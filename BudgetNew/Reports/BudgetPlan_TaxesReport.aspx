<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BudgetPlan_TaxesReport.aspx.cs" Inherits="M_Main.BudgetNew.Reports.BudgetPlan_TaxesReport" %>
...
<body style="margin: 0px; margin-top: 0px; overflow: hidden;">
    <form id="frmForm" runat="server">
        ...
        <script type="text/javascript">
            ...
            var column = [[
                { title: '计税依据', align: 'center', colspan: 2 },
                ...
                { field: 'TaxNegativeRate', title: '税负率', width: 80, align: 'center', rowspan: 2 },
                { field: 'BudgetExplain', title: '预算说明', width: 100, align: 'center', rowspan: 2 },
                { title: '月度预算数', align: 'center', colspan: 12 }
            ], [
                { field: 'TaxAmount', title: '计税金额<br/>（收入 / 原值 / 面积）', align: 'center', width: 130 },
            ...
            function Btn_SearchClick() {
                ...
                $.tool.DataGet('Budget', 'Budget_BudgetPlan_TaxesReport', parameters,
                    function Init() {
                    },
