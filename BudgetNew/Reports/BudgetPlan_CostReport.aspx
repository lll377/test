<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BudgetPlan_CostReport.aspx.cs" Inherits="M_Main.BudgetNew.Reports.BudgetPlan_CostReport" %>
    ...
    <form id="frmForm" runat="server">
        ...
        <script type="text/javascript">
            ...
            function Btn_SearchClick() {
                ...
                $.tool.DataGet('Budget', 'Budget_BudgetPlan_CostReport', parameters,
                    function Init() {
                    },
