<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BudgetPlan_FeesReport.aspx.cs" Inherits="M_Main.BudgetNew.Reports.BudgetPlan_FeesReport" %>
    ...
    <form id="frmForm" runat="server">
        ...
        <script type="text/javascript">
            ...
            function Btn_SearchClick() {
                ...
                $.tool.DataGet('Budget', 'Budget_BudgetPlan_FeesReport', parameters,
                    function Init() {
                    },
