<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BudgetPlan_IncomeReport.aspx.cs" Inherits="M_Main.BudgetNew.Reports.BudgetPlan_IncomeReport" %>
    ...
    <form id="frmForm" runat="server">
        ...
        <script type="text/javascript">
            ...
            function Btn_SearchClick() {
                ...
                $.tool.DataGet('Budget', 'Budget_BudgetPlan_IncomeReport', parameters,
                    function Init() {
                    },
