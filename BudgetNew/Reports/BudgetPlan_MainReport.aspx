<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BudgetPlan_MainReport.aspx.cs" Inherits="M_Main.BudgetNew.Reports.BudgetPlan_MainReport" %>
    ...
    <form id="frmForm" runat="server">
        ...
        <script type="text/javascript">
            ...
            function Btn_SearchClick() {
                ...
                $.tool.DataGet('Budget', 'Budget_BudgetPlan_MainReport', parameters,
                    function Init() {
                    },
