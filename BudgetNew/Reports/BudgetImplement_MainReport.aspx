<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BudgetImplement_MainReport.aspx.cs" Inherits="M_Main.BudgetNew.Reports.BudgetImplement_MainReport" %>
    ...
    <form id="frmForm" runat="server">
        ...
        <script type="text/javascript">
            ...
            var frozenColumns = [[
                ...
                { title: '预算科目', align: 'center', colspan: 2 }
            ], [
            ...
            var column = [[
                { field: 'AllBudgetValue', title: '本年预算', width: 120, align: 'center', rowspan: 2 }, 
                { field: 'AllCompleteValue', title: '本年实际发生累计', width: 120, align: 'center', rowspan: 2 },
                { field: 'DifferenceValue', title: '与预算差异', width: 120, align: 'center', rowspan: 2 },
                { field: 'CompleteRate', title: '完成率', width: 80, align: 'center', rowspan: 2 },
                { title: '月度执行数', align: 'center', colspan: 12 },
            ...
            function Btn_SearchClick() {
                ...
                $.tool.DataGet('Budget', 'Budget_BudgetImplement_MainReport', parameters,
                    function Init() {
                    },
