<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BudgetPlan_EscrowFundsReport.aspx.cs" Inherits="M_Main.BudgetNew.Reports.BudgetPlan_EscrowFundsReport" %>
    ...
    <form id="frmForm" runat="server">
        ...
        <script type="text/javascript">
            ...
            function Btn_SearchClick() {
                ...
                $.tool.DataGet('Budget', 'Budget_BudgetPlan_EscrowFundsReport', parameters,
                    function Init() {
                    },
