<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BudgetPlan_LabourUnionReport.aspx.cs" Inherits="M_Main.BudgetNew.Reports.BudgetPlan_LabourUnionReport" %>
...
<body style="margin: 0px; margin-top: 0px; overflow: hidden;">
    <form id="frmForm" runat="server">
        ...
        <script type="text/javascript">
            ...
            var column = [[
                { field: 'Explain', title: '说明', width: 120, align: 'center', rowspan: 2 },
            ...
            function Btn_SearchClick() {
                ...
                $.tool.DataGet('Budget', 'Budget_BudgetPlan_LabourUnionReport', parameters,
                    function Init() {
                    },
