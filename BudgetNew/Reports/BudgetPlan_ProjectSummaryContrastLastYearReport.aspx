<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BudgetPlan_ProjectSummaryContrastLastYearReport.aspx.cs" Inherits="M_Main.BudgetNew.Reports.BudgetPlan_ProjectSummaryContrastLastYearReport" %>
...
<body style="margin: 0px; margin-top: 0px; overflow: hidden;">
    <form id="frmForm" runat="server">
        ...
        <script type="text/javascript">
            ...
            var column = [[
                { title: '年全年预计累计发生数', align: 'center', colspan: 4 },
                { title: '年预算额', align: 'center', colspan: 4 },
                { title: '对比年累计发生', align: 'center', colspan: 4 },
            ], [
                { field: 'LastYearIncome', title: '收入', width: 120, align: 'center' },
                { field: 'LastYearCost', title: '支出', width: 120, align: 'center' },
                { field: 'LastYearManagementCommission', title: '管理佣金', width: 120, align: 'center' },
                { field: 'LastYearPreTaxProfit', title: '税前利润', width: 120, align: 'center' },
                ...
                { field: 'IncomeGrowthRate', title: '收入增长率', width: 120, align: 'center' },
                { field: 'CostGrowthRate', title: '成本增长率', width: 120, align: 'center' },
                { field: 'ManagementCommissionGrowthRate', title: '佣金增长率', width: 120, align: 'center' },
                { field: 'PreTaxProfitGrowthRate', title: '利润增长率', width: 120, align: 'center' }
            ]];
                ...
                }, '-',
                {
                    ...
                    handler: function () {
                        ...
                        if (rowData.length == 0) {
                            ...
                            Export('项目预算与上年实际发生汇总对比表', $('#TableContainer'));
                        }
                    }
                }
            ];
            ...
            function Btn_SearchClick() {
                ...
                $.tool.DataPost('Budget', 'Budget_BudgetPlan_ProjectSummaryContrastLastYearReport', parameters,
                    function Init() {
                    },
                    function callback(_Data) {
                        if (_Data != "") {
                            //构建表头
                            var LasYear = parseInt($('#BudgetYear').val()) - 1;
                            var NewColumn = [
                                { title: LasYear + '年全年预计累计发生数', align: 'center', colspan: 4 },
                                { title: $('#BudgetYear').val() + '年预算额', align: 'center', colspan: 4 },
                                { title: '对比' + LasYear + '年累计发生', align: 'center', colspan: 4 },
                            ];
                            column[0] = NewColumn;
