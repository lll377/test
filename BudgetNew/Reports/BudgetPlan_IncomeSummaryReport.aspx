<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BudgetPlan_IncomeSummaryReport.aspx.cs" Inherits="M_Main.BudgetNew.Reports.BudgetPlan_IncomeSummaryReport" %>
...
<body style="margin: 0px; margin-top: 0px; overflow: hidden;">
    <form id="frmForm" runat="server">
        ...
        <script type="text/javascript">
            ...
            var frozenColumns = [[
                { field: 'text', title: '单位名称', width: 320, align: 'left' }
            ]];
            ...
            var toolbar = [
                ...
                }, '-',
                {
                    ...
                    handler: function () {
                        ...
                        if (rowData.length == 0) {
                            HDialog.Info('没有需要导出的预算收入汇总数据');
                        }
                        else {
                            Export('预算收入汇总表', $('#TableContainer'));
                        }
                    }
                }
            ];
            ...
            function Btn_SearchClick() {
                ...
                $.tool.DataPost('Budget', 'Budget_BudgetPlan_IncomeSummaryReport', parameters,
                    function Init() {
                    },
            ...
            function InitColums(MaxLevelCode, ColumnsStr) {
                if (ColumnsStr.length > 0) {
                    //冻结列
                    frozenColumns = [[
                        { field: 'text', title: '单位名称', width: 320, align: 'left', rowspan: MaxLevelCode }
                    ]];
                    ...
                    for (var j = 0; j < ColumnObj.length; j++) {
                        ...
                        if (ColumnObj[j].FiledName == "") {
                            ...
                            ItemJson = '{\'field\':\'' + ColumnObj[j].text + '\',\'title\':\'' + ColumnObj[j].text + '\',\'width\': 120, \'align\': \'center\',\'colspan\': ' + ColumnObj[j].ColSpan + ',\'rowspan\': ' + ColumnObj[j].RowSpan + '}';
                        }
                ...
                if (treeNode) {
                    for (var j = 0; j < treeNode.length; j++) {
                        ...
                        if (treeNode[j].FiledName == "") {
                            ...
                            ItemJson = '{\'field\':\'' + treeNode[j].text + '\',\'title\':\'' + treeNode[j].text + '\',\'width\': 120, \'align\': \'center\',\'colspan\': ' + treeNode[j].ColSpan + ',\'rowspan\': ' + treeNode[j].RowSpan + '}';
                        }
