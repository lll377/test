<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BudgetIncomeManage_OtherIncomePlanCreate.aspx.cs" Inherits="M_Main.BudgetNew.BudgetIncomeManage_OtherIncomePlanCreate" %>
...
<head runat="server">
    ...
    <title>预算计划-收入计划-生成其他收入计划</title>
...
<body style="margin: 0px; padding: 0px; overflow: hidden;">
            ...
            <tr>
                ...
                <td class="TdContentSearch">
                    <input type="text" class="Wdate" onclick="WdatePicker({ dateFmt: 'yyyy' })" style="border: 1px solid #cccccc;"
                        id="OtherBudgetPlanYear" runat="server" name="OtherBudgetPlanYear" /></td>
            </tr>
            <tr>
    ...
    <script type="text/javascript">
        ...
        $("#btnCreate").click(function () {
            ...
            //    return;
            //}
            $.tool.DataPost('Budget', "IncomeManage_CreateOtherIncomePlan", $('#frmForm').serialize(),
                function Init() {
                },
                function callback(_Data) {
                    if (_Data == "true") {
                        HDialog.Info("生成其他收入计划成功");
                        HDialog.Close("true");
                    } else {
                        HDialog.Info(_Data);
                    }
