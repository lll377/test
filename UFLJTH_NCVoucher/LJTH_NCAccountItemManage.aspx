<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LJTH_NCAccountItemManage.aspx.cs" Inherits="M_Main.UFLJTH_NCVoucher.LJTH_NCAccountItemManage" %>
    ...
    <form id="frmForm" runat="server">
        ...
        <table class="DialogTable" border="0" style="line-height:23px;height:23px;">
            <tr>
                ...
                <td class="TdContent"><INPUT class="easyui-validatebox"  data-options="required:true" id="AccountItemMID" name="AccountItemMID" runat="server">
                </td>
                 <td class="TdTitle">收支项目名称</td>
                <td class="TdContent"><INPUT class="easyui-validatebox"  id="AccountItemName" name="AccountItemName" runat="server">
                </td>
             </tr>             
            <tr>
        ...
        <script type="text/javascript">
            $("#BtnSave").click(function () {
                ...
                $.tool.DataPostChk('frmForm', 'LJTH_NCAccountItem', "add", $('#frmForm').serialize(),
                function Init() {
                },
