<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeesRefundEntryDetail.aspx.cs" Inherits="M_Main.UFLJTH_NCVoucher.FeesRefundEntryDetail" %>
...
<body>
    <form id="frmForm" runat="server">
        <input id="CorpID" type="hidden" size="1" name="CorpID" runat="server" value="6009"/>
            ...
            function LoadEntry() {
                ...
                $("#TableContainer1").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        ...
                        param = $.JQForm.GetParam("LJTH_NCPushRefFees", "LoadPushRefEntry", "TableContainer1", param);
                    }
                });
            }
            LoadEntry();
