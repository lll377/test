<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LJTH_NCProjectManage.aspx.cs" Inherits="M_Main.UFLJTH_NCVoucher.LJTH_NCProjectManage" %>
    ...
    <form id="frmForm" runat="server">
        ...
        <table class="DialogTable" border="0" style="line-height:23px;height:23px;">
            <tr>
                ...
                <td class="TdContent"><INPUT class="easyui-validatebox" data-options="required:true" id="ProjectID" name="ProjectID" runat="server">
                </td>
                <td class="TdTitle">房地产项目编码</td>
                <td class="TdContent"><INPUT class="easyui-validatebox"  id="ProjectCode" name="ProjectCode" runat="server">
                </td>
             </tr>
             <tr>
                
                <td class="TdTitle">房地产项目名称</td>
                <td class="TdContent"><INPUT class="easyui-validatebox"  id="ProjectName" name="ProjectName" runat="server">
                </td>
                  <td class="TdTitle"></td>
                <td class="TdContent">
                </td>
        ...
        <script type="text/javascript">
            $("#BtnSave").click(function () {
                ...
                $.tool.DataPostChk('frmForm', 'LJTH_NCProject', "add", $('#frmForm').serialize(),
                function Init() {
                },
