<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LJTH_NCProjectItemManage.aspx.cs" Inherits="M_Main.UFLJTH_NCVoucher.LJTH_NCProjectItemManage" %>
...
<body>
    <form id="frmForm" runat="server">
        ...
        <table class="DialogTable" border="0" style="line-height:23px;height:23px;">
            <tr>
                <td class="TdTitle">房地产项目ID</td>
                <td class="TdContent"><INPUT class="easyui-validatebox" data-options="required:true" id="ProjectItemID" name="ProjectItemID" runat="server">
                </td>
                <td class="TdTitle">房地产项目编码</td>
                <td class="TdContent"><INPUT class="easyui-validatebox"  id="ProjectItemCode" name="ProjectItemCode" runat="server">
                </td>
             </tr>
             <tr>
                
                <td class="TdTitle">房地产项目名称</td>
                <td class="TdContent"><INPUT class="easyui-validatebox"  id="ProjectItemName" name="ProjectItemName" runat="server">
                </td>
                  <td class="TdTitle"></td>
                <td class="TdContent">
                </td>
        ...
        <script type="text/javascript">
            $("#BtnSave").click(function () {
                ...
                $.tool.DataPostChk('frmForm', 'LJTH_NCProjectItem', "add", $('#frmForm').serialize(),
                function Init() {
                },
