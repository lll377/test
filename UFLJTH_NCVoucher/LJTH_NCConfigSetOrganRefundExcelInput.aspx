<%@ Page Language="c#" CodeBehind="LJTH_NCConfigSetOrganRefundExcelInput.aspx.cs" AutoEventWireup="false" Inherits="M_Main.UFLJTH_NCVoucher.LJTH_NCConfigSetOrganRefundExcelInput" %>
        ...
        <table class="DialogTable" id="Table1" style="width: 100%">
            ...
            <tr>
                <td colspan="4" style="height: 30px; color: crimson; text-align: center; font-weight: 600; font-size: 14px">*提示：导入文件类型必须为Excel格式。
                    列是管理项目，财务组织，核算主体ID，实际承担主体ID，付款单位ID，房地产项目
