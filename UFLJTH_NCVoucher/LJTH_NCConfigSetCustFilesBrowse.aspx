<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LJTH_NCConfigSetCustFilesBrowse.aspx.cs" Inherits="M_Main.UFLJTH_NCVoucher.LJTH_NCConfigSetCustFilesBrowse" %>
    ...
    <form id="frmForm" runat="server">
        ...
        <script type="text/javascript">
            var column = [[
                       ...
                       { field: 'CustFilesCode', title: '客商编码', width: 100, align: 'left', sortable: true },
                       { field: 'CustFilesName', title: '客商名称', width: 100, align: 'left', sortable: true }
            ]];
            ...
            function DelRecord(Id) {
                HDialog.Prompt('是否删除该项', function () {
                    $.tool.DataGet('LJTH_NCConfigCustFiles', 'delete', 'ConfigID=' + Id,
                                function Init() {
                                },
            ...
            function LoadList() {
                $("#TableContainer").datagrid({
                    url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=LJTH_NCConfigCustFiles&Command=List&' + $("#frmForm").serialize(),
                    method: "get",
                    nowrap: false,
            ...
            function ViewDetail(title, OpType, ID) {
                ...
                HDialog.Open('800', '300', '../UFLJTH_NCVoucher/LJTH_NCConfigSetCustFilesManage.aspx?ConfigID=' + ID + '&OpType=' + OpType, title, true, function callback(_Data) {
                    //if (_Data == "true") {
                        LoadList();
                    //}
