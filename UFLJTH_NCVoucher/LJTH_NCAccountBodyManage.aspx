<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LJTH_NCAccountBodyManage.aspx.cs" Inherits="M_Main.UFLJTH_NCVoucher.LJTH_NCAccountBodyManage" %>
...
<body>
    <form id="frmForm" runat="server">
        ...
        <table class="DialogTable" border="0" style="line-height:23px;height:23px;">
            <tr>
                <td class="TdTitle">核算主体ID</td>
                <td class="TdContent"><INPUT class="easyui-validatebox" data-options="required:true" id="accountBodyMID" name="accountBodyMID" runat="server">
                </td>
                <td class="TdTitle">核算主体名称</td>
                <td class="TdContent"><INPUT class="easyui-validatebox"  id="AccountBodyName" name="AccountBodyName" runat="server">
                </td>
             </tr>
        ...
        <script type="text/javascript">
            $("#BtnSave").click(function () {
                ...
                $.tool.DataPostChk('frmForm', 'LJTH_NCAccountBody', "add", $('#frmForm').serialize(),
                function Init() {
                },
