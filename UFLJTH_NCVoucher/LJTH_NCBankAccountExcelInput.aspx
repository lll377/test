<%@ Page Language="c#" CodeBehind="LJTH_NCBankAccountExcelInput.aspx.cs" AutoEventWireup="false" Inherits="M_Main.UFLJTH_NCVoucher.LJTH_NCBankAccountExcelInput" %>
        ...
        <table class="DialogTable" id="Table1" style="width: 100%">
            ...
            <tr>
                <td colspan="4" style="height: 30px; color: crimson; text-align: center; font-weight: 600; font-size: 14px">*提示：导入文件类型必须为Excel格式。
                    列是银行账户ID，银行账户编码，银行账户名称，银行名称，银行类别
