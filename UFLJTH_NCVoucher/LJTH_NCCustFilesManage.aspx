<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LJTH_NCCustFilesManage.aspx.cs" Inherits="M_Main.UFLJTH_NCVoucher.LJTH_NCCustFilesManage" %>
    ...
    <form id="frmForm" runat="server">
        ...
        <table class="DialogTable" border="0" style="line-height:23px;height:23px;">
            <tr>
                ...
                <td class="TdContent"><INPUT class="easyui-validatebox"  data-options="required:true" id="CustFilesID" name="CustFilesID" runat="server">
                </td>
                <td class="TdTitle">客户编码</td>
                <td class="TdContent"><INPUT class="easyui-validatebox"  id="CustFilesCode" name="CustFilesCode" runat="server">
                </td>
             </tr>
             <tr>
                
                <td class="TdTitle">客户名称</td>
                <td class="TdContent"><INPUT class="easyui-validatebox"  id="CustFilesName" name="CustFilesName" runat="server">
                </td>
                  <td class="TdTitle"></td>
                <td class="TdContent">
                </td>
        ...
        <script type="text/javascript">
            $("#BtnSave").click(function () {
                ...
                $.tool.DataPostChk('frmForm', 'LJTH_NCCustFiles', "add", $('#frmForm').serialize(),
                function Init() {
                },
