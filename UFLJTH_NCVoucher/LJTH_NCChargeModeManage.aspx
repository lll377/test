<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LJTH_NCChargeModeManage.aspx.cs" Inherits="M_Main.UFLJTH_NCVoucher.LJTH_NCChargeModeManage" %>
...
<body>
    <form id="frmForm" runat="server">
        ...
        <table class="DialogTable" border="0" style="line-height:23px;height:23px;">
             ...
             <tr>
                <td class="TdTitle">结算方式ID</td>
                <td class="TdContent"><INPUT class="easyui-validatebox" data-options="required:true" id="ChargeModeID" name="ChargeModeID" runat="server">
                </td>
                <td class="TdTitle">结算方式编码</td>
                <td class="TdContent"><INPUT class="easyui-validatebox"  id="ChargeModeCode" name="ChargeModeCode" runat="server">
                </td>               
             </tr>
             <tr>                
                <td class="TdTitle">结算方式名称</td>
                <td class="TdContent"><INPUT class="easyui-validatebox"  id="ChargeModeName" name="ChargeModeName" runat="server">
                </td>
                 <td class="TdTitle"></td>
                <td class="TdContent">
                </td>
        ...
        <script type="text/javascript">
            $("#BtnSave").click(function () {
                ...
                $.tool.DataPostChk('frmForm', 'LJTH_NCChargeMode', "add", $('#frmForm').serialize(),
                function Init() {
                },
