<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LJTH_NCPushFeesChargeBrowse.aspx.cs" Inherits="M_Main.UFLJTH_NCVoucher.LJTH_NCPushFeesChargeBrowse" %>
    ...
    <form id="frmForm" runat="server">       
        ...
        <script type="text/javascript">
            ...
            $('#btnCre').click(function () {
                ...
                $.tool.DataPost('LJTH_NCPushFees', 'ChargeCre', $('#frmForm').serialize(),
                  function Init() {
            ...
            var column = [[
                { field: 'PushTypeName', title: '收款单类别', width: 100, align: 'left', sortable: true },
            ...
            function LoadList() {
                ...
                $("#TableContainer").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        ...
                        param = $.JQForm.GetParam("LJTH_NCPushFees", "LoadPushHead", "TableContainer", param);
                    }
                });
            }
            ...
            $('#btnOk').click(function () {
                if ($('#BatchCode').val() == '') {
                    ...
                    $.tool.DataPost('LJTH_NCPushFees', 'PushSub', $('#frmForm').serialize(),
                 function Init() {
            ...
            function ViewDetail(title, PushID) {
                ...
                HDialog.Open(w, h, '../UFLJTH_NCVoucher/LJTH_NCPushFeesEntryDetail.aspx?PushID=' + PushID, '推送明细', false, function callback(_Data) {
                    LoadList();
                });
            }
        </script>
