<%@ Page Language="c#" CodeBehind="LJTH_NCPayerExcelInput.aspx.cs" AutoEventWireup="false" Inherits="M_Main.UFLJTH_NCVoucher.LJTH_NCPayerExcelInput" %>
        ...
        <table class="DialogTable" id="Table1" style="width: 100%">
            ...
            <tr>
                <td colspan="4" style="height: 30px; color: crimson; text-align: center; font-weight: 600; font-size: 14px">*提示：导入文件类型必须为Excel格式。
                    列是付款单位类型，付款单位ID，付款单位名称，付款单位开户行，付款单位账号
