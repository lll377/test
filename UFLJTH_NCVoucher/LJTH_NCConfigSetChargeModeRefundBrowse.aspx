<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LJTH_NCConfigSetChargeModeRefundBrowse.aspx.cs" Inherits="M_Main.UFLJTH_NCVoucher.LJTH_NCConfigSetChargeModeRefundBrowse" %>
        ...
        <script type="text/javascript">
            ...
            function DelRecord(Id) {
                HDialog.Prompt('是否删除该项', function () {
                    $.tool.DataGet('LJTH_NCConfigChargeModeRefund', 'delete', 'ConfigID=' + Id,
                                function Init() {
                                },
            ...
            function LoadList() {
                $("#TableContainer").datagrid({
                    url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=LJTH_NCConfigChargeModeRefund&Command=List&' + $("#frmForm").serialize(),
                    method: "get",
                    nowrap: false,
            ...
            function ViewDetail(title, OpType, ID) {
                ...
                HDialog.Open('800', '400', '../UFLJTH_NCVoucher/LJTH_NCConfigSetChargeModeRefundManage.aspx?ConfigID=' + ID + '&OpType=' + OpType, title, true, function callback(_Data) {
                    //if (_Data == "true") {
                        LoadList();
                    //}
