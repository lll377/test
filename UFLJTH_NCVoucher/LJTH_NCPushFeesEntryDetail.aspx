<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LJTH_NCPushFeesEntryDetail.aspx.cs" Inherits="M_Main.UFLJTH_NCVoucher.LJTH_NCPushFeesEntryDetail" %>
    ...
    <form id="frmForm" runat="server">
        ...
        <script type="text/javascript">
            ...
            var EntryColumn = [[
                ...
                { field: 'MonAccountName', title: '现金账户', width: 300, align: 'left', sortable: true },
                { field: 'PKAccountName', title: '收款银行账户', width: 300, align: 'left', sortable: true },
                { field: 'PKBalaTypeName', title: '结算方式', width: 100, align: 'left', sortable: true },
                { field: 'PKRecprojectName', title: '收支项目', width: 100, align: 'left', sortable: true },
                { field: 'RecLocalAmount', title: '收款组织本币金额', width: 100, align: 'left', sortable: true },
                { field: 'RoomSign', title: '房屋编号', width: 400, align: 'left', sortable: true }
                ]]
            ...
            var toolbar1 = [ {
                    ...
                    handler: function () {
                        ...
                        if (data.rows.length>0) {
                            window.location.href = "../UFLJTH_NCVoucher/LJTH_NCPushEntryCre.aspx?PushID=" + $('#PushID').val();
                        }
            ...
            function LoadEntry() {
                ...
                $("#TableContainer1").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        ...
                        param = $.JQForm.GetParam("LJTH_NCPushFees", "LoadPushEntry", "TableContainer1", param);
                    }
                });
            }
            LoadEntry();
