<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeesChargeRateStat.aspx.cs" Inherits="M_Main.CorpCostStatistNew.FeesChargeRateStat" %>
    ...
    <form id="NewFeesDueCutSearch" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            ...
            var frozenColumns = [[
                ...
                { field: 'StanName', title: '费用标准', align: 'left', sortable: true, width: 100 },
                { field: 'CostTypeName', title: '费用类型', align: 'left', sortable: true, width: 100 }
            ]];


            var Headcolumn = [[
                { field: 'CostName', rowspan: 2, title: '费用名称', align: 'left', sortable: true, width: 100 },
                { field: 'StanName', rowspan: 2, title: '费用标准', align: 'left', sortable: true, width: 100 },
                { field: 'CostTypeName', rowspan: 2, title: '费用类型', align: 'left', sortable: true, width: 100 },
                { colspan: 3, title: '期初欠费' },
                { colspan: 2, title: '应收费用' },
                { colspan: 5, title: '实收费用' },
                { colspan: 5, title: '预交冲抵' },
            ...
            var ExcelCol = [{ field: 'CostName', title: '费用名称', align: 'left', sortable: true, width: 100 },
            { field: 'StanName', title: '费用标准', align: 'left', sortable: true, width: 100 },
            { field: 'CostTypeName', title: '费用类型', align: 'left', sortable: true, width: 100 },
            { field: 'BeginBefLastDebtsAmount', title: '年初往年欠费', align: 'left', sortable: true, width: 100 },
            { field: 'BeginBefPeriodDebtsAmount', title: '期初往年欠费', align: 'left', sortable: true, width: 100 },
            ...
            function ShowDetail(sStatID, DetailType) {
                ...
                $("#TableContainerDetail").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        param = $.JQForm.GetParam("FeesChargeRate", "LoadDataDetail", "TableContainerDetail", param);
                    },
                });
        ...
        <script type="text/javascript">
            ...
            function StartTask() {
                //启动一个任务
                $.tool.DataPostNoLoading('FeesChargeRate', 'StartTask', $('#NewFeesDueCutSearch').serialize(),
                    function Init() {
                    },
                    function callback(_Data) {
                    },
            ...
            function LoadList(page, rows) {
                ...
                $("#TableContainer").datagrid({
                    ...
                    sortOrder: "asc",
                    onBeforeLoad: function (param) {
                        param = $.JQForm.GetParam("FeesChargeRate", "LoadData", "TableContainer", param);
                    },
                    onLoadSuccess: function (data) {

                    }
                });
                //$.tool.DataPost2('FeesChargeRate', 'LoadData', "page=" + page + "&rows=" + rows + "&" + $('#NewFeesDueCutSearch').serialize(),
                //       function Init() {
                //       },
                //       function callback(_Data) {
                //           var Data = eval("(" + _Data + ")"); //转换为json对象
            ...
            function TakeProgress() {
                $.tool.DataPostNoLoading('FeesChargeRate', 'TakeProgress', $('#NewFeesDueCutSearch').serialize(),
                    function Init() {
                    },
                    function callback(_Data) {
            ...
            function ToExcel() {
                ...
                window.location.href = "../CorpCostStatistNew/FeesChargeRateDetailCre.aspx?StatID=" + StatID + "&DetailType=" + DetailType + "&hiIsPrec=" + hiIsPrec;
            }
            ...
            //                    BuildSNums = BuildSNums == "" ? DData[i].attributes.BuildSNum : BuildSNums + ',' + DData[i].attributes.BuildSNum;
            //                }
            //            }
            //            $('#SelectBuild').val(_Data);
            //            $('#BuildNames').textbox('setValue', BuildNames.substring(1, BuildNames.length));
