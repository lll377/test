<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncomeSearch.aspx.cs" Inherits="M_Main.CorpCostStatistNew.IncomeSearch" %>
...
<body>
    <form id="NewFeesDueCutSearch" runat="server">
        ...
        <input id="ChargeModes" size="1" type="hidden" name="ChargeModes" runat="server" />
        ...
        <script language="javascript" type="text/javascript">
            ...
            var column = [[
                ...
                { field: 'CostName', title: '费用项目', align: 'left', sortable: true, width: 200 },
                { field: '总户数', title: '总户数', align: 'left', sortable: true, width: 200 },
                { field: '当期户数', title: '当期户数', align: 'left', sortable: true, width: 200 },
                { field: '历史户数', title: '历史户数', align: 'left', sortable: true, width: 200 },
                { field: '实收后期户数', title: '实收后期户数', align: 'left', sortable: true, width: 200 },
                { field: '收回往年金额', title: '收回往年金额', align: 'left', sortable: true, width: 200 },
                { field: '收回本年前期金额', title: '收回本年前期金额', align: 'left', sortable: true, width: 200 },
                { field: '收回当期金额', title: '收回当期金额', align: 'left', sortable: true, width: 200 },
                { field: '实收后期金额', title: '实收后期金额', align: 'left', sortable: true, width: 200 },
                { field: 'Total', title: '合计', align: 'left', sortable: true, width: 200 }
            ]];
            ...
            function StartTask() {
                $("#ChargeModes").val($("#ChargeMode").combobox('getValues'));
                //启动一个任务
                $.tool.DataPostNoLoading('IncomeExpenditureNew', 'StartTask_Corp', $('#NewFeesDueCutSearch').serialize(),
                    function Init() {
                    },
            ...
            function LoadList(page, rows) {
                $("#TableContainer").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        param = $.JQForm.GetParam("IncomeExpenditureNew", "CorpLoadData", "TableContainer", param);
                    },
            ...
            function TakeProgress() {
                $.tool.DataPostNoLoading('IncomeExpenditureNew', 'TakeProgress_Corp', $('#NewFeesDueCutSearch').serialize(),
                    function Init() {
                    },
                    function callback(_Data) {
            ...
            function ToExcel() {
                window.location.href = "../CorpCostStatistNew/IncomeSearchCre.aspx";
            }
        </script>
    </form>
</body>
