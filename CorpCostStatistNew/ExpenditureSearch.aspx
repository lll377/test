<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExpenditureSearch.aspx.cs" Inherits="M_Main.CorpCostStatistNew.ExpenditureSearch" %>
...
<body>
    <form id="NewFeesDueCutSearch" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function StartTask() {
                //启动一个任务
                $.tool.DataPostNoLoading('IncomeExpenditure', 'StartTask_Corp', $('#NewFeesDueCutSearch').serialize(),
                    function Init() {
                    },
            ...
            function LoadList() {
                $("#TableContainer").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        param = $.JQForm.GetParam("IncomeExpenditure", "CorpLoadData", "TableContainer", param);
                    },
            ...
            function TakeProgress() {
                $.tool.DataPostNoLoading('IncomeExpenditure', 'TakeProgress_Corp', $('#NewFeesDueCutSearch').serialize(),
                    function Init() {
                    },
                    function callback(_Data) {
