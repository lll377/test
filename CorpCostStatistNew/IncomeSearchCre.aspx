<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncomeSearchCre.aspx.cs" Inherits="M_Main.CorpCostStatistNew.IncomeSearchCre" %>
    ...
    <form id="NewFeesDueCutSearch" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function StartTask() {
                ...
                //启动一个任务
                $.tool.DataPostNoLoading('IncomeExpenditureNew', 'StartTask', $('#NewFeesDueCutSearch').serialize(),
                    function Init() {
                    },
            ...
            function LoadList(page, rows) {
                ...
                $("#TableContainer").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        param = $.JQForm.GetParam("IncomeExpenditureNew", "LoadData", "TableContainer", param);
                    },
            ...
            function TakeProgress() {
                $.tool.DataPostNoLoading('IncomeExpenditureNew', 'TakeProgress', $('#NewFeesDueCutSearch').serialize(),
                    function Init() {
                    },
                    function callback(_Data) {
            ...
            function ToExcel() {
                window.location.href = "../InquiriesNew/IncomeSearchCre.aspx";
            }
        </script>
    </form>
</body>
