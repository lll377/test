<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskMaintenanceClose_Inspection.aspx.cs" Inherits="M_Main.EquipmentNew.TaskMaintenanceClose_Inspection" %>
...
<body>
    <form id="frmFrom" runat="server">
        ...
        <script type="text/javascript">
            ...
            function Save() {
                $.tool.DataPostChk('frmFrom', 'CsEquipment', 'SaveTaskMaintenanceClose_Inspection', $('#frmFrom').serialize(),
                    function Init() {
                    },
