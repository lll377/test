<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EquipmentReportList.aspx.cs" Inherits="M_Main.EquipmentNew.EquipmentReportList" %>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="row">
                                <div class="col-sm-4" style="font-size: 15px; font-family: 微软雅黑; line-height: 30px;">
                                    <a id="Rp_01" data-url="../EquipmentNew/EpquipmentReport.aspx">1、设备档案统计</a><br />
                                    <a id="Rp_02" data-url="../EquipmentNew/TaskReport_Inspection.aspx">2、设备巡检统计</a><br />
                                    <a id="Rp_03" data-url="../EquipmentNew/TaskReport_Maintenance.aspx">3、设备维保统计</a><br />
                                    <a id="Rp_04" data-url="../EquipmentNew/EquipmentFailureRateStatisticsSys.aspx">4、设备故障率统计（按设备系统）</a><br />
                                    <a id="Rp_05" data-url="../EquipmentNew/EquipmentFailureRateStatisticsLevel.aspx">5、设备故障率统计（按设备级别）</a><br />
                                    <a id="Rp_06" data-url="../EquipmentNew/EquipmentIntactRateStatisticsSys.aspx">6、设备完好率统计（按设备系统）</a><br />
                                    <a id="Rp_07" data-url="../EquipmentNew/EquipmentIntactRateStatisticsLevel.aspx">7、设备完好率统计（按设备级别）</a><br />
                                    <a id="Rp_08" data-url="../EquipmentNew/TaskSpaceLine_Report_Inspection.aspx">8、设备巡检表单</a><br />
                                    <a id="Rp_09" data-url="../EquipmentNew/TaskSpaceLine_Report_Maintenance.aspx">9、设备维保表单</a><br />
                                </div>
