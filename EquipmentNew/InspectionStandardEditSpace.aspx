<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InspectionStandardEditSpace.aspx.cs" Inherits="M_Main.EquipmentNew.InspectionStandardEditSpace" %>
<!DOCTYPE html>
            ...
            <table class="SearchTable">
                ...
                <tr>
                    ...
                    <td class="TdContentSearch">
                        ...
                        <select id="SpaceName" name="SpaceName" runat="server" class="easyui-combobox" style="width: 200px;" data-options="editable:false,panelHeight: '150px',required:true,panelMaxHeight:170">
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="TdContentSearch">
                        <select id="InspectionTypeId" name="InspectionTypeId" runat="server" class="easyui-combobox" style="width: 200px;" data-options="editable:false,panelHeight: '150px',required:true,panelMaxHeight:170">
                        </select>
                    </td>
                </tr>
                <tr>
        ...
        <script type="text/javascript">
            ...
            function Load() {
                if ($('#OpType').val() == 'edit') {
                    ...
                    $.tool.DataGet('CsEquipment', 'GetInspectionStandardSpaceById', ParameterStr,
                        function Init() {
                        },
                        function callback(_Data) {
                            ...
                            if (varObjects.length > 0) {
                                ...
                                $('#InspectionTypeId').combobox("setValue", varObjects[0].InspectionTypeId);
                    ...
                    $.tool.DataGet('CsEquipment', 'GetMaxSort', "Type=InspectionStandardSpace",
                                 function Init() {
                                 },
                                 function callback(_Data) {
                                     if (_Data != "") {
            ...
            function Save() {
                if ($('#frmForm').form("validate")) {
                    $.tool.DataPostChk('frmForm', 'CsEquipment', 'SaveInspectionStandardSpace', $('#frmForm').serialize(),
                            function Init() {
                            },
                            function callback(_Data) {
                                if (_Data == "true") {
                                    ...
                                    HDialog.Info("相同通用空间和巡检类别只能保存一个！");
                                }
                            },
                            function completeCallback() {
                            },
            ...
            $(function () {
                $('#InspectionTypeId').combobox("clear");
