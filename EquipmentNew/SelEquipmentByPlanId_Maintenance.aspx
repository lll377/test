<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelEquipmentByPlanId_Maintenance.aspx.cs" Inherits="M_Main.EquipmentNew.SelEquipmentByPlanId_Maintenance" %>
        ...
        <script type="text/javascript">
            ...
            function LoadList() {
                $("#TableContainer").datagrid({
                    url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CsEquipment&Command=SelectEquipmentByPlanId_Maintenance&PlanId=' + GetQueryString('PlanId'),
                    method: "get",
                    loadMsg: '数据加载中,请稍候...',
                    nowrap: false,
