<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskMaintenanceClose_Maintenance.aspx.cs" Inherits="M_Main.EquipmentNew.TaskMaintenanceClose_Maintenance" %>
...
<head runat="server">
    ...
    <script src="../jscript/EquimentDictionaryCanNull.js" type="text/javascript"></script>
...
<body>
    <form id="frmFrom" runat="server">
        ...
        <script type="text/javascript">
            ...
            function Save() {
                $.tool.DataPostChk('frmFrom', 'CsEquipment', 'SaveTaskMaintenanceClose_Maintenance', $('#frmFrom').serialize(),
                    function Init() {
                    },
            ...
            $("#CloseUserName").click(function () {
                HDialog.Open('650', '600', '../EquipmentNew/SelUser.aspx?IsSingle=1', '选择人员', false, function callback(_Data) {
                    if (_Data) {
