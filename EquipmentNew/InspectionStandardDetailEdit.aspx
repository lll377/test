<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InspectionStandardDetailEdit.aspx.cs" Inherits="M_Main.EquipmentNew.InspectionStandardDetailEdit" %>
        ...
        <script type="text/javascript">
            ...
            function Load() {
                if ($('#OpType').val() == 'edit') {
                    ...
                    $.tool.DataGet('CsEquipment', 'GetInspectionStandardDetailById', parameterStr,
                                    function Init() {
                                    },
                    ...
                    $.tool.DataGet('CsEquipment', 'GetMaxSort', "Type=InspectionStandardDetail&ID=" + $("#InspectionStandardId").val(),
                            function Init() {
                            },
                            function callback(_Data) {
                                if (_Data != "") {
            ...
            function Save() {
                if ($('#frmForm').form("validate")) {
                    ...
                    $.tool.DataPostChk('frmForm', 'CsEquipment', 'SaveInspectionStandardDetail', $('#frmForm').serialize(),
                        function Init() {
                        },
                        function callback(_Data) {
                            if (_Data == "true") {
