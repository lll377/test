<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskMaintenanceEdit_Inspection.aspx.cs" Inherits="M_Main.EquipmentNew.TaskMaintenanceEdit_Inspection" %>
...
<body>
    <form id="frmFrom" runat="server">
        ...
        <script type="text/javascript">
            function Load() {
                $.tool.DataGet('CsEquipment', 'SelTaskMaintenanceEdit_Inspection', $('#frmFrom').serialize(),
                    function Init() {
                    },
            ...
            function Save() {
                ...
                $.tool.DataPostChk('frmFrom', 'CsEquipment', 'SaveTaskMaintenanceEdit_Inspection', $('#frmFrom').serialize(),
                    function Init() {
                    },
                    function callback(_Data) {
                        HDialog.Info("修改成功!");
            ...
            $("#SeeHistory").click(function () {
                HDialog.Open('800', '500', '../EquipmentNew/TaskMaintenanceEditHistory_Inspection.aspx?TaskId=' + $("#TaskId").val() + '&CommId=' + $("#CommId").val(), '查看历史修改记录', true, function callback(_Data) {
