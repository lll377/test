<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InspectionStandardDetailEditSpace.aspx.cs" Inherits="M_Main.EquipmentNew.InspectionStandardDetailEditSpace" %>
...
<body style="margin: 0px; overflow: hidden; padding: 0px">
    <form id="frmForm" runat="server">
            ...
            <table class="SearchTable">
                <tr>
                    ...
                    <td class="TdContentSearch">
                        <input type="text" id="InspectionStandardName" name="InspectionStandardName" readonly style="width: 195px;" class="easyui-validatebox" runat="server" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="TdTitle">巡检项目、内容、方法、标准:</td>
                    <td class="TdContentSearch">
                        <textarea type="text" id="InspectionContent" name="InspectionContent" maxlength="1900" class="easyui-validatebox" data-options="required:true"></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="TdTitle">巡检登记类型:</td>
                    <td class="TdContentSearch">
                ...
                <tr>
                    <td class="TdTitle">项目是否必选:</td>
                    <td class="TdContentSearch">
                        <select id="IsCommCheck" name="IsCommCheck" class="easyui-combobox" data-options="panelHeight:'auto',width:'60',editable:false">
                            <option value="0">否</option>
                            <option value="1">是</option>
                        </select>
                    </td>
        ...
        <input type="hidden" id="InspectionStandardId" name="InspectionStandardId" runat="server" />
        ...
        <script type="text/javascript">
            ...
            function Load() {
                if ($('#OpType').val() == 'edit') {
                    ...
                    $.tool.DataGet('CsEquipment', 'GetInspectionStandardDetailSpaceById', parameterStr,
                                    function Init() {
                                    },
                    ...
                    $.tool.DataGet('CsEquipment', 'GetMaxSort', "Type=InspectionStandardDetailSpace&ID=" + $("#InspectionStandardId").val(),
                            function Init() {
                            },
                            function callback(_Data) {
                                if (_Data != "") {
            ...
            function Save() {
                if ($('#frmForm').form("validate")) {
                    ...
                    $.tool.DataPostChk('frmForm', 'CsEquipment', 'SaveInspectionStandardDetailSpace', $('#frmForm').serialize(),
                        function Init() {
                        },
                        function callback(_Data) {
                            if (_Data == "true") {
