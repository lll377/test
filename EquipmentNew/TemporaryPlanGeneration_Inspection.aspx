<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TemporaryPlanGeneration_Inspection.aspx.cs" Inherits="M_Main.EquipmentNew.TemporaryPlanGeneration_Inspection" %>
...
<body>
    <form id="frmForm" runat="server" style="overflow: hidden;">
        ...
        <script type="text/javascript">
            //选择计划模板
            function SelPlan() {
                HDialog.Open('800', '600', '../EquipmentNew/SelPlan_Inspection.aspx?IsSingle=1&CommId=' + $("#CommId").val() + '&IsFireControl=' + $("#IsFireControl").val(), '选择计划模板', true, function callback(_Data) {
                    if (_Data != "") {
            ...
            function LoadPlan() {
                $.tool.DataGet('CsEquipment', 'GetPlan_Inspection', 'page=1&rows=10&Id=' + $("#PlanId").val() + '&CommId=' + $("#CommId").val(),
                    function Init() {
                    },
            ...
            $("#BtnSave").click(function (e) {
                ...
                HDialog.Prompt("确认生成任务吗?", function a() {
                    $.tool.DataPost('CsEquipment', 'TemporaryPlanGeneration_Inspection', $("#frmForm").serialize() + work,
                        function Init() {
                        },
                        function callback(_Data) {
                            HDialog.Info(_Data);
