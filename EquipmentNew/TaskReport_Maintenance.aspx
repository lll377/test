<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskReport_Maintenance.aspx.cs" Inherits="M_Main.EquipmentNew.TaskReport_Maintenance" %>
...
<body>
    <form id="frmForm" runat="server">
        ...
        <input type="hidden" id="TaskName" name="TaskName" value="设备维保统计" />
        <script type="text/javascript">
            ...
            var column = [[
                ...
                { field: 'NeedDoNum', title: '应完成任务数', width: 120, align: 'left', sortable: true },
            ...
            function LoadList(str) {
                var urls = null;
                if (str != "") {
                    urls = '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CsEquipment&Command=GetTaskReport_Maintenance&' + $("#frmForm").serialize();
                ...
                $("#TableContainer").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        if (str != "") {
                            param = $.JQForm.GetParam("CsEquipment", "GetTaskReport_Maintenance", "TableContainer", param);
                        }
                    }
                });
