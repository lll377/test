<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlanSettingDetail_Inspection.aspx.cs" Inherits="M_Main.EquipmentNew.PlanSettingDetail_Inspection" %>
...
<body>
    <form id="frmForm" runat="server" style="overflow: hidden;">
        <div class="Container">
            <table class="SearchTable">
                ...
                <tr>
                    ...
                    <td class="TdTitle">巡检类别</td>
                    <td class="TdContentSearch">
                        <select id="InspectionType" name="InspectionType" runat="server" isdctype="true" dctype="巡检类别" style="width: 70%; border: 1px #cccccc solid; height: 22px;" class="easyui-validatebox" data-options="required:true">
                            <option value=""></option>
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="TdTitle">巡检设备是否扫码</td>
                    <td class="TdContentSearch">
                        <select id="EquipmentIsScan" name="EquipmentIsScan" class="easyui-validatebox" style="border: 1px #cccccc solid; height: 22px; line-height: 22px; width: 70%;" data-options="required:true">
                            <option value="0">否</option>
                            <option value="1">是</option>
                        </select>
                    </td>
                    <td class="TdTitle">是否消防巡检</td>
                    <td class="TdContentSearch">
                        <select id="IsFireControl" name="IsFireControl" class="easyui-validatebox" style="border: 1px #cccccc solid; height: 22px; line-height: 22px; width: 70%;" data-options="required:true">
                            <option value="0">否</option>
                            <option value="1">是</option>
                        </select>
                    </td>
        ...
        <input type="hidden" id="OldInspectionType" name="OldInspectionType" />
        ...
        <input type="hidden" id="hiIsFireControl" name="hiIsFireControl" />
        <script type="text/javascript">
            ...
            function Save() {
                ...
                if ($("#OpType").val() == "edit") {
                    if ($("#OldSpaceId").val() != $("#SpaceId").val() || $("#OldInspectionType").val() != $("#InspectionType").val()) {
                        HDialog.Prompt('修改设备空间或巡检类别后将刷新设备空间和设备级别工艺路线信息', function () {
                            SavePlan(work, 1);
                        });
                    } else if ($("#OldSystemId").val() != $("#SystemId").val()) {
                        HDialog.Prompt('修改设备系统后将刷新设备级别工艺路线信息', function () {
                            SavePlan(work, 2);
                        });
                    } else {
                        SavePlan(work, 0);
            ...
            function SavePlan(work, NeedClear) {
                $.tool.DataPostChk('frmForm', 'CsEquipment', 'SavePlan_Inspection', $('#frmForm').serialize() + work + '&NeedClear=' + NeedClear,
                    function Init() {
                    },
            ...
            function SaveAuditing() {
                $.tool.DataGet('CsEquipment', 'ExaminePlan_Inspection', 'Id=' + $("#Id").val() + '&IsFireControl=' + $("#hiIsFireControl").val(),
                    function Init() {
                    },
                    function callback(_Data) {
                        if (_Data > '')
            ...
            function SaveCheckPass(IsPass) {
                $.tool.DataGet('CsEquipment', 'CheckPassPlan_Inspection', 'Id=' + $("#Id").val() + '&IsPass=' + IsPass,
                    function Init() {
                    },
                    function callback(_Data) {
                        HDialog.Info(_Data);
            ...
            function Load() {
                ...
                $("#hiIsFireControl").val(GetQueryString('IsFireControl'));
                if ($("#hiIsFireControl").val() == "0")
                    $("#IsFireControl").html("<option value='0'>否</option>");
                else
                    $("#IsFireControl").html("<option value='1'>是</option>");
                GetMaxSort();
            ...
            function LoadData() {
                $.tool.DataGet('CsEquipment', 'GetPlan_Inspection', 'page=1&rows=10&Id=' + $("#Id").val() + '&CommId=' + $("#CommId").val(),
                    function Init() {
                    },
                    function callback(_Data) {
                        ...
                        $("#EquipmentIsScan").val(varObjects.rows[0].EquipmentIsScan);
                        ...
                        $("#InspectionType").val(varObjects.rows[0].InspectionType);
                        $("#OldInspectionType").val(varObjects.rows[0].InspectionType);
            ...
            function GetMaxSort() {
                $.tool.DataGet('CsEquipment', 'GetPlanMaxSort_Inspection', 'CommId=' + $("#CommId").val(),
                    function Init() {
                    },
                    function callback(_Data) {
                        varObjects = eval("(" + _Data.replace(/\\/g, "/") + ")"); //转换为json对象
