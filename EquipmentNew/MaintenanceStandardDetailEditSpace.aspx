<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaintenanceStandardDetailEditSpace.aspx.cs" Inherits="M_Main.EquipmentNew.MaintenanceStandardDetailEditSpace" %>
        ...
        <div style="padding: 5px;">
            <table class="SearchTable">
                ...
                <tr>
                    ...
                    <td class="TdContentSearch">
                        <select id="IsMaintenanceRegistration" name="IsMaintenanceRegistration" class="easyui-combobox" data-options="panelHeight:'auto',width:'60',editable:false">
        ...
        <script type="text/javascript">
            ...
            function Load() {
                if ($('#OpType').val() == 'edit') {
                    ...
                    $.tool.DataGet('CsEquipment', 'GetMaintenanceStandardDetailSpaceById', parameterStr,
                                    function Init() {
                                    },
                                    function callback(_Data) {
                                        ...
                                        if (varObjects.length > 0) {
                                            ...
                                            $('#IsMaintenanceRegistration').combobox("setValue", varObjects[0].IsMaintenanceRegistration);
                    ...
                    $.tool.DataGet('CsEquipment', 'GetMaxSort', "Type=MaintenanceStandardDetailSpace&ID=" + $("#MaintenanceStandardId").val(),
                            function Init() {
                            },
                            function callback(_Data) {
                                if (_Data != "") {
            ...
            function Save() {
                if ($('#frmForm').form("validate")) {
                    ...
                    $.tool.DataPostChk('frmForm', 'CsEquipment', 'SaveMaintenanceStandardDetailSpace', $('#frmForm').serialize(),
                        function Init() {
                        },
                        function callback(_Data) {
                            if (_Data == "true") {
