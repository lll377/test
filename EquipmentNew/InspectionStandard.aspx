<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InspectionStandard.aspx.cs" Inherits="M_Main.EquipmentNew.InspectionStandard" %>
    ...
    <form id="frmForm" runat="server">
        ...
        <script type="text/javascript">
            ...
            var column = [[
                ...
                { field: 'InspectionTypeName', title: '巡检类别', width: 25, align: 'left', sortable: true },
            ...
            var columnDetail = [[
                { field: 'ck', checkbox: true },
                { field: 'Sort', title: '序号', width: 10, align: 'left', sortable: true },
                { field: 'InspectionContent', title: '巡检项目、内容、方法、标准', width: 100, align: 'left', sortable: true },
                {
                ...
                {
                    field: 'IsInspectionRegistration', title: '巡检登记是否必填', width: 30, align: 'left', sortable: true, formatter: function (value, row, index) {
                        var str = "是";
                ...
                [
                    {
                        ...
                        handler: function () {
                            ...
                            EditObj("新增巡检标准", "", "insert", RankID, RankName);
                        }
                    }, '-',
                    {
                        text: '修改',
                        ...
                        handler: function () {
                            ...
                            if (row == null) {
                                HDialog.Info("请选择需要修改的巡检标准数据");
                                return;
                            }
                            EditObj("修改巡检标准", row.Id, "edit", row.RankID, row.RankName);
                        }
                    }, '-',
                    {
                        text: '删除',
                    ...
                    }, '-',
                    {
                        ...
                        handler: function () {
                            ...
                            if (rowData.length == 0) {
                                HDialog.Info("没有巡检标准数据导出!");
                                return;
                            }
                            window.open("InspectionStandardExport.aspx?RankID=" + SelecteNode.id);
                        }
                    }, '-',
                    {
                        text: '导出全部标准',
                        iconCls: 'icon-page_white_excel',
                        handler: function () {
                            window.open("InspectionStandardExport.aspx");
                        }
                    }
                ];
                ...
                [
                    ...
                    }, '-',
                    {
                        ...
                        handler: function () {
                            ...
                            EditObjSpace("修改巡检标准", row.Id, "edit");
                        }
                    }, '-',
                    {
                        text: '删除',
                    ...
                    }, '-',
                    {
                        ...
                        handler: function () {
                            ...
                            window.open("InspectionStandardExport.aspx?Type=Space");
                        }
                    }
                ];
            ...
            function EditObj(title, Id, OpType, RankID, RankName) {
                ...
                HDialog.OpenWin('700', '350', '../EquipmentNew/InspectionStandardEdit.aspx' + parameterStr, title,
                    false, function callback(_Data) {
                        if (_Data != "") {
                            HDialog.Info("保存巡检标准成功");
                            LoadBind();
                        }
                    });
            }
            ...
            function EditObjSpace(title, Id, OpType) {
                ...
                HDialog.OpenWin('700', '350', '../EquipmentNew/InspectionStandardEditSpace.aspx' + parameterStr, title, false, function callback(_Data) {
                    if (_Data != "") {
                        HDialog.Info("保存巡检标准成功");
                        LoadBindSpace();
                    }
            ...
            function DelRecord(Ids) {
                HDialog.Prompt('是否删除选中标准!', function () {
                    $.tool.DataGet('CsEquipment', 'DelInspectionStandard', 'IdList=' + Ids,
                        function Init() {
                        },
            ...
            function DelRecordSpace(Ids) {
                $.tool.DataGet('CsEquipment', 'CanDelInspectionStandardSpace', 'IdList=' + Ids,
                    function Init() {
                    },
                    function callback(_Data) {
                        if (_Data == "true") {
                            HDialog.Prompt('是否删除选中标准!', function () {
                                $.tool.DataGet('CsEquipment', 'DelInspectionStandardSpace', 'IdList=' + Ids,
                                    function Init() {
                                    },
                                    function callback(_Data) {
                                        if (_Data == "true") {
                ...
                [
                    ...
                    }, '-',
                    {
                        ...
                        handler: function () {
                            ...
                            EditDetailObj("修改工艺路线", row.InspectionStandardId, row.InspectionStandardName, "edit", row.DetailId);
                        }
                    }, '-',
                    {
                        text: '删除',
                ...
                [
                    ...
                    }, '-',
                    {
                        ...
                        handler: function () {
                            ...
                            EditDetailObjSpace("修改工艺路线", row.InspectionStandardId, row.InspectionStandardName, "edit", row.DetailId);
                        }
                    }, '-',
                    {
                        text: '删除',
            ...
            //编辑工艺路线
            function EditDetailObj(title, InspectionStandardId, InspectionStandardName, OpType, DetailId) {
                var parameterStr = '?OpType=' + OpType + '&InspectionStandardId=' + InspectionStandardId + "&InspectionStandardName=" + InspectionStandardName + "&DetailId=" + DetailId;
                HDialog.OpenWin('700', '440', '../EquipmentNew/InspectionStandardDetailEdit.aspx' + parameterStr, title,
                    false, function callback(_Data) {
                        if (_Data != "") {
            ...
            //编辑工艺路线
            function EditDetailObjSpace(title, InspectionStandardId, InspectionStandardName, OpType, DetailId) {
                var parameterStr = '?OpType=' + OpType + '&InspectionStandardId=' + InspectionStandardId + "&InspectionStandardName=" + InspectionStandardName + "&DetailId=" + DetailId;
                HDialog.OpenWin('700', '470', '../EquipmentNew/InspectionStandardDetailEditSpace.aspx' + parameterStr, title,
                    false, function callback(_Data) {
                        if (_Data != "") {
                            HDialog.Info("保存工艺路线成功");
                            LoadBindDetailSpace();
            ...
            function DelRecordDetail(Ids) {
                HDialog.Prompt('是否删除该工艺路线!', function () {
                    $.tool.DataGet('CsEquipment', 'DelInspectionStandardDetail', 'IdList=' + Ids,
                        function Init() {
                        },
                        function callback(_Data) {
                            if (_Data == "true") {
            ...
            function DelRecordDetailSpace(Ids) {
                HDialog.Prompt('是否删除该工艺路线!', function () {
                    $.tool.DataGet('CsEquipment', 'DelInspectionStandardDetailSpace', 'IdList=' + Ids,
                        function Init() {
                        },
                        function callback(_Data) {
                            if (_Data == "true") {
            ...
            function LoadBind() {
                ...
                $("#DivContainer").datagrid({
                    url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CsEquipment&Command=GetInspectionStandardList' + ParameterStr,
                    method: "get",
                    loadMsg: '数据加载中,请稍候...',
                    nowrap: false,
                    title: "巡检标准",
            ...
            function LoadBindDetail() {
                var InspectionStandardIdStr = "";
                var SelecteRow = $("#DivContainer").datagrid("getSelected");
                if (SelecteRow != null) {
                    InspectionStandardIdStr = SelecteRow.Id;
                } else {
                    InspectionStandardIdStr = "--";// 没有选中就不查询数据出来
                }
                var ParameterStr = "&InspectionStandardId=" + InspectionStandardIdStr;

                url = '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CsEquipment&Command=GetInspectionStandardDetailList' + ParameterStr;
            ...
            function LoadBindSpace() {
                $("#DivContainerSpace").datagrid({
                    url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CsEquipment&Command=GetInspectionStandardSpaceList',
                    method: "get",
                    loadMsg: '数据加载中,请稍候...',
                    nowrap: false,
                    title: "巡检标准",
            ...
            function LoadBindDetailSpace() {
                ...
                url = '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CsEquipment&Command=GetInspectionStandardDetailSpaceList' + ParameterStr;
