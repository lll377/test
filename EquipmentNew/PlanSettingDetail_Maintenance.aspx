<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlanSettingDetail_Maintenance.aspx.cs" Inherits="M_Main.EquipmentNew.PlanSettingDetail_Maintenance" %>
...
<body>
    <form id="frmForm" runat="server" style="overflow: hidden;">
        <div class="Container">
            <table class="SearchTable">
                <tr>
                    ...
                    <td class="TdContentSearch">
                        <input id="SpaceId" type="hidden" name="SpaceId" />
                        <input id="SpaceName" name="SpaceName" class="easyui-validatebox" style="border: 1px #cccccc solid; height: 22px; line-height: 22px; width: 70%;" onclick="SelSpace();" data-options="required:true" readonly="readonly" />
                    </td>
                ...
                <tr>
                    ...
                    <td class="TdContentSearch" colspan="5">
                        ...
                        <input id="SystemName" name="SystemName" class="easyui-validatebox" style="border: 1px #cccccc solid; height: 22px; line-height: 22px; width: 95.6%;" onclick="SelSystem();" data-options="required:true" readonly="readonly" />
                    </td>
                    <td class="TdTitle">维保类别</td>
                    <td class="TdContentSearch">
                        <select id="MaintenanceType" name="MaintenanceType" runat="server" isdctype="true" dctype="维保类别" style="width: 70%; border: 1px #cccccc solid; height: 22px;" class="easyui-validatebox" data-options="required:true">
                            <option value=""></option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="TdContentSearch" colspan="7">
                        <textarea id="Content" name="Content" style="width: 95.6%; border: 1px solid #cccccc; height: 44px;"></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="TdTitle">责任岗位</td>
                    <td class="TdContentSearch">
                        <input id="TaskRoleName" name="TaskRoleName" class="easyui-validatebox" data-options="required:true" runat="server" readonly="readonly" type="text" style="border: 1px #cccccc solid; height: 22px; line-height: 22px; width: 60%;" onclick="SelRole('Task')" />
                    ...
                    <td class="TdContentSearch">
                        <input id="TaskUserName" name="TaskUserName" class="easyui-validatebox" runat="server" readonly="readonly" type="text" style="border: 1px #cccccc solid; height: 22px; line-height: 22px; width: 60%;" onclick="SelUser('Task')" />
                    ...
                    <td class="TdTitle">维保机房是否扫码</td>
                    <td class="TdContentSearch">
                        <select id="SpaceIsScan" name="SpaceIsScan" class="easyui-validatebox" style="border: 1px #cccccc solid; height: 22px; line-height: 22px; width: 70%;" data-options="required:true">
                            <option value="1">是</option>
                            <%--<option value="0">否</option>6015 设备巡检 维保界面统一改动 将机房是否扫码选项锁死 选择是--%>
                        </select>
                    </td>
                </tr>
                <tr>
                    <td class="TdTitle">维保设备是否拍照</td>
                    <td class="TdContentSearch">
                        <select id="EquipmentIsPhotograph" name="EquipmentIsPhotograph" class="easyui-validatebox" style="border: 1px #cccccc solid; height: 22px; line-height: 22px; width: 70%;" data-options="required:true">
                            <option value="1">是</option>
                            <option value="0">否</option>
                        </select>
                    </td>
                    <td class="TdTitle">异常设备是否拍照</td>
                    <td class="TdContentSearch">
                        <select id="ProblemEquipmentIsPhotograph" name="ProblemEquipmentIsPhotograph" class="easyui-validatebox" style="border: 1px #cccccc solid; height: 22px; line-height: 22px; width: 70%;" data-options="required:true">
                            <option value="1">是</option>
                            <option value="0">否</option>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td class="TdTitle">任务完成验收岗位</td>
                    <td class="TdContentSearch">
                        <input id="CheckRoleName" name="CheckRoleName" class="easyui-validatebox" runat="server" readonly="readonly" type="text" style="border: 1px #cccccc solid; height: 22px; line-height: 22px; width: 60%;" onclick="SelRole('Check')" />
                        <input type="hidden" id="CheckRoleCode" name="CheckRoleCode" runat="server" />
                        <a href="#" class="easyui-linkbutton" onclick="ClearRole('Check');" data-options="iconCls:'icon-clear',plain:true"></a>
                    </td>
                    <td class="TdTitle">任务完成验收人</td>
                    <td class="TdContentSearch">
                        <input id="CheckUserName" name="CheckUserName" class="easyui-validatebox" runat="server" readonly="readonly" type="text" style="border: 1px #cccccc solid; height: 22px; line-height: 22px; width: 60%;" onclick="SelUser('Check')" />
                        <input type="hidden" id="CheckUserCode" name="CheckUserCode" runat="server" />
                        <a href="#" class="easyui-linkbutton" onclick="ClearUser('Check');" data-options="iconCls:'icon-clear',plain:true"></a>
                    </td>
                ...
                <tr>
                    ...
                    <td class="TdContentSearch" colspan="7">
                        <input id="PlanName" name="PlanName" class="easyui-validatebox" runat="server" type="text" data-options="required:true" style="border: 1px #cccccc solid; height: 22px; line-height: 22px; width: 95.6%;" />
                    </td>
                </tr>
                <tr>
                    <td class="TdTitle">备注</td>
                    <td class="TdContentSearch" colspan="7">
                        <textarea id="Remark" name="Remark" style="width: 95.6%; border: 1px solid #cccccc; height: 44px;"></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="TdTitle">频次详情</td>
                    <td class="TdContentSearch" colspan="7">
                        <table class="time" style="width: 96%">
                            <tr id="TimeTr1">
        ...
        <div style="text-align: center; bottom: 0; position: fixed; width: 100%; height: 50px; line-height: 50px; background-color: #f5f5f5; margin-right: 45px; border-top: 1px solid #E7EAEC;">
            ...
            <input type="button" class="button" value="审核通过" id="BtnCheckPass" onclick="SaveCheckPass('1');" />
            <input type="button" class="button" value="审核不通过" id="BtnCheckNoPass" onclick="SaveCheckPass('0');" />
            <input type="button" class="button" value="驳回" id="BtnReturn" onclick="SaveCheckPass('2');" />
            <input type="button" class="button" value="返回" id="BtnClose" onclick="Close();" />
        </div>
        <input type="hidden" id="OldSpaceId" name="OldSpaceId" />
        <input type="hidden" id="OldSystemId" name="OldSystemId" />
        <input type="hidden" id="OldMaintenanceType" name="OldMaintenanceType" />
        <input type="hidden" id="OpType" name="OpType" />
        <input type="hidden" id="Copys" name="Copys" />
        ...
        <script type="text/javascript">
            ...
            function SelSystem() {
                ...
                if (SpaceId == null || SpaceId == "" || SpaceId == undefined) {
                    HDialog.Info("请先选择设备空间");
                    return;
                }
                HDialog.Open('700', '450', '../EquipmentNew/SelSystem.aspx?type=more&SpaceId=' + SpaceId, '选择设备系统', true, function callback(_Data) {
                    if (_Data != "") {
                        var str = _Data.split('|');
                        $("#SystemId").val(str[0]);
            ...
            function SelUser(type) {
                ...
                localStorage.removeItem('EqRoleCode');
                localStorage.setItem("EqRoleCode", $("#" + type + "RoleCode").val());
                HDialog.Open('650', '600', '../EquipmentNew/SelUser.aspx?IslocalStorage=1', '选择人员', false, function callback(_Data) {
                    if (_Data) {
            ...
            function SetPlanName() {
                ...
                if ($("#Frequency").find("option:selected").text() != "" &&
                    ...
                    $("#PlanName").val($("#CommName").val() + "-" + $("#SystemName").val() + "-" + $("#SpaceName").val() + "-" + Frequency);
                } else {
                    $("#PlanName").val("");
                }
            }
            ...
            function Save() {
                ...
                if ($("#OpType").val() == "edit") {
                    if ($("#OldSpaceId").val() != $("#SpaceId").val() || $("#OldSystemId").val() != $("#SystemId").val() || $("#OldMaintenanceType").val() != $("#MaintenanceType").val()) {
                        HDialog.Prompt('修改设备空间或系统或维保类别后将刷新工艺路线信息', function () {
                            SavePlan(work, 1);
                        });
                    } else {
                        SavePlan(work, 0);
            ...
            function SavePlan(work, NeedClear) {
                $.tool.DataPostChk('frmForm', 'CsEquipment', 'SavePlan_Maintenance', $('#frmForm').serialize() + work + '&NeedClear=' + NeedClear,
                    function Init() {
                    },
            ...
            function SaveAuditing() {
                $.tool.DataGet('CsEquipment', 'ExaminePlan_Maintenance', 'Id=' + $("#Id").val(),
                    function Init() {
                    },
                    function callback(_Data) {
                        if (_Data > '')
            ...
            function SaveCheckPass(IsPass) {
                $.tool.DataGet('CsEquipment', 'CheckPassPlan_Maintenance', 'Id=' + $("#Id").val() + '&IsPass=' + IsPass,
                    function Init() {
                    },
                    function callback(_Data) {
                        HDialog.Info(_Data);
            ...
            function FrequencyChange(obj, varObjects) {
                ...
                if (($("#OpType").val() == "edit" || $("#Copys").val() == "1") && varObjects > '') {
                    SetCheck(varObjects)
                } else {
                    SetPlanName();
                }
            ...
            function Load() {
                ...
                $("#Copys").val(GetQueryString('Copys'));
                $("#CommId").val(GetQueryString('CommId'));
                $("#CommName").val(decodeURI(GetQueryString('CommName')));
                $("#CanEdit").val(GetQueryString('CanEdit'));
                GetMaxSort();
                if ($("#OpType").val() == "edit" || $("#Copys").val() == "1") {
            ...
            function LoadData() {
                $.tool.DataGet('CsEquipment', 'GetPlan_Maintenance', 'page=1&rows=10&Id=' + $("#Id").val() + '&CommId=' + $("#CommId").val(),
                    function Init() {
                    },
                    function callback(_Data) {
                        varObjects = eval("(" + _Data.replace(/\\/g, "/") + ")"); //转换为json对象
                        if ($("#Copys").val() != "1")//复制不需要复制序号
                            $("#Sort").val(varObjects.rows[0].Sort);
                        $("#SpaceId").val(varObjects.rows[0].SpaceId);
                        $("#OldSpaceId").val(varObjects.rows[0].SpaceId);
                        $("#SpaceName").val(varObjects.rows[0].SpaceName);
                        $("#SystemId").val(varObjects.rows[0].SystemId);
                        $("#OldSystemId").val(varObjects.rows[0].SystemId);
                        $("#SystemName").val(varObjects.rows[0].SystemName);
                        ...
                        $("#SpaceIsScan").val(varObjects.rows[0].SpaceIsScan);
                        $("#EquipmentIsPhotograph").val(varObjects.rows[0].EquipmentIsPhotograph);
                        $("#ProblemEquipmentIsPhotograph").val(varObjects.rows[0].ProblemEquipmentIsPhotograph);
                        ...
                        $("#IsFireControl").val(varObjects.rows[0].IsFireControl);
                        $("#IsEnable").val(varObjects.rows[0].IsEnable);
                        $("#PlanName").val(varObjects.rows[0].PlanName);
                        $("#Remark").val(varObjects.rows[0].Remark);
                        $("#MaintenanceType").val(varObjects.rows[0].MaintenanceType);
                        $("#OldMaintenanceType").val(varObjects.rows[0].MaintenanceType);
                        $("#IsAuditing").val(varObjects.rows[0].IsAuditing);
                        $("#CheckRoleName").val(varObjects.rows[0].CheckRoleName);
                        $("#CheckRoleCode").val(varObjects.rows[0].CheckRoleCode);
                        $("#CheckUserName").val(varObjects.rows[0].CheckUserName);
                        $("#CheckUserCode").val(varObjects.rows[0].CheckUserCode);
                        if ($("#Copys").val() == "1") {
                            $("#BtnSave").show();
                            $("#BtnSaveAuditing").hide();
                            $("#BtnCheckPass").hide();
                            ...
                            AuditStateControl(varObjects.rows[0].IsAuditing);
                        }
            ...
            function AuditStateControl(auditState) {
                //判断状态隐藏页面按钮
                switch (auditState) {
                    case "0": //未送审
                        if ($("#CanEdit").val() == "false") {
                ...
                if (GetQueryString('CanPass') == 'false') {
                    $("#BtnCheckPass").hide();
                    $("#BtnCheckNoPass").hide();
                    $("#BtnReturn").hide();
                }
            ...
            function GetMaxSort() {
                $.tool.DataGet('CsEquipment', 'GetPlanMaxSort_Maintenance', 'CommId=' + $("#CommId").val(),
                    function Init() {
                    },
                    function callback(_Data) {
                        varObjects = eval("(" + _Data.replace(/\\/g, "/") + ")"); //转换为json对象
