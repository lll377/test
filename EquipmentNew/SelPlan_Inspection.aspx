<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelPlan_Inspection.aspx.cs" Inherits="M_Main.EquipmentNew.SelPlan_Inspection" %>
    ...
    <form id="frmFrom" runat="server">
        ...
        <script type="text/javascript">
            ...
            var column = [[
                ...
                {
                    field: 'Content', title: '巡检内容', width: 200, align: 'left', sortable: true, formatter: function (value, row, index) {
                        var str = value;
                        if (value.length > 10)
                            str = str.substr(0, 15) + '...';
                        return str;
                ...
                { field: 'TaskUserName', title: '责任人', width: 100, align: 'left', sortable: true },
                {
            ...
            function LoadList() {
                ...
                if ($("#IsSingle").val() == "1") {
                    column = [[
                        ...
                        { field: 'Frequency', title: '巡检频次', width: 120, align: 'left', sortable: true },
                        { field: 'TaskRoleName', title: '责任岗位', width: 120, align: 'left', sortable: true },
                        { field: 'TaskUserName', title: '责任人', width: 100, align: 'left', sortable: true },
                        {
                            field: 'Remark', title: '备注', width: 150, align: 'left', sortable: true, formatter: function (value, row, index) {
                ...
                $("#TableContainer").datagrid({
                    url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CsEquipment&Command=GenerationGetPlan_Inspection&' + $('#frmFrom').serialize(),
                    method: "get",
                    loadMsg: '数据加载中,请稍候...',
                    nowrap: false,
                    rownumbers: true,
