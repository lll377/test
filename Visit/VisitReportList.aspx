<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VisitReportList.aspx.cs" Inherits="M_Main.Visit.VisitReportList" %>
...
<body class="gray-bg">
    <form id="frmForm" runat="server">
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-sm-4" style="font-size: 15px; font-family: 微软雅黑; line-height: 30px;">
                                 <a id="Rp_01" data-url="../Visit/ReportStatistics/VisitingSituation_ReportStatistics.aspx">（1）拜访汇总统计</a><br />
                                    <a id="Rp_02" data-url="../Visit/ReportStatistics/VisitingScoresSituation_ReportStatistics.aspx">（2）拜访得分统计</a><br />
                                      <a id="Rp_03" data-url="../Visit/ReportStatistics/VisitingSuggestedClass_ReportStatistics.aspx">（3）拜访建议统计</a><br />
                                    <a id="Rp_04" data-url="../Visit/ReportStatistics/VisitingRoomCustomers_ReportStatistics.aspx">（4）拜访房屋统计</a><br />
                                    </div>
                                <div class="col-sm-4" style="font-size: 15px; font-family: 微软雅黑; line-height: 30px;">
        ...
        <script type="text/javascript" src="../Jscript-Ui/hplus/js/content.min.js?v=1.0.0"></script>
