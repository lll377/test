<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendLetterBrowse.aspx.cs" Inherits="M_Main.UrgeFees.SendLetterBrowse" %>
                    ...
                    //}, '-',
                    {
                        ...
                        handler: function () {
                            ...
                            if (row != undefined) {
                                var w = $(window).width();
                                var h = $(window).height();
                                HDialog.Open(w, h, '../UrgeFees/SendLetterDetailFrame.aspx?OPType=Edit&SendLetterID=' + row.SendLetterID, "欠费明细", false, function callback(_Data) {
                                });
                        ...
                        handler: function () {
                            ...
                            if (row != undefined) {
                                HDialog.Prompt('是否删除该项', function () {
                                    $.tool.DataGet('SendLetter', 'SendLetterDelete', 'SendLetterID=' + row.SendLetterID,
                                            function Init() {
                                            },
