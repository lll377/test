<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UrgeFeesDetailNew.aspx.cs" Inherits="M_Main.UrgeFees.UrgeFeesDetailNew" %>


<!DOCTYPE HTML >
<html>
<head>
    <title>UrgeFeesDetailNew</title>
    ...
    function checkFormAll(chk) {
        ...
        form = document.getElementById("UrgeFeesDetailNew");
        var chkval;
        ...
        //alert(getObject("SelReturn").value)
    }
    ...
    function btnClear_OnClick() {
        UrgeFeesDetailNew.CustID.value = "";
        UrgeFeesDetailNew.CustName.value = "";
        UrgeFeesDetailNew.hiCustName.value = "";

        UrgeFeesDetailNew.RoomID.value = "";
        UrgeFeesDetailNew.RoomSign.value = "";
        UrgeFeesDetailNew.hiRoomSign.value = "";

        UrgeFeesDetailNew.CostID.value = "";
        UrgeFeesDetailNew.hiCostName.value = "";
        UrgeFeesDetailNew.CostName.value = "";

        UrgeFeesDetailNew.CustTypeID.value = "全部";
        UrgeFeesDetailNew.ChargeTypeID.value = "";
        UrgeFeesDetailNew.IsPay.value = "";

        UrgeFeesDetailNew.StartDate.value = "";
        UrgeFeesDetailNew.EndDate.value = "";
    ...
    function btnSelRoom_OnClick() {
        ...
        if (varReturn != "") {//**获得返回 刷新
            ...
            UrgeFeesDetailNew.RoomID.value = varObjects[0];
            UrgeFeesDetailNew.RoomSign.value = varObjects[2];
            UrgeFeesDetailNew.hiRoomSign.value = varObjects[2];

            UrgeFeesDetailNew.CustID.value = varObjects[1];
            UrgeFeesDetailNew.CustName.value = varObjects[3];
            UrgeFeesDetailNew.hiCustName.value = varObjects[3];
            //alert(varReturn);
    ...
    function btnSelCust_OnClick() {
        ...
        if (varReturn != "") {//**获得返回 刷新
            ...
            UrgeFeesDetailNew.CustID.value = varObjects[0];
            UrgeFeesDetailNew.CustName.value = varObjects[1];
            UrgeFeesDetailNew.hiCustName.value = varObjects[1];
    ...
    function SelRoomID_OnChange() {
        UrgeFeesDetailNew.RoomID.value = UrgeFeesDetailNew.SelRoomID.options[UrgeFeesDetailNew.SelRoomID.selectedIndex].value;
        UrgeFeesDetailNew.RoomSign.value = UrgeFeesDetailNew.SelRoomID.options[UrgeFeesDetailNew.SelRoomID.selectedIndex].text;
        UrgeFeesDetailNew.hiRoomSign.value = UrgeFeesDetailNew.RoomSign.value;
    ...
    function btnSelCost_OnClick() {
        ...
        if (varReturn != "") {//**获得返回 刷新
            ...
            UrgeFeesDetailNew.CostID.value = varObjects[0];
            UrgeFeesDetailNew.CostName.value = varObjects[2];
            UrgeFeesDetailNew.hiCostName.value = varObjects[2];
...
<body>
    <form id="UrgeFeesDetailNew" method="post" runat="server">
        ...
        <input id="ArrearsID" type="hidden" name="ArrearsID" runat="server">
            ...
            <table class="DialogTable">
                ...
                <tr>
                    ...
                    <td class="formTable_ItemInput" width="40%">
                      ...
                      <tr>
                    <td class="TdTitle">是否催费</td>
                    <td class="TdContentSearch">
                        <select id="ISUrgeFees" class="easyui-combobox" name="ISUrgeFees" runat="server">
                    ...
                    <td class="TdContentSearch">
                        <select id="IsSendLetter" class="easyui-combobox" name="IsSendLetter" runat="server">
										  <option selected value="">全部</option>
                            <option Value="是" >是</option>
										<option Value="否"  >否</option>
						 </select>
        ...
        <div id="SearchDlg3" class="easyui-dialog" title="登记催费信息" data-options="iconCls:'icon-search',closed: true,modal:true"
            style="width: 750px; height: 350px;">
            <table class="DialogTable">
                    <tr>
                       <td class="TdTitle">跟进人员</td>
                    <td class="TdContentSearch">
                    
                        <input class="easyui-validatebox" id="UserName"  style="width:156px;" readonly name="UserName" runat="server">
                          </td>

               
                    <td class="TdTitle">跟进时间</td>
                    <td class="TdContentSearch">
                        <input type="text" class="Wdate"  editable="false"   readonly  style="width: 189px;" runat="server" onclick="WdatePicker({   dateFmt: 'yyyy-MM-dd HH:mm:ss', alwaysUseStartDate: true })" id="FollowUpDate" name="FollowUpDate" /></td>
                </tr>
                <tr>
                    ...
                    <tr>                   
                    <td class="TdTitle">跟进内容</td>
                    <td class="TdContentSearch" colspan="3"> 
                        <input id="FollowUpContent" class="easyui-textbox" style="width:88%;height:60px;"   data-options="required:true" 
                            name="FollowUpContent" runat="server" /> 
                        </td>  
...
<%--                <tr>
        ...
        <script type="text/javascript">
            ...
            function IsLateFee_Click() {
                UrgeFeesDetailNew.BankBeginDate.disabled = !IsLateFee.checked;
            }
            ...
            var toolbar = [
                ...
                //    handler: function () {
                //        window.location.href = "BankSurrExcelCre.aspx?random=" + Math.random() + GetParam();
                //    }
                //}
                , '-',
            ...
            function GetParam() {
                ...
                str += '&ArrearsID=' + $('#ArrearsID').val().trim();
            ...
            function LoadList() {
                ...
                $("#TableContainer").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        param = $.JQForm.GetParam("UrgeFeesNew", "ArrearsReasonDetail", "TableContainer", param);
                    },
            ...
            function btnCre() {
                ...
                $('#SearchDlg').dialog('close');
                $.tool.DataPostChk('UrgeFeesDetailNew', 'UrgeFeesNew', 'ArrearsReasonSave', $('#UrgeFeesDetailNew').serialize(),
                    function Init() {
                    },
                    function callback(_Data) {
                        var r = _Data;
            ...
            function CheckSelAll(IsNoPay) {
                ...
                //alert($('#UrgeFeesDetailNew').serialize());
                if (row != '') {
                    $.tool.DataPostChk('UrgeFeesDetailNew', 'UrgeFeesNew', 'UpdateAllIs', $('#UrgeFeesDetailNew').serialize() + "&IsNoPay=" + IsNoPay,
                        function Init() {
                        },
                        function callback(_Data) {
                            var r = _Data;
            ...
            function CheckSel(IsNoPay) {
                ...
                if (row != '') {
                    ...
                    if (row2 != '') {
                        ...
                        $.tool.DataPostChk('UrgeFeesDetailNew', 'UrgeFeesNew', 'UpdateIs', $('#UrgeFeesDetailNew').serialize() + "&IsNoPay=" + IsNoPay,
                            function Init() {
                            },
                            function callback(_Data) {
                                var r = _Data;
