<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InspectionPlanMaintenanceClose_Patrol.aspx.cs" Inherits="M_Main.ComprehensivePatrols.InspectionPlanMaintenanceClose_Patrol" %>
...
<body>
    <form id="frmFrom" runat="server">
        ...
        <script type="text/javascript">
            function Save() {
                $.tool.DataPostChk('frmFrom', 'CpComPatrols', 'SaveInspectionPlanMaintenanceColse_Patrol', $('#frmFrom').serialize(),
                    function Init() {
                    },
