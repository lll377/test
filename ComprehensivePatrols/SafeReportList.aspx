<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SafeReportList.aspx.cs" Inherits="M_Main.ComprehensivePatrols.SafeReportList" %>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="row">
                                <div class="col-sm-4" style="font-size: 15px; font-family: 微软雅黑; line-height: 30px;">
                                    <a id="Rp_01" data-url="../ComprehensivePatrols/SafeTaskStatistics_TaskLevel.aspx">1、任务统计表</a><br />
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4" style="font-size: 15px; font-family: 微软雅黑; line-height: 30px;">
                                   <a id="Rp_02" data-url="../ComprehensivePatrols/ScanExceptionStatistics_TaskLevel.aspx">2、扫码异常统计表</a><br />
                                </div>
                            </div>
                        </div>
                    </div>
