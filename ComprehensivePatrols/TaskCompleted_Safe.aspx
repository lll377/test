<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskCompleted_Safe.aspx.cs" Inherits="M_Main.ComprehensivePatrols.TaskCompleted_Safe" %>
    ...
    <form id="frmFrom" runat="server">
        ...
        <script type="text/javascript">
            ...
            function Export() {
                ...
                param.IsZip = "否";
                param.TableName = "安全管理任务执行跟进（已完成）";
                param.Class = "CpComPatrols";
                param.Method = "ExportCpPlanTaskList_Safe";
                window.open("/HM/M_Main/HC/Export.aspx?" + $.param(param) + "&Flag=已完成");
            }
            ...
            function LoadList() {
                ...
                $("#DivContainer").datagrid({
                    url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CpComPatrols&Command=GetCpPlanTaskList_Safe&Flag=已完成&' + $("#frmFrom").serialize(),
                    method: "get",
                    loadMsg: '数据加载中,请稍候...',
                    nowrap: false,
                    pageSize: 20,
