<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CpPlanExecutionFrame_Patrol.aspx.cs" Inherits="M_Main.ComprehensivePatrols.CpPlanExecutionFrame_Patrol" %>
            ...
            <div id="layout_center" data-options="region:'center',border:true">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        <li class="active" refpage="TaskNotComplete_Patrol" refsel="1"><a data-toggle="tab" href="#tab-1" aria-expanded="true">未完成任务</a>
                        </li>
                        <li class="" refpage="TaskExpired_Patrol" refsel="0"><a data-toggle="tab" href="#tab-2" aria-expanded="false">已过期任务</a>
                        </li>
                        <li class="" refpage="TaskCompleted_Patrol" refsel="0"><a data-toggle="tab" href="#tab-3" aria-expanded="false">已完成任务</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div id="tab-1" class="tab-pane active">
                            <div class="panel-body" style="padding: 0px;">
                                <iframe id="TaskNotComplete_Patrol" src="" style="width: 100%; border: none;" class="iframe"></iframe>
                            </div>
                        </div>
                        <div id="tab-2" class="tab-pane">
                            <div class="panel-body" style="padding: 0px;">
                                <iframe id="TaskExpired_Patrol" src="" style="width: 100%; border: none;" class="iframe"></iframe>
                            </div>
                        </div>
                        <div id="tab-3" class="tab-pane">
                            <div class="panel-body" style="padding: 0px;">
                                <iframe id="TaskCompleted_Patrol" src="" style="width: 100%; border: none;" class="iframe"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            function LoadOrganTree() {
                $("#treeOrgan").tree({
                    ...
                    onBeforeLoad: function (row, param) {
                        localStorage.removeItem('CpCommId_Patrol');
                    ...
                    onSelect: function (row) {
                        ...
                        //if (isLeaf) {
                        //    localStorage.setItem("CpCommId_Patrol", row.attributes.CommID);
                        ...
                        $(".tabs-container li").each(function () {
                            if ($(this).attr("refpage") != page) {
                                ...
                                if (GetQueryString('isDesk') == '1') {
                                    $("#" + page).attr("src", page + ".aspx?isDesk=1&typename=" + encodeURI(encodeURI(decodeURI(GetQueryString('typename')))) + "&CommID=" + row.attributes.CommID);
                                } else {
            ...
            $(".tabs-container li").click(function () {
                ...
                if (refsel == 0) {
                    ...
                    if (SelecteTreeNode != null) {
                        localStorage.setItem("CpCommId_Patrol", SelecteTreeNode.attributes.CommID);
