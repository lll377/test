<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InspectionPlanMaintenanceClose.aspx.cs" Inherits="M_Main.ComprehensivePatrols.InspectionPlanMaintenanceClose" %>
...
<body>
    <form id="frmFrom" runat="server">
        ...
        <script type="text/javascript">
            function Save() {
                $.tool.DataPostChk('frmFrom', 'CpComPatrols', 'SaveInspectionPlanMaintenanceColse', $('#frmFrom').serialize(),
                    function Init() {
                    },
