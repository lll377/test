<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskNotComplete_Patrol.aspx.cs" Inherits="M_Main.ComprehensivePatrols.TaskNotComplete_Patrol" %>
        ...
        <script type="text/javascript">
            ...
            function LoadList() {
                ...
                $("#DivContainer").datagrid({
                    url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CpComPatrols&Command=GetCpPlanTaskList_Patrol&Flag=未完成&' + $("#frmFrom").serialize(),
                    method: "get",
                    loadMsg: '',
                    nowrap: false,
            ...
            function Load() {
                ...
                $("#typename").val(decodeURI(GetQueryString('typename')));
                InitTableHeight();
                LoadList();
                LoadTaskLevel();
            }
