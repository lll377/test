<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComprehensivePatrolsFiles_Ambient.aspx.cs" Inherits="M_Main.ComprehensivePatrols.ComprehensivePatrolsFiles_Ambient" %>
        ...
        <script type="text/javascript">
            ...
            function DelRecord(FileId) {
                $.messager.confirm('确定', '是否删除该项', function (r) {
                    if (r) {
                        $.tool.DataGet('CpComPatrols', 'DelCpFile_Ambient', 'FileId=' + FileId + '&CommId=' + $("#CommId").val(),
                            function Init() {
                            },
            ...
            function LoadList() {
                ...
                $("#TableContainer").datagrid({
                    url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CpComPatrols&Command=GetCpPlanTaskFilesList_Ambient&' + $('#frmFrom').serialize(),
                    method: "get",
                    loadMsg: '数据加载中,请稍候...',
                    nowrap: false,
