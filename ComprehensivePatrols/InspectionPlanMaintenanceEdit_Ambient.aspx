<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InspectionPlanMaintenanceEdit_Ambient.aspx.cs" Inherits="M_Main.ComprehensivePatrols.InspectionPlanMaintenanceEdit_Ambient" %>
...
<body>
    <form id="frmFrom" runat="server">
        ...
        <script type="text/javascript">
            function Load() {
                if ($("#OpType").val() == 'Edit') {
                    $.tool.DataGet('CpComPatrols', 'SelInspectionPlanMaintenance_Ambient', $('#frmFrom').serialize(),
                        function Init() {
                        },
            ...
            function Save() {
                ...
                $.tool.DataPostChk('frmFrom', 'CpComPatrols', 'SaveInspectionPlanMaintenanceEdit_Ambient', $('#frmFrom').serialize(),
                    function Init() {
                    },
                    function callback(_Data) {
                        HDialog.Info("修改成功!");
            ...
            $("#SeeHistory").click(function () {
                HDialog.Open('800', '500', '../ComprehensivePatrols/SeeHistory_Ambient.aspx?TaskId=' + $("#TaskId").val() + '&CommId=' + $("#CommId").val(), '查看历史修改记录', true, function callback(_Data) {
