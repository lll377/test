<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CpTaskStatistics_TaskLevel.aspx.cs" Inherits="M_Main.ComprehensivePatrols.CpTaskStatistics_TaskLevel" %>
...
<body>
    <form id="frmForm" runat="server">
            ...
            <table class="SearchTable" style="width: 100%; font-size: 12px; font-family: 微软雅黑;">
                ...
                <tr>
                    ...
                    <td class="TdContentSearch">
                        <select id="LevelId" name="LevelId" runat="server" class="easyui-combobox" data-options="editable:false,multiple: true,panelHeight:'150px',valueField:'id',textField:'text'" style="width: 98%;">
                        </select>
                    </td>
        ...
        <input type="hidden" id="TaskName" name="TaskName" value="核查任务统计-按任务级别" />
        <script type="text/javascript">
            ...
            function bindLevel() {
                $.tool.DataPostNoLoading('CpComPatrols', 'GetPatrolLevelList', 'page=1&rows=10000&TaskTypeName=品质核查',
                    function Init() {
                    },
            ...
            var column = [[
                ...
                { field: 'RectificationNum', title: '整改报告提交数', width: 120, align: 'left', sortable: true },
                { field: 'RectificationCompleteNum', title: '整改报告完成数', width: 120, align: 'left', sortable: true },
                { field: 'RectificationCompleteRate', title: '整改报告完成率（%）', width: 120, align: 'left', sortable: true },
                { field: 'RectificationAcceptanceNum', title: '整改报告验收数', width: 120, align: 'left', sortable: true },
                { field: 'RectificationAcceptanceRate', title: '整改报告验收率（%）', width: 120, align: 'left', sortable: true }
            ]];
            ...
            var toolbar = [
                {
                    ...
                    handler: function () {
                        ...
                        //window.open("CpReportExcel.aspx?CommId=" + $('#CommId').val() + '&LevelId=' + $("#LevelId").combobox('getValues') + '&BeginTime=' + $('#BeginTime').val() + '&EndTime=' + $('#EndTime').val() + '&TaskName=' + $('#TaskName').val());
            ...
            function LoadList(str) {
                var urls = null;
                if (str != "") {
                    urls = '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CpComPatrols&Command=CpTaskStatistics_TaskLevel&' + $("#frmForm").serialize();
                ...
                $("#TableContainer").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        if (str != "") {
                            param = $.JQForm.GetParam("CpComPatrols", "CpTaskStatistics_TaskLevel", "TableContainer", param);
                        }
                    }
                });
