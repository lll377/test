<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlanTemplateList_Ambient.aspx.cs" Inherits="M_Main.ComprehensivePatrols.PlanTemplateList_Ambient" %>
    ...
    <form id="frmFrom" runat="server">
        ...
        <script type="text/javascript">
            ...
            var toolbar = [
                {
                    ...
                    handler: function () {
                        if ($("#CommId").val().length < 3) {
                            ...
                            HDialog.Open(w, '600', '../ComprehensivePatrols/PlanTemplateFrame_Ambient.aspx', '新增计划模板', true, function callback(_Data) {
                                LoadList();
                                ClearStorage();
                            });
                        }
                ...
                , '-',
                {
                    ...
                    handler: function () {
                        ...
                        if (row != "" && row != null && row != undefined) {
                            ...
                            HDialog.Open(w, '600', '../ComprehensivePatrols/PlanTemplateFrame_Ambient.aspx', '复制计划模板', true, function callback(_Data) {
                                LoadList();
                                ClearStorage();
                            });
                        } else {
                ...
                , '-',
                {
                    ...
                    handler: function () {
                        ...
                        if (row.length > 0) {
                            ...
                            HDialog.Open('720', '190', '../ComprehensivePatrols/PlanTaskUserEdit_Ambient.aspx?Id=' + str + '&CommId=' + row[0].CommId, '修改', true, function callback(_Data) {
                                LoadList();
                            });
                        } else {
            ...
            function ShowPlanDlg(PlanId, CommId, CommName, AddUserCode, IsAuditing) {
                ...
                HDialog.Open(w, '600', '../ComprehensivePatrols/PlanTemplateFrame_Ambient.aspx', '计划模板详情', false, function callback(_Data) {
                    LoadList();
                    ClearStorage();
                });
            }
            ...
            function DelRecordById(Id, LevelId) {
                $.tool.DataGet('CpComPatrols', 'ExaminePlanTemplateGetCheck', 'LevelId=' + LevelId,
                    ...
                    function callback(_Data) {
                        if (_Data == '1') {
                            $.tool.DataGet('CpComPatrols', 'DelPlanTemplateList_Ambient', 'Id=' + Id,
                                function Init() {
                                },
                                function callback(_Data) {
                                    LoadList();
            ...
            function Examine(Id, LevelId) {
                $.tool.DataGet('CpComPatrols', 'ExaminePlanTemplateGetAuditing', 'LevelId=' + LevelId,
                    ...
                    function callback(_Data) {
                        if (_Data == '1') {
                            HDialog.Open('500', '170', '../ComprehensivePatrols/PlanTemplateAuditing_Ambient.aspx?PlanId=' + Id, '审核', true, function callback(_Data) {
                                LoadList();
                            });
                        }
                        else {
            ...
            function Enable(Id, LevelId) {
                $.tool.DataGet('CpComPatrols', 'ExaminePlanTemplateGetAuditing', 'LevelId=' + LevelId,
                    ...
                    function callback(_Data) {
                        if (_Data == '1') {
                            $.tool.DataGet('CpComPatrols', 'EnablePlanTemplateById_Ambient', 'PlanId=' + Id,
                                function Init() {
                                },
                                function callback(_Data) {
                                    HDialog.Info("操作成功！");
            ...
            function LoadList() {
                $("#TableContainerTemplate").datagrid({
                    url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CpComPatrols&Command=GetPlanTemplateList_Ambient&' + $('#frmFrom').serialize(),
                    method: "get",
                    title: '',
                    loadMsg: '数据加载中,请稍候...',
                    nowrap: false,
