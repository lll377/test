<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InspectionPlanMaintenanceEdit.aspx.cs" Inherits="M_Main.ComprehensivePatrols.InspectionPlanMaintenanceEdit" %>
...
<body>
    <form id="frmFrom" runat="server">
        ...
        <input type="hidden" id="LevelId" name="LevelId" runat="server" />
        ...
        <script type="text/javascript">
            function Load() {
                if ($("#OpType").val() == 'Edit') {
                    $.tool.DataGet('CpComPatrols', 'SelInspectionPlanMaintenance', $('#frmFrom').serialize(),
                        function Init() {
                        },
            ...
            function Save() {
                ...
                $.tool.DataPostChk('frmFrom', 'CpComPatrols', 'SaveInspectionPlanMaintenanceEdit', $('#frmFrom').serialize(),
                    function Init() {
                    },
                    function callback(_Data) {
                        HDialog.Info("修改成功!");
            ...
            function SelTaskRole() {
                ...
                //HDialog.Open('950', '600', '../ComprehensivePatrols/SelRoleList.aspx?CommId=' + $("#CommId").val() + '&LevelId=' + $("#LevelId").val(), '选择岗位', false, function callback(_Data) {
                //    if (_Data) {
            ...
            $("#SeeHistory").click(function () {
                HDialog.Open('800', '500', '../ComprehensivePatrols/SeeHistory.aspx?TaskId=' + $("#TaskId").val() + '&CommId=' + $("#CommId").val(), '查看历史修改记录', true, function callback(_Data) {
