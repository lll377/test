<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InspectionPlanMaintenanceClose_Safe.aspx.cs" Inherits="M_Main.ComprehensivePatrols.InspectionPlanMaintenanceClose_Safe" %>
...
<body>
    <form id="frmFrom" runat="server">
        ...
        <script type="text/javascript">
            function Save() {
                $.tool.DataPostChk('frmFrom', 'CpComPatrols', 'SaveInspectionPlanMaintenanceColse_Safe', $('#frmFrom').serialize(),
                    function Init() {
                    },
