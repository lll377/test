<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskCompleted_Patrol.aspx.cs" Inherits="M_Main.ComprehensivePatrols.TaskCompleted_Patrol" %>
...
<body style="margin: 0px; padding: 0px; overflow: hidden;">
    <form id="frmFrom" runat="server">
        ...
        <script type="text/javascript">
            ...
            //查看附件
            function OnFileList(TaskId, PointId) {
                HDialog.Open(600, 450, '../ComprehensivePatrols/ComprehensivePatrolsFiles_Patrol.aspx?TaskId=' + TaskId + "&TaskPointId=" + PointId, '查看附件', true, function callback(_Data) {
                });
            }
            //查看对象标准
            ...
            function LoadList() {
                ...
                $("#DivContainer").datagrid({
                    url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CpComPatrols&Command=GetCpPlanTaskList_Patrol&Flag=已完成&' + $("#frmFrom").serialize(),
                    method: "get",
                    loadMsg: '数据加载中,请稍候...',
                    nowrap: false,
