<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CpPlanExecutionFrame_Ambient.aspx.cs" Inherits="M_Main.ComprehensivePatrols.CpPlanExecutionFrame_Ambient" %>
            ...
            <div id="layout_center" data-options="region:'center',border:true" style="overflow: hidden;">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        <li class="active" refpage="TaskNotComplete_Ambient" refsel="1"><a data-toggle="tab" href="#tab-1" aria-expanded="true">未完成任务</a>
                        </li>
                        <li class="" refpage="TaskExpired_Ambient" refsel="0"><a data-toggle="tab" href="#tab-2" aria-expanded="false">已过期任务</a>
                        </li>
                        <li class="" refpage="TaskCompleted_Ambient" refsel="0"><a data-toggle="tab" href="#tab-3" aria-expanded="false">已完成任务</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div id="tab-1" class="tab-pane active">
                            <div class="panel-body" style="padding: 0px;">
                                <iframe id="TaskNotComplete_Ambient" src="" style="width: 100%; border: none;" class="iframe"></iframe>
                            </div>
                        </div>
                        <div id="tab-2" class="tab-pane">
                            <div class="panel-body" style="padding: 0px;">
                                <iframe id="TaskExpired_Ambient" src="" style="width: 100%; border: none;" class="iframe"></iframe>
                            </div>
                        </div>
                        <div id="tab-3" class="tab-pane">
                            <div class="panel-body" style="padding: 0px;">
                                <iframe id="TaskCompleted_Ambient" src="" style="width: 100%; border: none;" class="iframe"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
