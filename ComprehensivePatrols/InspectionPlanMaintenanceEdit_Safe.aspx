<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InspectionPlanMaintenanceEdit_Safe.aspx.cs" Inherits="M_Main.ComprehensivePatrols.InspectionPlanMaintenanceEdit_Safe" %>
...
<body>
    <form id="frmFrom" runat="server">
        ...
        <script type="text/javascript">
            function Load() {
                if ($("#OpType").val() == 'Edit') {
                    $.tool.DataGet('CpComPatrols', 'SelInspectionPlanMaintenance_Safe', $('#frmFrom').serialize(),
                        function Init() {
                        },
            ...
            function Save() {
                ...
                $.tool.DataPostChk('frmFrom', 'CpComPatrols', 'SaveInspectionPlanMaintenanceEdit_Safe', $('#frmFrom').serialize(),
                    function Init() {
                    },
                    function callback(_Data) {
                        HDialog.Info("修改成功!");
            ...
            $("#SeeHistory").click(function () {
                HDialog.Open('800', '500', '../ComprehensivePatrols/SeeHistory_Safe.aspx?TaskId=' + $("#TaskId").val() + '&CommId=' + $("#CommId").val(), '查看历史修改记录', true, function callback(_Data) {
