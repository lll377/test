<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CpReportList.aspx.cs" Inherits="M_Main.ComprehensivePatrols.CpReportList" %>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="row">
                                <div class="col-sm-4" style="font-size: 15px; font-family: 微软雅黑; line-height: 30px;">
                                   <%-- <a id="Rp_01" data-url="../ComprehensivePatrols/CpTaskStatistics_TaskLevel.aspx">1-1、核查任务统计-按任务级别</a><br />
                                    <a id="Rp_02" data-url="../ComprehensivePatrols/CpTaskStatistics_TaskUser.aspx">1-2、核查任务统计-按责任人员</a><br />
                                    <a id="Rp_03" data-url="../ComprehensivePatrols/CpProblemStatistics_Profession.aspx">2-1、核查问题统计-按所属专业</a><br />
                                    <a id="Rp_04" data-url="../ComprehensivePatrols/CpProblemStatistics_TaskType.aspx">2-2、核查问题统计-按所属类别</a><br />
                                    <a id="Rp_05" data-url="../ComprehensivePatrols/CpProblemStatistics_SysPoint.aspx">2-3、核查问题统计-按通用点位</a><br />
                                    <a id="Rp_06" data-url="../ComprehensivePatrols/CpRectification_ProblemType.aspx">3-1、核查整改统计-按问题类型</a><br />
                                    <a id="Rp_07" data-url="../ComprehensivePatrols/CpRectification_Incident.aspx">3-2、核查整改统计-按报事工单</a><br />--%>
                                    <a id="Rp_01" data-url="../ComprehensivePatrols/CpTaskStatistics_TaskLevel.aspx">1、核查任务统计-按任务级别</a><br />
                                    <a id="Rp_02" data-url="../ComprehensivePatrols/CpProblemStatistics_Profession.aspx">2、核查问题统计-按所属专业</a><br />
                                    <a id="Rp_03" data-url="../ComprehensivePatrols/CpProblemStatistics_TaskType.aspx">3、核查问题统计-按所属类别</a><br />
                                    <a id="Rp_04" data-url="../ComprehensivePatrols/CpProblemStatistics_SysPoint.aspx">4、核查问题统计-按通用点位</a><br />
                                    <a id="Rp_05" data-url="../ComprehensivePatrols/CpRectification_ProblemType.aspx">5、核查整改统计-按问题类型</a><br />
                                    <a id="Rp_06" data-url="../ComprehensivePatrols/CpTaskPointDidCount_TaskLevel.aspx">6、点位执行统计-按任务级别</a><br />
                                    <a id="Rp_07" data-url="../ComprehensivePatrols/CpPlanNum_Tasklevel.aspx">7、计划模板统计-按任务级别</a><br />
                                    <%--<a id="Rp_07" data-url="../ComprehensivePatrols/CpTaskStandard_FwGl.aspx">8、品质互检基础标准报表</a><br />--%>
                                </div>
