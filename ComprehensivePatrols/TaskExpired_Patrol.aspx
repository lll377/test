<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskExpired_Patrol.aspx.cs" Inherits="M_Main.ComprehensivePatrols.TaskExpired_Patrol" %>
...
<body style="margin: 0px; padding: 0px; overflow: hidden;">
    <form id="frmFrom" runat="server">
        ...
        <div id="SearchDlg" class="easyui-dialog" title="筛选条件" data-options="iconCls:'icon-search',closed: true,modal:true" style="overflow: scroll; overflow-y: scroll; padding: 5px;">
            <table style="width: 100%; font-size: 12px; font-family: 微软雅黑;" class="SearchTable">
                <tr>
                    <td class="TdTitle">任务类型</td>
                    <td class="TdContentSearch">
                        <select id="TaskType" name="TaskType" isdctype='true' dctype="任务类型" dcname="公区巡查,空房巡查,装修巡查" class="easyui-validatebox">
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td class="TdContentSearch">
                        <input type="text" id="FinishBeginTime" name="EndBeginTime" runat="server" class="easyui-validatebox Wdate" onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd HH:mm:ss' })" onkeypress="CheckDate();" />
                    </td>
                    ...
                    <td class="TdTitle">到</td>
                    <td class="TdContentSearch">
                        <input type="text" id="FinishEndTime" name="EndEndTime" runat="server" class="easyui-validatebox Wdate" onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd HH:mm:ss' })" onkeypress="CheckDate();" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="TdTitle">到</td>
                    <td class="TdContentSearch">
                        <input type="text" id="FinishDidBeginTime" name="EndDidBeginTime" runat="server" class="easyui-validatebox Wdate" onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd HH:mm:ss' })" onkeypress="CheckDate();" />
                    </td>
                    ...
                    <td class="TdTitle">到</td>
                    <td class="TdContentSearch">
                        <input type="text" id="FinishDidEndTime" name="EndDidEndTime" runat="server" class="easyui-validatebox Wdate" onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd HH:mm:ss' })" onkeypress="CheckDate();" />
                    </td>
                </tr>
                <tr>
        ...
        <div id="SearchDlgPoint" class="easyui-dialog" title="筛选条件" data-options="iconCls:'icon-search',closed: true,modal:true" style="overflow: hidden; padding: 5px;">
            <table style="width: 100%; font-size: 12px; font-family: 微软雅黑;" class="SearchTable">
                <tr>
                    <td class="TdTitle">点位编码</td>
                    <td class="TdContentSearch">
                ...
                <tr>
                    <td class="TdTitle">是否扫码</td>
                    <td class="TdContentSearch">
                        <select id="IsScan " name="IsScan" class="easyui-validatebox">
                            <option value=""></option>
                            <option value="0">否</option>
                            <option value="1">是</option>
                        </select>
                    </td>
                    <td class="TdTitle">点位状态</td>
                    <td class="TdContentSearch">
                        <select id="PointState " name="PointState" class="easyui-validatebox">
                            <option value=""></option>
                ...
                <tr>
                    <td class="TdContentSearch" colspan="8" style="text-align: center;">
                        <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-search',width:80" onclick="LoadListDetail();">确定筛选</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-reload',width:80" onclick="btnClearPoint();">清空</a>
                    </td>
                </tr>
            </table>
        </div>
        <input type="hidden" id="TaskId" name="TaskId" />
        <input type="hidden" id="TaskTypeName" name="TaskTypeName" />
        ...
        <script type="text/javascript">
            ...
            function InitTableHeight() {
                ...
                //$("#SearchDlg").css("width", $(window).width() - 150);
            }
            ...
            function SelTaskRole() {
                HDialog.Open('700', '450', '../ComprehensivePatrols/SelSpecificRole.aspx', '选择岗位', true, function callback(_Data) {
                    if (_Data != "") {
            ...
            function btnClear() {
                ...
                $("#FinishDidBeginTime").val("");
                $("#StartDidEndTime").val("");
                $("#FinishDidEndTime").val("");
                $("#PlanState").val("");
                $("#PlanName").val("");
                $("#FrequencyTitle").val("");
                $("#IsClose").val("");
            ...
            var toolbarDetail =
                [{
                    ...
                    handler: function () {
                        ...
                        switch (TaskTypeName) {
                            case "公区巡查":
                                formData.append("TaskName", '公区任务点位');
                                break;
                            case "空房巡查":
                                formData.append("TaskName", '空房任务点位');
                                break;
                            case "装修巡查":
                                formData.append("TaskName", '装修任务点位');
                                break;
                        }
                        $.ajax({
                            type: "POST",
            ...
            var column = [[
                ...
                { field: 'TaskUserName', title: '责任人', width: 80, align: 'left', sortable: true },
                ...
                {
                    field: 'PointNum', title: '任务点位数(计划)', width: 100, align: 'left', sortable: true, formatter: function (value, row, index) {
                        var str = row.PointNum;
                        if (row.TaskTypeName == '空房巡查' || row.TaskTypeName == '装修巡查')
                            str = "<a style=\"color:blue;\" onclick=\"ShowTaskLog('" + row.TaskId + "','" + row.CommId + "')\">" + row.PointNum + "</a>";
                        return str;
                    }
                },
                { field: 'MustCheckPointNum', title: '必查点位数(计划)', width: 100, align: 'left', sortable: true },
                {
                    field: 'OtherPointPercentage', title: '抽查点位覆盖率(计划)', width: 150, align: 'center', sortable: true, formatter: function (value, row, index) {
                        var str;
                        if (row.OtherPointPercentage > 0 && TaskTypeName == '公区巡查') {
                            str = "<a class=\"HrefStyle\" onclick=\"OnOtherPointPercentageList('" + row.TaskId + "');\">" + row.OtherPointPercentage + "%</a>";
                        } else if (row.OtherPointPercentage > 0) {
                ...
                { field: 'DidMustCheckPointNum', title: '必查点位数(实际)', width: 100, align: 'left', sortable: true },
                {
                    field: 'DidOtherPointPercentage', title: '抽查点位覆盖率(实际)', width: 150, align: 'center', sortable: true, formatter: function (value, row, index) {
                        var str;
                        if (row.OtherPointPercentage > 0 && TaskTypeName == '公区巡查') {
                            str = "<a class=\"HrefStyle\" onclick=\"OnOtherPointPercentageList('" + row.TaskId + "');\">" + row.DidOtherPointPercentage + "%</a>";
                        } else if (row.OtherPointPercentage > 0) {
                ...
                { field: 'CloseRemark', title: '关闭说明', width: 250, align: 'left', sortable: true },
                {
                    ...
                    formatter: function (value, row, index) {
                        var str = "";
                        if (row.TaskTypeName == "公区巡查")
                            str = "<a style=\"color:blue\" onclick=\"checkPlanTrajectory('" + row.TaskId + "','" + row.PlanId + "','" + row.CommId + "');\" href=\"#\">查看</a>";
                        return str;
                    }
                }
            ]];
            //公区详情
            var columnDetail_PublicArea = [[
                { field: 'PointCode', title: '点位编号', width: 160, align: 'left', sortable: true },
                { field: 'PointName', title: '点位名称', width: 160, align: 'left', sortable: true },
                { field: 'Addr', title: '点位地址', width: 200, align: 'left', sortable: true },
                {
                    field: 'Map', title: '地图', width: 60, align: 'left', sortable: false, formatter: function (value, row, index) {
                        if (isValueNull(value)) { value = "<a  onclick=\"ShowMap('" + row.Map + "');\"  href=\"javascript:void(0);\">地图</a>"; }
                        return value;
                    }
                }, {
                    field: 'QRCodesPath', title: '二维码', width: 80, align: 'left', sortable: false, formatter: function (value, row, index) {
                        value = "<a  onclick=\"ShowQRCode('" + row.PointId + "','" + row.PointCode + "','" + row.PointName + "','" + row.Addr + "');\" href=\"javascript:void(0);\">二维码</a>";
                        return value;
                    }
                },
                {
                    field: 'IsMustCheck', title: '是否必查', width: 100, align: 'left', sortable: true, formatter: function (value, row, index) {
                        var str = "";
                ...
                {
                    field: 'sm', title: '是否扫码', width: 100, align: 'left', sortable: true, formatter: function (value, row, index) {
                        var str = "";
                        if (row.DidTime != '') {
                            str = "是";
                        } else {
                ...
                { field: 'DidTime', title: '扫码时间', width: 160, align: 'left', sortable: true },
                {
                    field: 'xq', title: '巡查对象/巡查标准', width: 140, align: 'left', sortable: true, formatter: function (value, row, index) {
                        var str = "<a class=\"HrefStyle\" onclick=\"checkPatrolMsg('" + row.TaskId + "','" + row.TaskPointId + "');\">查看</a>";
                        return str;
                    }
                },
                {
                    field: 'fj', title: '任务附件', width: 100, align: 'left', sortable: true, formatter: function (value, row, index) {
                        var str = "<a class=\"HrefStyle\" onclick=\"OnFileList('" + row.TaskId + "','" + row.TaskPointId + "');\">查看附件</a>";
                        return str;
                    }
                },
                {
                    field: 'IncidentCount', title: '整改工单', width: 100, align: 'left', sortable: true, formatter: function (value, row, index) {
                        var str = "<a class=\"HrefStyle\" onclick=\"TaskPointIncident('" + row.TaskPointId + "','" + row.TaskId + "');\">" + value + "</a>";
                        return str;
                    }
                },
                {
                    field: 'PointState', title: '点位状态', width: 100, align: 'left', sortable: true, formatter: function (value, row, index) {
                        var str = "";
                        if (row.PointState == '1') {
                            str = "已完成";
                        } else {
            ...
            //装修详情
            var columnDetail_Renovation = [[
                { field: 'PointCode', title: '点位编号', width: 160, align: 'left', sortable: true },
                { field: 'PointName', title: '点位名称', width: 160, align: 'left', sortable: true },
                { field: 'Addr', title: '点位地址', width: 200, align: 'left', sortable: true },
                {
                    field: 'QRCodesPath', title: '二维码', width: 80, align: 'left', sortable: false, formatter: function (value, row, index) {
                        value = "<a  onclick=\"ShowQRCode('" + row.RenoID + "','" + row.PointCode + "','" + row.PointName + "','" + row.Addr + "');\" href=\"javascript:void(0);\">二维码</a>";
                        return value;
                    }
                },
                {
            ...
            function OnOtherPointPercentageList(TaskId) {
                HDialog.Open(600, 450, '../ComprehensivePatrols/TaskOtherPointPercentageList_PublicArea.aspx?TaskId=' + TaskId, '抽查点位覆盖率', true, function callback(_Data) {
                });
            }
            //点位日志
            function ShowTaskLog(TaskId, CommId) {
                HDialog.Open('600', '450', '../ComprehensivePatrols/TaskPointLog_Patrol.aspx?TaskId=' + TaskId + '&CommId=' + CommId, '点位变化日志', false, function callback(_Data) {
                });
            }

            //查看附件
            function OnFileList(TaskId, TaskPointId) {
                HDialog.Open(600, 450, '../ComprehensivePatrols/ComprehensivePatrolsFiles_Patrol.aspx?TaskId=' + TaskId + "&TaskPointId=" + TaskPointId, '查看附件', true, function callback(_Data) {
                });
            }
            //查看对象标准
            function checkPatrolMsg(TaskId, TaskPointId) {
                HDialog.Open('900', '600', '../ComprehensivePatrols/CpPlanTaskStandard_Patrol.aspx?TaskPointId=' + TaskPointId + "&TaskId=" + TaskId + "&CommId=" + $("#CommId").val(),
                    '对象/标准', true, function callback(_Data) {
                    });
            }
            //查看二维码
            function ShowQRCode(pointId, pointCode, pointName, addr) {
                HDialog.Open('360', '400', '../ComprehensivePatrols/PointShowQrCode_Patrol.aspx?PointId=' + pointId + "&PointCode=" + escape(pointCode) + "&PointName=" + escape(pointName) + "&Addr=" + escape(addr), '查看二维码', true, function callback(_Data) {
                });
            }

            //查看计划轨迹
            function checkPlanTrajectory(TaskId, PlanId, CommId) {
                HDialog.Open('1100', '600', '../ComprehensivePatrols/TaskRouteFrame_PublicArea.aspx?TaskId=' + TaskId + '&PlanId=' + PlanId + '&CommId=' + CommId,
            ...
            function ShowMap(longitude) {
                HDialog.Open('700', '540', '../ComprehensivePatrols/PointShowMap_Patrol.aspx?longitude=' + longitude, '查看地图', true, function callback(_Data) {
                });
            }
            //查看报事
            function TaskPointIncident(TaskPointId, TaskId) {
                HDialog.Open(800, 600, '../ComprehensivePatrols/TaskPointIncident_Patrol.aspx?TaskPointId=' + TaskPointId + "&TaskId=" + TaskId + "&CommId=" + $("#CommId").val(), '查看报事', true, function callback(_Data) {
                });
            }

            function LoadList() {
                $("#CommId").val(localStorage.getItem('CpCommId_Patrol'));
                $("#DivContainer").datagrid({
                    url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CpComPatrols&Command=GetCpPlanTaskList_Patrol&Flag=已过期&' + $("#frmFrom").serialize(),
                    method: "get",
                    loadMsg: '数据加载中,请稍候...',
                    nowrap: false,
            ...
            var toolbarPoint =
                [{
                    ...
                    iconCls: 'icon-search',
                    handler: function () {
                        $('#SearchDlgPoint').parent().appendTo($("form:first"))
                        $('#SearchDlgPoint').dialog('open');
                    }
                }];
            ...
            function LoadListDetail() {
                ...
                switch (TaskTypeName) {
                    case "公区巡查":
                        columnDetail = columnDetail_PublicArea;
                        break;
                    case "空房巡查":
                        columnDetail = columnDetail_VacantRoom;
                        break;
                    case "装修巡查":
                        columnDetail = columnDetail_Renovation;
                        break;
                }
                $("#DivContainerDetail").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        ...
                        param.Command = "GetCpPlanTaskPointList_Patrol";
                        param.TaskId = Id;
                        param.CommId = $("#CommId").val();
                        param.PointCode = $("#PointCode").val();
                        param.PointName = $("#PointName").val();
                        param.IsScan = $("#IsScan").val();
                        param.PointState = $("#PointState").val();
                    }
                });
                $("#SearchDlgPoint").dialog("close");
            }
            function Load() {
                InitTableHeight();
                LoadList();
            ...
            $(document).ready(function () {
                ...
                if (screen.height == "768" && screen.width == "1024") {
                    ...
                    $('.easyui-dialog').parent().css({ width: "400px", height: "250px", padding: "5px", position: "absolute", top: "120px", left: "100px" });
                    $(".easyui-dialog").css({ width: "400px", height: "250px", padding: "50px", });
                }
