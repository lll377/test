<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlanTemplateListDialog.aspx.cs" Inherits="M_Main.ComprehensivePatrols.PlanTemplateListDialog" %>
        ...
        <script type="text/javascript">
            ...
            function LoadList() {
                ...
                $("#TableContainer").datagrid({
                    url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CpComPatrols&Command=GetPlanTemplateList_GenerationTask&' + $('#frmFrom').serialize(),
                    method: "get",
                    loadMsg: '数据加载中,请稍候...',
                    nowrap: false,
                    rownumbers: true,
