<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PatrolsProblemStatistics_TaskType.aspx.cs" Inherits="M_Main.ComprehensivePatrols.PatrolsProblemStatistics_TaskType" %>
...
<body>
    <form id="frmForm" runat="server">
        ...
        <input type="hidden" id="TaskName" name="TaskName" value="巡查问题统计-按所属类别" />
        <script type="text/javascript">
            ...
            var column = [
                [
                    { field: 'TaskTypeName', rowspan: 2, title: '所属类别', width: 150, align: 'left', sortable: true },
            ...
            function LoadList(str) {
                var urls = null;
                if (str != "") {
                    urls = '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CpComPatrols&Command=PatrolsProblemStatistics_TaskType&' + $("#frmForm").serialize();
                ...
                $("#TableContainer").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        if (str != "") {
                            param = $.JQForm.GetParam("CpComPatrols", "PatrolsProblemStatistics_TaskType", "TableContainer", param);
                        }
                    }
                });
