<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AmbientTaskStatistics_TaskLevel.aspx.cs" Inherits="M_Main.ComprehensivePatrols.AmbientTaskStatistics_TaskLevel" %>
...
<body>
    <form id="frmForm" runat="server">
            ...
            <table class="SearchTable" style="width: 100%; font-size: 12px; font-family: 微软雅黑;">
                ...
                <tr>
                    ...
                    <td class="TdContentSearch">
                        <select id="TypeId" name="TypeId" isdctype='true' dctype="任务类型" dcname="环境保洁,绿化养护,四害消杀,垃圾清运" class="easyui-validatebox" style="width: 98%;" onchange="bindLevel();">
                        </select>
                    </td>
        ...
        <input type="hidden" id="TaskName" name="TaskName" value="环境任务统计表" />
        <script type="text/javascript">
            ...
            function bindLevel() {
                $.tool.DataPostNoLoading('CpComPatrols', 'GetPatrolLevelList', 'page=1&rows=10000&TaskTypeName=环境保洁,绿化养护,四害消杀,垃圾清运&TypeId=' + $("#TypeId").val(),
                    function Init() {
                    },
            ...
            var toolbar = [
                {
                    ...
                    handler: function () {
                        ...
                        //window.open("CpReportExcel.aspx?CommId=" + encodeURI(encodeURI($('#CommId').val())) + '&TypeId=' + $("#TypeId").val() + '&LevelId=' + $("#LevelId").combobox('getValues') + '&BeginTime=' + $('#BeginTime').val() + '&EndTime=' + $('#EndTime').val() + '&TaskName=' + $('#TaskName').val());
            ...
            function LoadList(str) {
                var urls = null;
                if (str != "") {
                    urls = '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CpComPatrols&Command=AmbientTaskStatistics_TaskLevel&' + $("#frmForm").serialize();
                ...
                $("#TableContainer").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        if (str != "") {
                            param = $.JQForm.GetParam("CpComPatrols", "AmbientTaskStatistics_TaskLevel", "TableContainer", param);
                        }
                    }
                });
