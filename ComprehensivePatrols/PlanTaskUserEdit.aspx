<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlanTaskUserEdit.aspx.cs" Inherits="M_Main.ComprehensivePatrols.PlanTaskUserEdit" %>
...
<body>
    <form id="frmFrom" runat="server">
        <table class="SearchTable" style="width: 100%; padding-top: 5px; line-height: 25px;">
            <tr>
                <td class="TdTitle"><span>责任岗位:</span></td>
                ...
                <td class="TdTitle"><span>责任人:</span></td>
                <td class="TdContentSearch">
        ...
        <script type="text/javascript">
            ...
            function Save() {
                debugger;
                $.tool.DataPostChk('frmFrom', 'CpComPatrols', 'SavePlanTaskUserEdit', $('#frmFrom').serialize(),
                    function Init() {
                    },
            ...
            function SelTaskRole() {
                HDialog.Open('650', '600', '../ComprehensivePatrols/SelRole.aspx?CommId=' + GetQueryString('CommId'), '选择岗位', false, function callback(_Data) {
                    if (_Data) {
