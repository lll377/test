<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskNotComplete_Ambient.aspx.cs" Inherits="M_Main.ComprehensivePatrols.TaskNotComplete_Ambient" %>
        ...
        <script type="text/javascript">
            ...
            function LoadList() {
                ...
                $("#DivContainer").datagrid({
                    url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CpComPatrols&Command=GetCpPlanTaskList_Ambient&Flag=未完成&' + $("#frmFrom").serialize(),
                    method: "get",
                    loadMsg: '',
                    nowrap: false,
                    pageSize: 20,
