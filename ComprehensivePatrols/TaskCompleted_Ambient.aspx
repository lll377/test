<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskCompleted_Ambient.aspx.cs" Inherits="M_Main.ComprehensivePatrols.TaskCompleted_Ambient" %>
    ...
    <form id="frmFrom" runat="server">
        ...
        <script type="text/javascript">
            ...
            function TaskPointIncident(TaskPointId, TaskId) {
                HDialog.Open(800, 600, '../ComprehensivePatrols/TaskPointIncident_Ambient.aspx?TaskPointId=' + TaskPointId + "&TaskId=" + TaskId + "&CommId=" + $("#CommId").val(), '查看报事', true, function callback(_Data) {
                });
            }
            ...
            function LoadList() {
                ...
                $("#DivContainer").datagrid({
                    url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CpComPatrols&Command=GetCpPlanTaskList_Ambient&Flag=已完成&' + $("#frmFrom").serialize(),
                    method: "get",
                    loadMsg: '数据加载中,请稍候...',
                    nowrap: false,
                    pageSize: 20,
