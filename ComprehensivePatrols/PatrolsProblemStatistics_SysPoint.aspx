<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PatrolsProblemStatistics_SysPoint.aspx.cs" Inherits="M_Main.ComprehensivePatrols.PatrolsProblemStatistics_SysPoint" %>
...
<body>
    <form id="frmForm" runat="server">
        ...
        <input type="hidden" id="TaskName" name="TaskName" value="巡查问题统计-按通用点位" />
        <script type="text/javascript">
            ...
            var column = [
                [
                    { field: 'SysPointName', rowspan: 2, title: '通用点位', width: 150, align: 'left', sortable: true },
            ...
            function LoadList(str) {
                var urls = null;
                if (str != "") {
                    urls = '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CpComPatrols&Command=PatrolsProblemStatistics_SysPoint&' + $("#frmForm").serialize();
                ...
                $("#TableContainer").datagrid({
                    ...
                    onLoadSuccess: function () {
                        $("#TableContainer").datagrid("autoMergeCells", ['OrganName', 'CommName']);
                    },
                    onBeforeLoad: function (param) {
                        if (str != "") {
                            param = $.JQForm.GetParam("CpComPatrols", "PatrolsProblemStatistics_SysPoint", "TableContainer", param);
                        }
                    }
                });
