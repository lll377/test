<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SafeTaskStatistics_TaskLevel.aspx.cs" Inherits="M_Main.ComprehensivePatrols.SafeTaskStatistics_TaskLevel" %>
...
<body>
    <form id="frmForm" runat="server">
            ...
            <table class="SearchTable" style="width: 100%; font-size: 12px; font-family: 微软雅黑;">
                ...
                <tr>
                    ...
                    <td class="TdContentSearch">
                        <select id="TypeId" name="TypeId" isdctype='true' dctype="任务类型" dcname="安全巡更,消防巡检" class="easyui-validatebox" style="width: 98%;" onchange="bindLevel();">
                        </select>
                    </td>
        ...
        <input type="hidden" id="TaskName" name="TaskName" value="安全任务统计表" />
        <script type="text/javascript">
            ...
            $(function () {
                bindLevel();
                var option = "<option value='FireControl'>消防巡检</option>";
                $("#TypeId").append(option);
            });

            function bindLevel() {
                $.tool.DataPostNoLoading('CpComPatrols', 'GetPatrolLevelList', 'page=1&rows=10000&TaskTypeName=安全巡更,消防巡检&TypeId=' + $("#TypeId").val(),
                    function Init() {
                    },
            ...
            function LoadList(str) {
                var urls = null;
                if (str != "") {
                    urls = '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CpComPatrols&Command=SafeTaskStatistics_TaskLevel&' + $("#frmForm").serialize();
                ...
                $("#TableContainer").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        if (str != "") {
                            param = $.JQForm.GetParam("CpComPatrols", "SafeTaskStatistics_TaskLevel", "TableContainer", param);
                        }
                    }
                });
