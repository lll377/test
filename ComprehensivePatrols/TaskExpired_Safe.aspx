<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskExpired_Safe.aspx.cs" Inherits="M_Main.ComprehensivePatrols.TaskExpired_Safe" %>
    ...
    <form id="frmFrom" runat="server">
        ...
        <script type="text/javascript">
            ...
            function Export() {
                ...
                param.IsZip = "否";
                param.TableName = "安全管理任务执行跟进（已过期）";
                param.Class = "CpComPatrols";
                param.Method = "ExportCpPlanTaskList_Safe";
                window.open("/HM/M_Main/HC/Export.aspx?" + $.param(param) + "&Flag=已过期");
            }
            ...
            function TaskPointIncident(TaskPointId, TaskId) {
                HDialog.Open(800, 600, '../ComprehensivePatrols/TaskPointIncident_Safe.aspx?TaskId=' + TaskId + "&TaskPointId=" + TaskPointId + "&CommId=" + $("#CommId").val(), '查看报事', true, function callback(_Data) {
                });
            }
            ...
            function LoadList() {
                ...
                $("#DivContainer").datagrid({
                    url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CpComPatrols&Command=GetCpPlanTaskList_Safe&Flag=已过期&' + $("#frmFrom").serialize(),
                    method: "get",
                    loadMsg: '数据加载中,请稍候...',
                    nowrap: false,
                    pageSize: 20,
