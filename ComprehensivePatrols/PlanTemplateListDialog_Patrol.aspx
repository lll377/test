<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlanTemplateListDialog_Patrol.aspx.cs" Inherits="M_Main.ComprehensivePatrols.PlanTemplateListDialog_Patrol" %>
            ...
            <table class="SearchTable" style="width: 100%; font-size: 12px; font-family: 微软雅黑;">
                <tr>
                    ...
                    <td class="TdContentSearch" colspan="5">
                        <input type="text" class="easyui-validatebox" id="CommName" name="CommName" onclick="SelComm();" style="border: 1px #cccccc solid; width: 580px; height: 50px;" />
                ...
                <tr>
                    ...
                    <td class="TdContentSearch">
                        <input type="text" id="TaskRoleName" name="TaskRoleName" class="easyui-validatebox" onclick="SelRole();" runat="server" style="border: 1px #cccccc solid;" />
        ...
        <script type="text/javascript">
            ...
            function LoadList() {
                ...
                $("#TableContainer").datagrid({
                    url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CpComPatrols&Command=GetPlanTemplateList_GenerationTask_Patrol&' + $('#frmFrom').serialize(),
                    method: "get",
                    loadMsg: '数据加载中,请稍候...',
                    nowrap: false,
                    rownumbers: true,
