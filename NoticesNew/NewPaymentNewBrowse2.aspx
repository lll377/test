<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewPaymentNewBrowse2.aspx.cs" Inherits="M_Main.NoticesNew.NewPaymentNewBrowse2" %>
...
<body onload="Win_OnLoad()">
    <form id="frmForm" runat="server">
        ...
        <input style="display: none;" id="btnPrint" class="button" value="报表打印" type="button"
            name="btnPrint" runat="server" onserverclick="btnPrint_ServerClick1">
        ...
        <div id="SearchDlg" class="easyui-dialog" title="筛选条件" data-options="iconCls:'icon-search',closed: true,modal:false"
            ...
            <table class="DialogTable" id="DivCust" name="DivCust">
                <tr>
                ...
                <tr>
                    ...
                    <td class="TdContentSearch" colspan="3">
                        <input id="CkLiveType0" value="on" checked type="radio" name="CkLiveType" onclick="RadioCheck(0);" runat="server">当前住户
                        <input id="CkLiveType1" value="CkLiveType1" onclick="    RadioCheck(1);" type="radio" name="CkLiveType" runat="server">房屋业主
                        <input id="CkLiveType2" value="CkLiveType2" onclick="    RadioCheck(2);" type="radio" name="CkLiveType" runat="server">房屋租户
                        <input id="CkLiveType3" value="Radio1" onclick="    RadioCheck(3);" type="radio" name="CkLiveType" runat="server" designtimedragdrop="110">临时客户
                        <input id="CkLiveType4" value="Radio1" onclick="    RadioCheck(4);" type="radio" name="CkLiveType" runat="server" designtimedragdrop="110">历史客户
                ...
                <tr>
                    ...
                    <td class="TdContentSearch">
                        <select id="RoomState" style="width: 43%;" name="RoomState" runat="server">
                            <option selected></option>
                        </select></td>
                    <td class="TdTitle">是否银行代扣</td>
                    <td class="TdContentSearch"><select id="IsBank" name="IsBank" runat="server"></select></td>
                    <td ></td>
                    <td ></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="TdContentSearch">
                        <select id="ChargeTypeID" style="width: 43%;" name="ChargeTypeID" runat="server">
                            <option selected></option>
                        </select></td>
                ...
                <tr>
                    ...
                    <td class="TdContentSearch">
                        <select id="UseRepID" name="UseRepID" runat="server"></select></td>
                ...
                <tr>
                    ...
                    <td style="height: 129px" class="TdContentSearch" colspan="8">
                        ...
                        <input id="CfgID" size="1" type="hidden" name="CfgID" runat="server"></td>
                </tr>
                <tr>
...
<script type="text/javascript">
    ...
    $('#btnSearch').click(function () {
        ...
        $.tool.DataPost('PaymentNotice', "PaymentCustAll", $('#frmForm').serialize(),
                function Init() {
    ...
    function btnSaveConfig() {
        $.ajax({
            type: "post",
            url: "NewPaymentNewBrowse2.aspx/btnSaveConfig",
