<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeesPaymentDetail.aspx.cs" Inherits="M_Main.NoticesNew.FeesPaymentDetail" %>
        ...
        <div id="tt1">
            <table class="DialogTable" id="HeadTable" name="HeadTable" style="width: 100%;">
                ...
                <tr>
                    ...
                    <td class="TdContent" colspan="3">
                        <asp:Label ID="lbPayMemo" runat="server"></asp:Label></td>
                </tr>
                ...
                <tr>
                    <td align="center" colspan="4">
                        ...
                        <input class="button" id="btnPrint" type="button" value="报表打印"
                            name="btnPrint" runat="server" onserverclick="btnPrint_ServerClick">&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <input class="button" id="btnOk" type="button" value="关闭"
