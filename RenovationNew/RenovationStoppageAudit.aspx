<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RenovationStoppageAudit.aspx.cs" Inherits="M_Main.RenovationNew.RenovationStoppageAudit" %>
    ...
    <form id="frmForm" runat="server">
        ...
        <div id="SearchDlg" class="easyui-dialog" title="筛选条件" style="overflow: hidden;" data-options="iconCls:'icon-search',closed: true,modal:true">
            <table class="SearchTable">
                ...
                <tr>
                    <td class="TdTitle">停工时间</td>
                    <td class="TdContentSearch">
                        <input type="text" id="StoppageBeginTime" name="StoppageBeginTime" class="easyui-datebox" data-options="editable:false" />
                    </td>
                    <td class="TdTitle">至</td>
                    <td class="TdContentSearch">
                        <input type="text" id="StoppageEndTime" name="StoppageEndTime" class="easyui-datebox" data-options="editable:false" />
                    </td>
        ...
        <script type="text/javascript">
            ...
            var column = [[
                ...
                {
                    field: 'StoppageBeginTime', title: '停工开始时间', width: 120, align: 'left', sortable: false, formatter: function (value, row, index) {
                        if (row.StoppageBeginTime != "") {
                            var str = formatDate(row.StoppageBeginTime, "yyyy-MM-dd");
                            return str;
                        }
                        return row.StoppageBeginTime;
                    }
                },
                {
                    field: 'StoppageEndTime', title: '停工结束时间', width: 120, align: 'left', sortable: false, formatter: function (value, row, index) {
                        if (row.StoppageEndTime != "") {
                            var str = formatDate(row.StoppageEndTime, "yyyy-MM-dd");
                            return str;
                        }
                        return row.StoppageEndTime;
                    }
                },
            ...
            function Detail(ID, RID, OpType) {
                HDialog.OpenWin(700, 440, '../RenovationNew/RenovationStoppageAuditManage.aspx?ID=' + ID + '&RID=' + RID + '&OpType=' + OpType, "装修停工申请", false, function callback(_Data) {
                    if (_Data != "") {
                        LoadList();
                    }
                });
            ...
            function LoadList() {
                $("#TableContainer").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        param = $.JQForm.GetParam("Renovation", "GetRenoStoppageAuditList", "TableContainer", param);
                    }
                });
