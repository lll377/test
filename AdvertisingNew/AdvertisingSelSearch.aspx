<%@ Page Language="c#" CodeBehind="AdvertisingSelSearch.aspx.cs" AutoEventWireup="false" Inherits="M_Main.AdvertisingNew.AdvertisingSelSearch" %>
...
<script type="text/javascript">
    ...
    var Column = [[
           { field: 'RegionalName', title: '广告位区域', width: 100, align: 'left', sortable: true },
           {
               ...
               formatter: function (value, row, index) {
                   ...
                   var str = "<a class=\"HrefStyle\"  href='#' onclick=\"ViewDetail('广告管理','Select'," + row.AdvertisingID + ");\">" + row.AdvertisingSign + "</a>";
                   return str;
               }
           },
           {
    ...
    function LoadList() {
        $("#TableContainer").datagrid({
            ...
            //    ViewDetail('广告管理', 'Select', rowData.AdvertisingID);
            //}
        });
    ...
    function SearchHistory() {
        HDialog.Open(w, h, '../AdvertisingNew/AdvertisingHandHisSearch.aspx?', '广告位退租历史', false, function callback(_Data) {
    ...
    function ViewDetail(title, OpType, AdvertisingID) {
        ...
        HDialog.Open(w, h, '../AdvertisingNew/AdvertisingHandBrowse.aspx?AdvertisingID=' + AdvertisingID + '&OpType=' + OpType, title, false, function callback(_Data) {
            if (_Data == "true") {
                LoadList();
            }
        });
