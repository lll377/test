<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UFJDConfigSet_JinWei_AccSubjBrowse.aspx.cs" Inherits="M_Main.UFJDVoucher.UFJDConfigSet_JinWei_AccSubjBrowse" %>
    ...
    <form id="frmForm" runat="server">
        ...
        <script type="text/javascript">
            var column = [[
                ...
                { field: 'UFCustName', title: '客商', width: 100, align: 'left', sortable: true },
                { field: 'CurrentItemName', title: '往来项目', width: 100, align: 'left', sortable: true },
                { field: 'FundPropertyName', title: '款项性质', width: 100, align: 'left', sortable: true },
                { field: 'PropertyIncomeName', title: '物业收入', width: 100, align: 'left', sortable: true },
                ...
                ,'-',
                    {
                        ...
                        handler: function () {
                             HDialog.Open(770, 400, '../UFJDVoucher/UFJDConfigSet_JinWei_AccSubjExcelInput.aspx', '批量导入信息', false, function callback(_Data) {
                                if (_Data == "true") {
                                    LoadList();
                                }
                            });
            ...
            function ViewDetail(title, OpType, ID) {
                ...
                HDialog.Open('800', '500', '../UFJDVoucher/UFJDConfigSet_JinWei_AccSubjManage.aspx?ConfigID=' + ID + '&OpType=' + OpType, title, true, function callback(_Data) {
                    //if (_Data == "true") {
                        LoadList();
                    //}
