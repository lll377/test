<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UFJDFitemssManage.aspx.cs" Inherits="M_Main.UFJDVoucher.UFJDFitemssManage" %>
...
<body>
    <form id="frmForm" runat="server">
        ...
        <table class="DialogTable" border="0" style="line-height:23px;height:23px;">
             ...
             <tr>
                <td class="TdTitle">项目编码</td>
                <td class="TdContent"><INPUT class="easyui-validatebox"  id="FitemssCode" name="FitemssCode" runat="server">
                </td>
                <td class="TdTitle">项目名称</td>
                <td class="TdContent"><INPUT class="easyui-validatebox"  id="FitemssName" name="FitemssName" runat="server">
                </td>
             </tr>           
            <tr>
        ...
        <script type="text/javascript">
            $("#BtnSave").click(function () {
                ...
                $.tool.DataPostChk('frmForm', 'UFJDFitemss', "add", $('#frmForm').serialize(),
                function Init() {
                },
            ...
            function SelectFitem_OnChange()
            {
                var strFitemCode = $("#SelectFitem").val();
                $("#FitemCode").val(strFitemCode);
			}
