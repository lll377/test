<%@ Page Language="c#" CodeBehind="UFJDConfigSet_JinWei_AccSubjExcelInput.aspx.cs" AutoEventWireup="false" Inherits="M_Main.UFJDVoucher.UFJDConfigSet_JinWei_AccSubjExcelInput" %>
        ...
        <table class="DialogTable" id="Table1" style="width: 100%">
            ...
            <tr>
                <td colspan="4" style="height: 30px; color: crimson; text-align: center; font-weight: 600; font-size: 14px">*提示：导入文件类型必须为Excel格式。
                    列是类别，费用名称，科目编码,税率,科目(税)编码,现金流量编码,客商,往来项目,款项性质,物业收入,资金计划项目
                    &nbsp;&nbsp;&nbsp;&nbsp;<%--<a href="javascript:void(0);" onclick="CreExcel()">下载模板文件</a>--%>
                </td>
            </tr>
        </table>
...
<script type="text/javascript">
    //function CreExcel() {
    //    HDialog.Open(500, 300, '../UFJDVoucher/XXX.aspx', '生成Excel预交文件', false, function callback(_Data) {
    //    });
    //}
</script>
