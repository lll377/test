<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UFJDPushFeesSearch.aspx.cs" Inherits="M_Main.UFJDVoucher.UFJDPushFeesSearch" %>
    ...
    <form id="frmForm" runat="server">
        ...
        <script type="text/javascript">
                        ...
                        handler: function () {
                            ...
                            if (rows == "") {
                                ...
                                HDialog.Prompt('是否删除该项', function () {
                                    $.tool.DataPostChk('frmForm', 'UFJDPushFees', 'BatchDelete', $('#frmForm').serialize(),
                                    function Init() {
                                    },
            ...
            function DelRecord(Id) {
                HDialog.Prompt('是否删除该项', function () {
                    $.tool.DataGet('UFJDPushFees', 'delete', 'VID=' + Id,
                        function Init() {
                        },
                        function callback(_Data) {
            ...
            function LoadList() {
                ...
                $("#TableContainer").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        param = $.JQForm.GetParam("UFJDPushFees", "LoadPushHead", "TableContainer", param);
                    },
