<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UFJDCustManage.aspx.cs" Inherits="M_Main.UFJDVoucher.UFJDCustManage" %>
...
<body>
    <form id="frmForm" runat="server">
        ...
        <table class="DialogTable" border="0" style="line-height:23px;height:23px;">
            <tr>
                <td class="TdTitle">客商ID</td>
                <td class="TdContent"><INPUT class="easyui-validatebox"  id="CustID" name="CustID" runat="server">
                </td>
                <td class="TdTitle">客商编码</td>
                <td class="TdContent"><INPUT class="easyui-validatebox"  id="CustCode" name="CustCode" runat="server">
                </td>
             </tr> 
            <tr>
                <td class="TdTitle">客商名称</td>
                <td class="TdContent"><INPUT class="easyui-validatebox"  id="CustName" name="CustName" runat="server">
                </td>
                <td class="TdTitle"></td>
                <td class="TdContent">
                </td>
        ...
        <script type="text/javascript">
            $("#BtnSave").click(function () {
                ...
                $.tool.DataPostChk('frmForm', 'UFJDCust', "add", $('#frmForm').serialize(),
                function Init() {
                },
