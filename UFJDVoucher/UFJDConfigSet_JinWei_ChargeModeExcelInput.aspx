<%@ Page Language="c#" CodeBehind="UFJDConfigSet_JinWei_ChargeModeExcelInput.aspx.cs" AutoEventWireup="false" Inherits="M_Main.UFJDVoucher.UFJDConfigSet_JinWei_ChargeModeExcelInput" %>
        ...
        <table class="DialogTable" id="Table1" style="width: 100%">
            ...
            <tr>
                <td colspan="4" style="height: 30px; color: crimson; text-align: center; font-weight: 600; font-size: 14px">*提示：导入文件类型必须为Excel格式。
                    列是收款方式，结算方式编码，科目编码,手续费,科目(手续费)编码,银行账户编码,现金流量编码
...
<script type="text/javascript">
    function CreExcel() {
        window.location.href = "../UFJDVoucher/templet/ConfigSetChargeMode.xlsx";
    }
</script>
