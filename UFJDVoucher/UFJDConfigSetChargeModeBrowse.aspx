<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UFJDConfigSetChargeModeBrowse.aspx.cs" Inherits="M_Main.UFJDVoucher.UFJDConfigSetChargeModeBrowse" %>
    ...
    <form id="frmForm" runat="server">
        ...
        <script type="text/javascript">
            var column = [[
                ...
                { field: 'UFCorpName', title: '内部公司', width: 100, align: 'left', sortable: true }
                ...
                ,'-',
                    {
                        ...
                        handler: function () {
                             HDialog.Open(770, 400, '../UFJDVoucher/UFJDConfigSetChargeModeExcelInput.aspx', '批量导入信息', false, function callback(_Data) {
                                if (_Data == "true") {
                                    LoadList();
                                }
                            });
            ...
            function ViewDetail(title, OpType, ID) {
                ...
                HDialog.Open('800', '400', '../UFJDVoucher/UFJDConfigSetChargeModeManage.aspx?ConfigID=' + ID + '&OpType=' + OpType, title, true, function callback(_Data) {
                    //if (_Data == "true") {
                        LoadList();
                    //}
