<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UFJDPushFeesChargeBrowse.aspx.cs" Inherits="M_Main.UFJDVoucher.UFJDPushFeesChargeBrowse" %>
    ...
    <form id="frmForm" runat="server">
        ...
        <script type="text/javascript">
            ...
            $('#btnCre').click(function () {
                ...
                $.tool.DataPost('UFJDPushFees', 'ChargeCre', $('#frmForm').serialize(),
                  function Init() {
