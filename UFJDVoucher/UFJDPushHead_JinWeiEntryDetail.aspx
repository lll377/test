<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UFJDPushHead_JinWeiEntryDetail.aspx.cs" Inherits="M_Main.UFJDVoucher.UFJDPushHead_JinWeiEntryDetail" %>
    ...
    <form id="frmForm" runat="server">
        ...
        <table class="DialogTable" id="HeadTable" name="HeadTable" style="width: 100%;">            
           ...
           <tr>
                ...
                <td class="TdContent">
                    <span id="lbVBillNo" name="lbVBillNo" runat="server"></span>
                </td>
                <td class="TdTitle"></td>
                <td class="TdContent">
                </td>
        ...
        <script type="text/javascript">
            ...
            var EntryColumn = [[
                ...
                { field: 'Abstract', title: '摘要', width: 300, align: 'left', sortable: true },
                { field: 'Account_Code', title: '会计科目', width: 100, align: 'left', sortable: true },
                { field: 'DispName', title: '科目名称', width: 200, align: 'left', sortable: true },
                { field: 'CustName', title: '客商', width: 300, align: 'left', sortable: true },
                { field: 'RollProjetName', title: '资金计划项目', width: 100, align: 'left', sortable: true },
                { field: 'BankAccountName', title: '收款银行', width: 100, align: 'left', sortable: true },
                { field: 'CreditAmount', title: '贷方', width: 100, align: 'left', sortable: true }
                //,{ field: 'DebitAmount', title: '借方', width: 100, align: 'left', sortable: true }
                ]]
            ...
            var toolbar1 = [ {
                    ...
                    handler: function () {
                        ...
                        if (data.rows.length>0) {
                            window.location.href = "../UFJDVoucher/UFJDPushHead_JinWeiEntryCre.aspx?VID=" + $('#VID').val();
                        }
            ...
            function LoadEntry() {
                ...
                $("#TableContainer1").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        ...
                        param = $.JQForm.GetParam("UFJDPushFees_JinWei", "LoadRecPushEntry", "TableContainer1", param);
                    }
                });
            }
            LoadEntry();
