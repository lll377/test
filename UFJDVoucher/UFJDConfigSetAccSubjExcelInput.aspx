<%@ Page Language="c#" CodeBehind="UFJDConfigSetAccSubjExcelInput.aspx.cs" AutoEventWireup="false" Inherits="M_Main.UFJDVoucher.UFJDConfigSetAccSubjExcelInput" %>
        ...
        <table class="DialogTable" id="Table1" style="width: 100%">
            ...
            <tr>
                <td colspan="4" style="height: 30px; color: crimson; text-align: center; font-weight: 600; font-size: 14px">*提示：导入文件类型必须为Excel格式。
                    列是类别，费用名称，科目编码,税率,科目(税)编码,现金流量编码(主表),现金流量编码(附表),项目档案,客户,部门,公司
