<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SaleRoomRemoveTransFee.aspx.cs" Inherits="M_Main.HouseNew.SaleRoomRemoveTransFee" %>
...
<body style="overflow-y: auto">
    <form id="SaleRoomTransFee" method="post" runat="server">
        <input id="PageIndex" style="width: 16px; height: 22px" type="hidden" size="1" name="PageIndex" runat="server">
        <input id="LiveID" style="width: 16px; height: 22px" type="hidden" size="1" name="LiveID" runat="server">
        <input id="CustID" style="width: 16px; height: 22px" type="hidden" size="1" name="CustID" runat="server">
        <input id="RoomID" style="width: 16px; height: 22px" type="hidden" size="1" name="RoomID" runat="server">
        <input id="OldCustID" style="width: 16px; height: 22px" type="hidden" size="1" name="OldCustID" runat="server">
        <input id="FeesIDs" style="width: 16px; height: 22px" type="hidden" size="1" name="FeesIDs" runat="server">
        <input id="PrecIDs" style="width: 16px; height: 22px" type="hidden" size="1" name="PrecIDs" runat="server">
        <input id="LimitCount" style="width: 16px; height: 22px" type="hidden" size="1" name="LimitCount" runat="server">
        ...
        <table class="DialogTable" width="100%">
            <tr>
                <td class="TdTitle" align="right" width="15%">
                    <font face="宋体">现业主名称</font>
                </td>
                <td class="TdContent" width="35%">
                    <asp:Label ID="CustName" runat="server"></asp:Label>
                </td>
                <td class="TdTitle" align="right" width="15%">
                    <font face="宋体">原业主名称</font>
                </td>
                <td class="TdContent" width="35%">
                    <asp:Label ID="MasterName" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="TdTitle" align="right" width="15%">
                    <font face="宋体">房屋编号</font>
                </td>
                <td class="TdContent" width="35%">
                    <asp:Label ID="RoomSign" runat="server"></asp:Label>
                </td>
                <td class="TdTitle" align="right" width="15%">
                    <font face="宋体">变更时间</font>
                </td>
                <td class="TdContent" width="35%">
                    <asp:Label ID="ChargeTime" runat="server"></asp:Label>
                </td>
            </tr>
        </table>
        ...
        <table class="DialogTable" width="100%">
            <tr>
                <td class="formTable_Footer" align="center" colspan="4">
                    <input class="button" id="btnSave" onclick="javascript: if (CheckData() == false) return false;" type="button" value="确定转移" name="btnSave" runat="server">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
        ...
        <div id="toolbar">
            <table style="width: 100%;">
                <tr>
                    <td style="padding-left: 5px;"><span class="fa fa-laptop"></span>原业主已转移应收费用</td>
