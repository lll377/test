<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HouseKeeperDetail.aspx.cs" Inherits="M_Main.HouseNew.HouseKeeperDetail" %>
...
<body style="margin: 0px; padding: 0px; overflow: hidden;">
    <form id="FrmForm" runat="server">
        <div id="SearchDlg" class="easyui-dialog" title="筛选条件" data-options="iconCls:'icon-search',closed: true,modal:true"
            ...
            <table style="width: 100%; padding-top: 5px">
                ...
                <tr>
                    ...
                    <td class="TdContent">
                        <input type="text" class="easyui-validatebox" id="BuildRoomName" name="BuildRoomName" style="width: 95%; border: 1px solid #cccccc;" />
                    </td>
                    <td class="TdTitle">客户名称</td>
                    <td class="TdContent">
                        <input type="text" class="easyui-validatebox" id="EvaluationCustName" name="EvaluationCustName" style="width: 95%; border: 1px solid #cccccc;" />
                    </td>
                </tr>
                <tr>
        ...
        <script type="text/javascript">
            ...
            //导出
            function ExcelPrint() {
                var url = '../HouseNew/HouseKeeperExcel.aspx?ExcelName=管家评价明细' + '&random=' + Math.random() + GetParamet();
                window.open(url);
            }
