<%@ Page Language="c#" CodeBehind="InputCustManage.aspx.cs" AutoEventWireup="false" Inherits="M_Main.HouseNew.InputCustManage" %>
...
<script type="text/javascript">
    ...
    $('#btnCreExcel').click(function () {
        HDialog.Open(500, 150, '../HouseNew/ExcelCustManage.aspx', '生成Excel业主文件', false, function callback(_Data) {
