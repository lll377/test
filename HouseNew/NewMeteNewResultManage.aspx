<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewMeteNewResultManage.aspx.cs" Inherits="M_Main.HouseNew.NewMeteNewResultManage" %>
                        ...
                        <td valign="top">
                            ...
                            <%--    楼宇：--%>
                              <%--<asp:DropDownList ID="SelBuildSNum" runat="server" AutoPostBack="True" OnSelectedIndexChanged="SelBuildSNum_SelectedIndexChanged"></asp:DropDownList>--%>
                                <input id="BuildName"  style="width: 144px;display:none" searcher="SelBuild" data-options="editable:false"
                                    name="BuildName"  runat="server" />
                                <input id="hiBuildSNum" style="width: 8px; height: 22px" type="hidden"
                                    size="1" name="hiBuildSNum" runat="server" />
<%--                                <br />
                                <br />--%>
                                房屋：
                                <input id="CRoomSign" searcher="SelRoom"
                                    name="CRoomSign" class="easyui-searchbox" data-options="editable:false" runat="server" /><input id="hiRoomID" style="width: 8px; height: 22px" type="hidden"
                                        size="1" name="hiRoomID" runat="server" />
                                <input id="loadRoomTree" style="display: none" name="CreFees" runat="server" type="button" onserverclick="SelBuildSNum_SelectedIndexChanged" />
                            </div>
        ...
        <script type="text/javascript">
            ...
            function SelRoom() {
                ...
                HDialog.Open(w, h, conent, '房屋选择', false, function callback(_Data) {
                    ...
                    $('#CRoomSign').searchbox("setValue", data.RoomSign);
                    $('#hiRoomID').val(data.RoomID);
                    $('#loadRoomTree').click();
                });
            }
            ...
            function SelBuild() {
                ...
                HDialog.Open('700', '400', "../dialogNew/SingleBuildingDlg.aspx", '楼宇选择', false, function callback(_Data) {
                    console.log(_Data);
                    ...
                    if (_Data != "") {//**获得返回 刷新
                        ...
                        var BuildSNums = "";
                        var BuildNames = "";
                        $('#hiBuildSNum').val(BuildSNums);
                        $('#BuildName').searchbox('setValue', BuildNames);

                        $('#hiBuildSNum').val(varObjects[0]);
                        $('#BuildName').searchbox('setValue', varObjects[1]);
