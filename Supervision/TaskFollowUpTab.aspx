<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskFollowUpTab.aspx.cs" Inherits="M_Main.Supervision.TaskFollowUpTab" %>
    ...
    <form id="frmForm" runat="server">
        <div style="width: 100%">
            ...
            <div style="float: left; width: 80%">
                <div id="tab" class="easyui-tabs">
                    <div id="tab0" issel="true" title="未完成任务" style="overflow: hidden">
                    </div>
                    <div id="tab1" issel="false" title="已过期任务" style="overflow: hidden">
                    </div>
                    <div id="tab2" issel="false" title="已完成任务" style="overflow: hidden">
                    </div>
                    <div id="tab3" issel="false" title="待审核任务" style="overflow: hidden">
                    </div>
                </div>
            </div>
        </div>
        ...
        <script type="text/javascript">
            ...
            function LoadTree() {
                $("#TreeGrid").treegrid({
                    ...
                    onClickRow: function (rowData) {
                        ...
                        if ($("#tab2").attr("issel") == "true") {
                            $('#tab').tabs('select', 3);
                            $('#tab').tabs('select', 2);
                        }
                        if ($("#tab3").attr("issel") == "true") {
                            $('#tab').tabs('select', 0);
                            $('#tab').tabs('select', 3);
                        }
                    }
            ...
            function InitControl() {
                ...
                var pageName = "TaskFollowUpNoComplete";
                ...
                $('#tab').tabs({
                    ...
                    onSelect: function (title, index) {
                        ...
                        if (issel == "false") {
                            if (index == 0) { pageName = "TaskFollowUpNoComplete"; }
                            else if (index == 1) { pageName = "TaskFollowUpOverDue"; }
                            else if (index == 2) { pageName = "TaskFollowUpCompleted"; }
                            else if (index == 3) { pageName = "TaskFollowUpToExamine"; }
                            CommId = $("#CommId").val();
