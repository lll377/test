<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlanStandardSel.aspx.cs" Inherits="M_Main.Supervision.PlanStandardSel" %>
        ...
        <script type="text/javascript">
            ...
            function LoadList() {
                ...
                if ($("#ScoreType").combobox("getValue") > '')
                    url = '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CSSupervision&Command=Plan_CheckStandardSel&CheckStandard_ScoreType=' + $("#ScoreType").combobox("getValue") + '&Id=' + $("#Id").val();
                ...
                if ($("#ScoreType").combobox("getValue") > '') {
                    $.tool.DataPostChk('frmForm', 'CSSupervision', 'Plan_CheckStandardSel_SumScore', 'CheckStandard_ScoreType=' + $("#ScoreType").combobox("getValue") + '&Id=' + $("#Id").val(),
                        function Init() {
                        },
            ...
            function ExportList(SumScore) {
                $.tool.DataPostChk('frmForm', 'CSSupervision', 'Plan_CheckStandardSel', 'CheckStandard_ScoreType=' + $("#ScoreType").combobox("getValue") + '&Id=' + $("#Id").val() + '&page=1&rows=999999999',
                    function Init() {
                    },
                    function callback(_Data) {
