<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskRectificationInfoExamineInfo.aspx.cs" Inherits="M_Main.Supervision.TaskRectificationInfoExamineInfo" %>
        ...
        <script type="text/javascript">
            ...
            function LoadListExamine() {
                $("#TableContainerExamine").datagrid({
                    url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CSSupervision&Command=TaskRectification_GetExamineInfo&' + $('#frmForm').serialize(),
                    method: "get",
                    loadMsg: '数据加载中,请稍候...',
                    nowrap: false,
