<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskFollowUpNoComplete.aspx.cs" Inherits="M_Main.Supervision.TaskFollowUpNoComplete" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>任务跟进-未完成任务</title>
...
<body style="margin: 0px; padding: 0px; overflow: hidden">
    <form id="frmForm" runat="server">
        ...
        <input type="hidden" id="TaskState" name="TaskState" value="0" />
        <input type="hidden" id="IsOverDue" name="IsOverDue" value="0" />
            ...
            function Export() {
                ...
                $.tool.DataPostChk('frmForm', 'CSSupervision', 'TaskList', $('#frmForm').serialize() + '&page=1&rows=999999999',
                    ...
                    function callback(_Data) {
                        ...
                        i.appendTo(f);
                        var date = new Date();
                        l.val('检查任务跟进-未完成任务-' + dateFormat("YYYY-mm-dd", date));
                        l.appendTo(f);
