<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskFollowUpToExamine.aspx.cs" Inherits="M_Main.Supervision.TaskFollowUpToExamine" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>任务跟进-待审核任务</title>
...
<body style="margin: 0px; padding: 0px; overflow: hidden">
    <form id="frmForm" runat="server">
        ...
        <input type="hidden" id="ExamineState" name="ExamineState" value="1" />
        ...
        <script type="text/javascript">
            ...
            var column = [[
                ...
                { field: 'ExamineStateName', title: '审核状态', width: 200, align: 'left', sortable: true }
            ]];
            ...
            var toolbar = [
                ...
                , '-',
                {
                    ...
                    handler: function () {
                        ...
                        if (row == null) {
                            HDialog.Info("请选择需要审核的数据");
                            return;
                        }
                        localStorage.setItem("OpType", 'examine');
                        localStorage.setItem("TaskId", row.TaskId);
                        localStorage.setItem("CommId", $("#CommId").val());
                        localStorage.setItem("PlanId", row.PlanId);
                        HDialog.Open('800', '600', '../Supervision/TaskRectificationFrame.aspx', '审核整改报告', true, function callback(_Data) {
            ...
            function LoadList() {
                $("#TableContainer").datagrid({
                    url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CSSupervision&Command=TaskRectification_GetExamineList&' + $('#frmForm').serialize(),
                    method: "get",
                    loadMsg: '数据加载中,请稍候...',
                    nowrap: false,
            ...
            function Export() {
                ...
                $.tool.DataPostChk('frmForm', 'CSSupervision', 'TaskRectification_GetExamineList', $('#frmForm').serialize() + '&page=1&rows=999999999',
                    function Init() {
                    },
                    function callback(_Data) {
                        ...
                        i.appendTo(f);
                        var date = new Date();
                        l.val('任务跟进-待审核任务-' + dateFormat("YYYY-mm-dd", date));
                        l.appendTo(f);
