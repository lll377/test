<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskRectificationServiceHighlights.aspx.cs" Inherits="M_Main.Supervision.TaskRectificationServiceHighlights" %>
...
<body>
    <form id="frmForm" runat="server">
        <div class="panel-body" style="padding: 0px;">
            <div id="ServiceHighlights" style="width: 100%; overflow: hidden;"></div>
        </div>
        ...
        <script type="text/javascript">
            ...
            function Load() {
                var H = $(window).height();
                $('#ServiceHighlights').height(H - 180 + "px");
                var ue = UE.getEditor('ServiceHighlights',
                    {
                ...
                ue.ready(function () {
                    // editor准备好之后才可以使用
                    $.tool.DataGet('CSSupervision', 'GetTaskRectificationServiceHighlights', $('#frmForm').serialize(),
                        function Init() {
                        },
            ...
            function Save() {
                var ServiceHighlightsResult = UE.getEditor('ServiceHighlights').getContent();
                if (ServiceHighlightsResult.length > 0) {
                    ServiceHighlightsResult = escape(ServiceHighlightsResult);
                }
                $.tool.DataPostChk('frmForm', 'CSSupervision', 'SaveTaskRectificationServiceHighlights', $('#frmForm').serialize() + '&Content=' + ServiceHighlightsResult,
                    function Init() {
                    },
                    function callback(_Data) {
                        HDialog.Info("保存成功");
