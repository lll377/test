<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TasksMonthlySummaryDetailsTable_ReportForm.aspx.cs" Inherits="M_Main.TaskManagement.TasksMonthlySummaryDetailsTable_ReportForm" %>
...
<body>
    ...
    <script language="javascript" type="text/javascript">
        ...
        var columnSpace = [[
            ...
            {
                field: 'ThisMonthShouldCompleteNum', title: '本月应完成任务数', width: 100, align: 'left', formatter: function (value, row, index) {
                    //var valueShow = row.ThisMonthShouldCompleteNum1 == "" && row.ThisMonthShouldCompleteNum2 == "" ? "----" : "--";
                    //if (valueShow != "-") {
                    //    if (row.TaskType == "总计") {
                    //        valueShow = row.ThisMonthShouldCompleteNum1;
                    //    } else {
                    //        valueShow = GetCompleteNum(row, row.ThisMonthShouldCompleteNum1, row.ThisMonthShouldCompleteNum2);
                    //    }
                    //}
                    //return valueShow;
                return value == "" ? "----" : value;
                ...
                field: 'ThisMonthCompleteNum', title: '本月实完成任务数', width: 100, align: 'left', formatter: function (value, row, index) {
                    //var valueShow = row.ThisMonthCompleteNum1 == "" && row.ThisMonthCompleteNum2 == "" ? "----" : "--";
                    //if (valueShow != "-") {
                    //    if (row.TaskType == "总计") {
                    //        valueShow = row.ThisMonthCompleteNum1;
                    //    } else {
                    //        valueShow = GetCompleteNum(row, row.ThisMonthCompleteNum1, row.ThisMonthCompleteNum2);
                    //    }
                    //}
                    //return valueShow;
                 return value == "" ? "----" : value;
