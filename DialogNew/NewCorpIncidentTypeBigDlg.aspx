<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewCorpIncidentTypeBigDlg.aspx.cs" Inherits="M_Main.DialogNew.NewCorpIncidentTypeBigDlg" %>
...
<body style="overflow-y: auto;">
    <form id="FrmForm" runat="server">
        ...
        <input id="IsBigClass" name="IsBigClass" type="hidden" runat="server" />
        <div>
        ...
        <script type="text/javascript">
            ...
            function InitLeftTree() {
                var Commd = 'GetIncidentTypeListBigClass';
                if ($('#IsBigClass').val() == '0') {
                    Commd = "GetIncidentTypeListMinClass"
                }
                $.tool.DataGet('IncidentChoose', Commd, 'hClassID=' + $("#hClassID").val() + '&Duty=' + encodeURI($("#hiDuty").val()) + '&CostName=' + encodeURI($("#CostName").val()) + "&isAll=" + $("#isAll").val() + "&IsEdit=" + $("#IsEdit").val() + "&IncidentPlace=" + $("#IncidentPlace").val(),
            ...
            function GetTree(obj) {
                ...
                $('#treeDemo').tree({
                    ...
                    onBeforeSelect: function (node) {
                        //alert($("#treeDemo").tree('isLeaf', node.target));
