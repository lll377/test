<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelComm.aspx.cs" Inherits="M_Main.DialogNew.SelComm" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        var column = [[
            ...
            { field: 'CommName', title: '项目名称', width: 240, align: 'left', sortable: true }
        ]];
        ...
        function LoadList() {
            if ($('#isCheck').val() == '1') {
                $("#TableContainer").datagrid({
                    url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=Organ&Command=GetComm&' + $('#FrmForm').serialize(),
        ...
        function InitLeftTree() {
            $.tool.DataPost('Organ', 'GetOrganTreeByOrgan', "OrganCode=" + $('#hiOrganCode').val(),
                function Init() {
                },
