<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MultiUserCodeDlg.aspx.cs" Inherits="M_Main.DialogNew.MultiUserCodeDlg" %>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function LoadList(_Data, rows) {
                $("#TableContainer").datagrid({
                    url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=Choose&Command=SelPayeeData&' + $("#FrmForm").serialize(),
                    method: "get",
                    title: '',
                    nowrap: false,
