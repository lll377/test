<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelDepartSingle.aspx.cs" Inherits="M_Main.DialogNew.SelDepartSingle" %>
<!DOCTYPE html>
<html>
<head>
    <title></title>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            function InitLeftTree() {
                        $.tool.DataGet('Choose', 'SelDepartmentSingle', "",
                        function Init() {
                        },
            ...
            function GetTree(obj) {
                ...
                $('#treeDemo').tree({
                    ...
                    {
                        var ReturnValue = node.attributes.DepCode + ',' + node.text + ',' + node.id;
