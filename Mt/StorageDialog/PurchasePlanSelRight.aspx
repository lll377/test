<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchasePlanSelRight.aspx.cs" Inherits="M_Main.Mt.StorageDialog.PurchasePlanSelRight" %>
<!DOCTYPE html>
<html>
<head>
    <title>采购计划明细表</title>
...
<body>
    ...
    <script type="text/javascript">
        ...
        column = [[
                ...
                {
                    field: 'Price', title: '申购含税单价', align: 'left', width: 50, sortable: true, formatter: function (value, row, index) {
                        var str = ToDecimal(value, decimalPos);
                        return str;
                    }
                },
                ...
                {
                    field: 'Taxes', title: '申购税率', align: 'left', width: 50, sortable: true, formatter: function (value, row, index) {
                        var str = ToDecimal(value, 4);
                        return str;
                    }
                },

                {
                    field: 'NoTaxPrice', title: '申购不含税单价', align: 'left', width: 50, sortable: true, formatter: function (value, row, index) {
                        var str = ToDecimal(value, decimalPos);
                        return str;
                    }
                },
                ...
                {
                    field: 'Quantity', title: '数量', align: 'left', width: 50, sortable: true, formatter: function (value, row, index) {
                ...
                {
                    field: 'Amount', title: '申购含税金额', align: 'left', width: 50, sortable: true, formatter: function (value, row, index) {
                ...
                {
                    field: 'NoTaxAmount', title: '申购不含税金额', align: 'left', width: 50, sortable: true, formatter: function (value, row, index) {
                        var str = ToDecimal(value, moneyPos);
                        return str;
                    }
                },
                {
                    field: 'PlanPrice', title: '计划含税单价', align: 'left', width: 50, sortable: true, formatter: function (value, row, index) {
                        var str = ToDecimal(value, decimalPos);
                        return str;
                    }
                },
                {
                    field: 'PlanTaxes', title: '计划税率', align: 'left', width: 50, sortable: true, formatter: function (value, row, index) {
                        var str = ToDecimal(value, 2);
                        return str;
                    }
                },
                {
                    field: 'PlanNoTaxPrice', title: '计划不含税单价', align: 'left', width: 50, sortable: true, formatter: function (value, row, index) {
                        var str = ToDecimal(value, decimalPos);
                        return str;
                    }
                },
                {
                    field: 'PlanQuantity', title: '计划数量', align: 'left', width: 50, sortable: true, formatter: function (value, row, index) {
                        var str = ToDecimal(value, 2);
                        return str;
                    }
                },
                {
                    field: 'PlanAmount', title: '计划含税金额', align: 'left', width: 50, sortable: true, formatter: function (value, row, index) {
                        var str = ToDecimal(value, moneyPos);
                        return str;
                    }
                },
                {
                    field: 'PlanTaxMoney', title: '税款', align: 'left', width: 50, sortable: true, formatter: function (value, row, index) {
                        var str = ToDecimal(value, decimalPos);
                        return str;
                    }
                },
                {
                    field: 'PlanNoTaxAmount', title: '计划不含税金额', align: 'left', width: 50, sortable: true, formatter: function (value, row, index) {
                        var str = ToDecimal(value, moneyPos);
                        return str;
                    }
                }
        ...
        var toolbar = [
                 {
                     ...
                     handler: function () {
                         ...
                         for (var i = 0; i < rows.length; i++) {
                             parent.window.frames["PurchasePlanSelBottom"].window.AddRow(rows[i]);
                         }
                     }
                 }, '-',
            {
        ...
        function LoadList() {
            $("#TableContainer").datagrid({
                url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=Storage&Command=PurchasePlanDetailList&' + $('#frmForm').serialize(),
                method: "get",
                idField: "Id",
                nowrap: true,
                pageSize: 50,
                ...
                onDblClickRow: function (rowIndex, rowData) {
                    parent.window.frames["PurchasePlanSelBottom"].window.AddRow(rowData);
                }
            });
        }
        LoadList();
        ...
        function FastSearch() {
            ...
            $("#TableContainer").datagrid({
                url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=Storage&Command=PurchasePlanDetailList_New&' + $('#frmForm').serialize(),
                method: "get",
                idField: "Id",
                nowrap: true,
                pageSize: 50,
