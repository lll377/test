<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BackCheckOutSelRight.aspx.cs" Inherits="M_Main.Mt.StorageDialog.BackCheckOutSelRight" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        var column;
        column = [[
            { field: 'Id', title: 'ID', width: 150, align: 'center', sortable: true, hidden: true },
            { field: 'MaterialId', title: 'MaterialId', width: 150, align: 'center', sortable: true, hidden: true },
            { field: 'WareHouseName', title: '出库仓库', width: 150, align: 'center', sortable: true },
            { field: 'MaterialTypeName', title: '物资类型', width: 150, align: 'center', sortable: true },
            ...
            { field: 'Specification', title: '规格', width: 50, align: 'center', sortable: true },
            { field: 'ColorName', title: '颜色', width: 50, align: 'center', sortable: true },
            { field: 'Quantity', title: '数量', width: 50, align: 'center', sortable: true },
            //{ field: 'Price', title: '含税单价', width: 50, align: 'center', sortable: true },
            //{ field: 'Amount', title: '含税金额', width: 50, align: 'center', sortable: true },
            { field: 'UnitName', title: '单位', align: 'center', width: 50, sortable: true }
            //{ field: 'NoTaxPrice', title: '不含税单价', align: 'center', width: 50, sortable: true },
            //{ field: 'Taxes', title: '税率', align: 'center', width: 50, sortable: true },
            //{ field: 'NoAmount', title: '不含税金额', align: 'center', width: 50, sortable: true }               
        ]];
        var toolbar = [
                 {
                     text: '全选',
                     ...
                     handler: function () {
                         ...
                         for (var i = 0; i < rows.length; i++) {
                             parent.window.frames["BackCheckOutSelBottom"].window.AddRow(rows[i]);
                         }
                     }
                 }, '-',
            {
        ...
        function LoadList() {
            $("#TableContainer").datagrid({
                url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CheckOut&Command=CheckOutDetailListDialog&' + $('#frmForm').serialize(),
                method: "get",
                idField: "Id",
                nowrap: true,
                pageSize: 50,
                ...
                onDblClickRow: function (rowIndex, rowData) {
                    parent.window.frames["BackCheckOutSelBottom"].window.AddRow(rowData);
                }
            });
        }
        LoadList();
        ...
        function FastSearch() {
            ...
            $("#TableContainer").datagrid({
                url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CheckOut&Command=CheckOutDetailListDialog_New&' + $('#frmForm').serialize(),
                method: "get",
                idField: "Id",
                nowrap: true,
                pageSize: 50,
