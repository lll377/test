<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseSelBottom.aspx.cs" Inherits="M_Main.Mt.StorageDialog.PurchaseSelBottom" %>
<!DOCTYPE html>
<html>
<head>
    <title>采购申请单选中列表</title>
...
<body>
    ...
    <script type="text/javascript">
        ...
        column = [[
                        ...
                        { field: 'MaterialTypeName', title: '物资类别', width: 160, align: 'center', sortable: true },
                        { field: 'MaterialName', title: '物资名称', width: 100, align: 'center', sortable: true },
