<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierCooperationPeriodImportExcel.aspx.cs" Inherits="M_Main.Mt.SupplierCooperationPeriodImportExcel" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>供货期间物资批量导入</title>
...
<body style="margin: 0px; margin-top: 0px;" scroll="no">
    ...
    <input type="hidden" id="DecimalNum" name="DecimalNum" runat="server" value="4" />
        ...
        <script language="javascript" type="text/javascript">
            ...
            InitTableHeight();
            var column = [[
                    { field: '物资名称', title: '物资名称', width: 100, align: 'left', sortable: true },
                    { field: '物资编号', title: '物资编号', width: 100, align: 'left', sortable: true },
                    {
                        field: '含税价', title: '含税价', width: 100, align: 'left', sortable: true, formatter: function (value, row, index) {
                            return ToDecimal(row.含税价, decimalPos);
                        }
                    },
                    {
                        field: '税率', title: '税率', width: 100, align: 'left', sortable: true, editor: { type: 'numberbox', options: { precision: 2, min: 0, max: 1 } }
                    },
                    {
                        field: '不含税价', title: '不含税价', width: 100, align: 'left', sortable: true, formatter: function (value, row, index) {
                            return ToDecimal(row.不含税价, decimalPos);
                        }
                    },
            ]];
            ...
            function StartImport() {
                $.tool.DataPost('MaterialSupplierInfo', 'StartImportSalaryData_baoxian', $('#frmForm').serialize(),
                        function Init() {
                        },
