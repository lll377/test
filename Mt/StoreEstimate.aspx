<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoreEstimate.aspx.cs" Inherits="M_Main.Mt.StoreEstimate" %>
        ...
        <script type="text/javascript">
            ...
            column = [
                [
                    ...
                    { rowspan: 2, field: '物料类别', title: '2级物料类别', align: 'center', sortable: false, width: 100 },
                    { rowspan: 2, field: '物料类别', title: '3级物料类别', align: 'center', sortable: false, width: 100 },
                    { rowspan: 2, field: '物料类别', title: '4级物料类别', align: 'center', sortable: false, width: 100 },
                    { colspan: 3, title: '期初余额' },
                    { colspan: 3, title: '收入' },
                    { colspan: 3, title: '钩稽' },
                    { colspan: 3, title: '期末余额' }
                ],
                [
                    { field: '期初数量', title: '数量', align: 'center', sortable: false, width: 100 },
                    { field: '期初结存数量', title: '单价', align: 'center', sortable: false, width: 100 },
                    { field: '期初结存金额', title: '金额', align: 'center', sortable: false, width: 100 },
                    { field: '本期收入单价', title: '数量', align: 'center', sortable: false, width: 100 },
                    { field: '本期收入数量', title: '单价', align: 'center', sortable: false, width: 100 },
                    { field: '本期收入金额', title: '金额', align: 'center', sortable: false, width: 100 },
                    { field: '本期发出单价', title: '数量', align: 'center', sortable: false, width: 100 },
                    { field: '本期发出数量', title: '单价', align: 'center', sortable: false, width: 100 },
                    { field: '本期发出金额', title: '金额', align: 'center', sortable: false, width: 100 },
                    { field: '期末结存单价', title: '数量', align: 'center', sortable: false, width: 100 },
                    { field: '期末结存数量', title: '单价', align: 'center', sortable: false, width: 100 },
            ...
            function LoadList() {
                ...
                $("#TableContainer").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        param = $.JQForm.GetParam("MaterialStat", "StoreEstimate", "TableContainer", param);
                    },
