<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatchImportPurchase.aspx.cs" Inherits="M_Main.Mt.BatchImportPurchase" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>批量导入采购明细信息</title>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#btnImport").click(function () {
                if (CheckFile()) {
                    ...
                    var ImportType = "BatchImportPurchase";
        ...
        //生成文件
        function CreExcel() {
            HDialog.Open(600, 300, '../ImportExcel/ExcelDownload/PurchaseDetailExcel.aspx', '生成物资明细模板文件', false, function callback(_Data) {
            });
        }
