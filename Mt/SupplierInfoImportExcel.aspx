<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierInfoImportExcel.aspx.cs" Inherits="M_Main.Mt.SupplierInfoImportExcel" %>
...
<body style="margin: 0px; margin-top: 0px;" scroll="no">
    ...
    <input type="hidden" id="DecimalNum" name="DecimalNum" runat="server" value="4" />
        ...
        <script language="javascript" type="text/javascript">
            ...
            InitTableHeight();
            var column = [[
                { field: '供方名称', title: '供方名称', width: 100, align: 'center', sortable: true },
                { field: '供方类别', title: '供方类别', width: 100, align: 'center', sortable: true },
                { field: '管理单位', title: '管理单位', width: 100, align: 'center', sortable: true },
                { field: '企业类型', title: '企业类型', width: 100, align: 'center', sortable: true },
                { field: '联系人', title: '联系人', width: 100, align: 'center', sortable: true },
                { field: '联系电话', title: '联系电话', width: 100, align: 'center', sortable: true },
                { field: '供方编号', title: '供方编号', width: 100, align: 'center', sortable: true }
            ]];
            ...
            function StartImport() {
                ...
                console.log(ob);
                $.tool.DataPost('MaterialSupplierInfo', 'SupplierImport', $('#frmForm').serialize(),
                        function Init() {
                        },
