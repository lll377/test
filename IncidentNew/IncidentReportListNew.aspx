<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncidentReportListNew.aspx.cs" Inherits="M_Main.IncidentNew.IncidentReportListNew" %>
                            ...
                            <div class="row">
                                        ...
                                        <div class="col-sm-4" style="font-size:15px;font-family:微软雅黑;line-height:30px;">
                                          ...
                                          <a  id="Rp_13" data-url="../IncidentNewJH/IncidentNewCorpStatisticsNew3.aspx">3、报事统计表-书面</a><br />
                                            ...
                                            <a  id="Rp_21" data-url="../IncidentNewJH/IncidentNewCorpStatistics_FenLei.aspx">5、报事分类统计表（新）</a><br />
                                            <a  id="Rp_19" data-url="../IncidentNew/IncidentMonNewStatistics.aspx">6、报事按月分类统计</a><br />
                                           <a  id="Rp_15" data-url="../IncidentNew/IncidentMonthCorpStatistics_New.aspx">7、报事按月统计表</a><br />
                                         <a  id="Rp_16" data-url="../IncidentNew/IncidentDayToNewStatisticsToSubdivide.aspx">8、报事按日统计表</a><br />
                                            <a  id="Rp_17" data-url="../IncidentNewJH/IncidentSatisfactionStatistics.aspx">9、报事满意度统计表</a><br />
                                          <a  id="Rp_18" data-url="../IncidentNewJH/NewIncidentEmployeeKPIStatistics.aspx">10、报事绩效统计表</a><br />
                                            <a  id="Rp_20" data-url="../IncidentNew/IncidentNewCorpservice.aspx">11、报事费用统计</a><br />
                                            <a  id="Rp_22" data-url="../IncidentNewJH/IncidentReport/Incident_BaoBiaoYuJinTongJi_Report_12.aspx">12、报事预警统计</a><br />
                                          <%--  <a  id="Rp_21" data-url="../IncidentNewJH/IncidentStatisticsContainer.aspx">11、报事统计</a><br />
