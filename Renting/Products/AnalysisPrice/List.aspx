<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="M_Main.Renting.Products.AnalysisPrice.List" %>
...
<body style="padding: 0px; margin: 0px; overflow: hidden;">
    <div id="layout" class="easyui-layout" data-options="fit:true">
            ...
            <form class="form-horizontal dialog-fixed-tool-top" role="form" style="background-color: #F5F5F5;">
                <div class="form-group">
                    <div class="col-sm-12 col-xs-12" style="width: 100%;">
                        <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-add',width:100" onclick="DistanceClick();">租金分组</a>
                        ...
                        <a id="tip" href="javascript:void(0)" class="easyui-linkbutton easyui-tooltip" title="<div><p>温馨提示：<br/>&emsp;&emsp;请先设置租金分组!</p></div>" data-options="plain:true,iconCls:'icon-help'"></a>
                    </div>
                </div>
            </form>
                ...
                <form id="formSearch" class="form-horizontal" role="form">
                    <fieldset class="frame-fieldset">
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-sm-1 col-xs-1 control-label">距本项目距离从</label>
                            <div class="col-sm-3 col-xs-3">
                                <input type="text" id="DistanceStart" name="DistanceStart" class="easyui-numberbox" runat="server"
                                    data-options="width:'100%',min:0,precision:2" />
                            </div>
                            <label class="col-sm-1 col-xs-1 control-label">到</label>
                            <div class="col-sm-3 col-xs-3">
                                <input type="text" id="DistanceEnd" name="DistanceEnd" class="easyui-numberbox" runat="server"
                                    data-options="width:'100%',min:0,precision:2" />
                            </div>
                        </div>
                    </fieldset>
        ...
        <div id="layout_center" data-options="region:'center',border:false" style="padding: 0px;">
            <div id="PricePie" style="height: 100%; width: 100%;"></div>
        </div>
    </div>
    <script language="javascript" type="text/javascript">
        ...
        function DistanceClick() {
            LayerDialog.OpenWin('800', '500', '/HM/M_Main/Renting/Products/AnalysisPrice/Edit.aspx', "租金分组设置", true, function callback(_Data) {
                if (_Data != "") {
        ...
        function LoadData() {
            ...
            $.dataPostJson("Renting_Products_AnalysisPrice", 'BuildingPriceDataStructure', $.getParam(), true, false,
                function Init() {
                },
        ...
        function InitPie(LegendData, SeriesData) {
            ...
            var dom = document.getElementById("PricePie");
