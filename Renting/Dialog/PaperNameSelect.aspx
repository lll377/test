<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaperNameSelect.aspx.cs" Inherits="M_Main.Renting.Dialog.PaperNameSelect" %>
...
<body style="margin: 0px; padding: 0px; overflow: hidden;">
    ...
    <script language="javascript" type="text/javascript">
        ...
        var column = [[
            { field: 'DictionaryCode', title: '证件编号', width: 50, align: 'center' },
            { field: 'DictionaryName', title: '证件名称', width: 100, align: 'center' }
        ]];
        function InitDataGrid() {
            ...
            $("#dg").datagrid({
                ...
                onBeforeLoad: function (param) {
                    param.SortField = "DictionaryOrderId";
                    param.SortOrder = 0;
                    param = $.getDataGridParam("RentingPublicClass", "GetPaperNameList", param);
                },
