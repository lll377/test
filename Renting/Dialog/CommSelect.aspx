<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CommSelect.aspx.cs" Inherits="M_Main.Renting.Dialog.CommSelect" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function InitDataGrid() {
            ...
            $("#dg").datagrid({
                ...
                onBeforeLoad: function (param) {
                    ...
                    param.IsPowerPost = $("#IsPowerPost").val();
                    param.IsPowerLevel = $("#IsPowerLevel").val();
                    param = $.getDataGridParam("RentingPublicClass", "GetListCommunity", param);
                },
        ...
        function AddAllProject() {
            ...
            if (nodes.length > 0) {
                ...
                param.IsPowerPost = $("#IsPowerPost").val();
                param.IsPowerLevel = $("#IsPowerLevel").val();
                $.dataPostJson('RentingPublicClass', 'GetListDataTableCommunity', param, true, false,
                    function Init() {
                    },
