<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerTypeSelect.aspx.cs" Inherits="M_Main.Renting.Dialog.CustomerTypeSelect" %>
...
<head runat="server">
    ...
    <title>租赁管理-选择客户类别-Tb_HSPR_CustType通过CommID过滤</title>
...
<body style="margin: 0px; padding: 0px; overflow: hidden;">
        ...
        <form id="frm" class="form-horizontal" role="form">
            <div class="form-group">
                <div class="col-sm-12 col-xs-12">
                    ...
                    <input id="CustTypeName" name="CustTypeName" class="easyui-textbox" data-options="prompt:'',
                        icons:[{
                            iconCls:'icon-clear',
                            handler: function(e){
    ...
    <script language="javascript" type="text/javascript">
        ...
        var column = [[
            { field: 'CustTypeName', title: '客户类别名称', width: 100, align: 'center'}
        ]];
        function InitDataGrid() {
            ...
            $("#dg").datagrid({
                ...
                onBeforeLoad: function (param) {
                    param.SortField = "CustTypeSign";
                    param.SortOrder = 0;
                    param = $.getDataGridParam("RentingPublicClass", "GetCustomerTypeList", param);
                },
