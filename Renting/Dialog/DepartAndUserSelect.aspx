<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartAndUserSelect.aspx.cs" Inherits="M_Main.Renting.Dialog.DepartAndUserSelect" %>
...
<body style="margin: 0px; padding: 0px; overflow: hidden;">
    ...
    <script language="javascript" type="text/javascript">
        ...
        var column = [[
            { field: 'UserName', title: '人员名称', width: 80, align: 'left' },
            { field: 'LoginCode', title: '登录账号', width: 80, align: 'left' },
            { field: 'DepName', title: '所在部门', width: 220, align: 'left' }
        ]];
        function InitDataGrid() {
            $("#dg").datagrid({
                ...
                onBeforeLoad: function (param) {
                    param.SortField = "UserCode";
                    param.SortOrder = 0;
                    param = $.getDataGridParam("RentingPublicClass", "GetUserListWithDepartment", param);
                },
