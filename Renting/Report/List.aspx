<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="M_Main.Renting.Report.List" %>
                ...
                <div class="col-sm-12">
                    <div class="ibox">
                        <div class="ibox-title">
                            <span style="font-family: 微软雅黑; font-size: 14px; font-weight: bold;">租赁报表</span>
                        </div>
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-sm-4" style="font-size: 15px; font-family: 微软雅黑; line-height: 30px;">
                                    <a id="Rp_01" data-url="/HM/M_Main/Renting/Report/ContractAccountReport.aspx">1、合同台账报表(T+1)</a><br />
                                    <a id="Rp_02" data-url="/HM/M_Main/Renting/Report/MerchantsAccountReport.aspx">2、客户台账报表(T+1)</a><br />
                                    <a id="Rp_03" data-url="/HM/M_Main/Renting/Report/RentingSynthesizeReport.aspx">3、租赁综合报表(T+1)</a><br />
                                    <a id="Rp_04" data-url="/HM/M_Main/Renting/Report/RentingBussinessReport.aspx">4、租赁经营报表(T+1)</a><br />
                                </div>
                            </div>
                        </div>
                    </div>
