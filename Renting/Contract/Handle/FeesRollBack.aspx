<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeesRollBack.aspx.cs" Inherits="M_Main.Renting.Contract.Handle.FeesRollBack" %>
...
<head runat="server">
    ...
    <title>租赁管理-租赁合同-租赁合同办理-费用反转移</title>
    ...
    <script type="text/javascript" src="/HM/M_Main/Jscript/json2.js"></script>
    ...
    <link href="/HM/M_Main/css/framesearch.css" type="text/css" rel="stylesheet" />
    <script type="text/javascript" src="/HM/M_Main/Jscript-Ui/JQForm/JQForm.js"></script>
    <script type="text/javascript" src="/HM/M_Main/jscript/DateFormat.js"></script>
    ...
    <form id="LeaseRoomTransFee" method="post" runat="server">
        ...
        <table style="text-align: center; bottom: 0; position: fixed; width: 100%; height: 22px; background-color: #f5f5f5; border-top: 1px solid #cccccc;">
            <tr>
                <td align="center">
                    ...
                    <input class="button" id="btnReturn" type="button" value="关闭" onclick="close()" name="btnReturn" runat="server"></td>
            </tr>
        </table>
        ...
        <div id="toolbar">
            <table style="width: 100%;">
                <tr>
                    <td style="padding-left: 5px;"><span class="fa fa-laptop"></span>租户应收费用</td>
        ...
        <div id="toolbar2">
            <table style="width: 100%;">
                <tr>
                    <td style="padding-left: 5px;"><span class="fa fa-laptop"></span>租户主预交余额</td>
