<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="M_Main.Renting.Contract.Register.Update" %>
...
<body style="padding: 0px; margin: 0px; overflow: hidden;">
    ...
    <form id="mainForm" class="form-horizontal" role="form" style="overflow-y: auto;">
        <fieldset class="frame-fieldset">
            <legend class="frame-legend">合同信息</legend>
    ...
    <script type="text/javascript">
        ...
        function Save() {
            if ($('#mainForm').form("validate")) {
                $.dataPostJson("Renting_Contract", 'UpdateSignUpTimeAndAddress', $.getParam(), true, false,
                    function Init() {
                    },
