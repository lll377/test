<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sign.aspx.cs" Inherits="M_Main.Renting.Contract.Search.Sign" %>
        ...
        var toolbar = [
            ...
            }, '-',
            {
                ...
                handler: function () {
                    ...
                    param.IsZip = "否";
                    param.TableName = "合同签订信息";
                    param.Class = 'Renting_ContractSearch';
                    param.Method = "GetSignListSqlWhere";
        ...
        function InitDataGrid() {
            $("#TableContainer").datagrid({
                ...
                onBeforeLoad: function (param) {
                    ...
                    param.SortOrder = 1;
                    param.IsDelete = 0;
                    param = $.getDataGridParam("Renting_ContractSearch", "GetSignList", param);
                },
