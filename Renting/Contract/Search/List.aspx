<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="M_Main.Renting.Contract.Search.List" %>
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-sm-4" style="font-size: 15px; font-family: 微软雅黑; line-height: 30px;">
                                    <a id="Rp_01" data-url="/HM/M_Main/Renting/Contract/Search/Sign.aspx">1、合同签订信息查询</a><br />
                                    <a id="Rp_02" data-url="/HM/M_Main/Renting/Contract/Search/Change.aspx">2、合同变更信息查询</a><br />
                                    <a id="Rp_03" data-url="/HM/M_Main/Renting/Contract/Search/Royalty.aspx">3、合同提成信息查询</a><br />
                                    <a id="Rp_04" data-url="/HM/M_Main/Renting/Contract/Search/Fees.aspx">4、合同费用信息查询</a><br />
                                </div>
                            </div>
                        </div>
                    </div>
