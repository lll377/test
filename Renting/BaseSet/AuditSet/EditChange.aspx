<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditChange.aspx.cs" Inherits="M_Main.Renting.BaseSet.AuditSet.EditChange" %>
...
<body style="padding: 0px; margin: 0px; overflow: hidden;">
    ...
    <input type="hidden" name="AuditType" id="AuditType" value="租赁合同变更" />
        ...
        <fieldset class="frame-fieldset">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10 col-xs-10">
                    <input id="ChangeType" name="ChangeType" class="easyui-combobox" data-options="editable:false,tipPosition:'bottom',panelHeight:'auto',
        ...
        function InitData() {
            $.dataPostJson("Renting_AuditSet", 'GetModel', $.getParam(), true, false,
                ...
                function callback(data) {
                    if (data) {
                        $('#ChangeType').combobox("setValue", data.ChangeType);
