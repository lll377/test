<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewAlgorithmFeesDebtCutSearch.aspx.cs" Inherits="M_Main.Inquiries.NewAlgorithmFeesDebtCutSearch" %>
...
<head id="Head1" runat="server">
    ...
    <link href="../css/framesearch_old.css" rel="stylesheet" />
    <link href="../css/button.css" rel="stylesheet" />
    <script src="../jscript/DateControl.js"></script>
...
<body style="overflow-y: hidden">
    <form id="NewFeesDueCutSearch" runat="server">
        ...
        <input id="hiPropertyRights" type="hidden" name="hiPropertyRights" runat="server" />
        ...
        <div id="tt" class="easyui-tabs" style='overflow: hidden'>
                ...
                <div id="SearchDlg" class="easyui-dialog" title="筛选条件" data-options="iconCls:'icon-search',closed: true,modal:true" style="width: 700px; height: 400px;">
                    <table class="DialogTable">
                        ...
                        <tr>
                            ...
                            <td class="TdContentSearch">
                                <input id="CustName" searcher="SelCust" style="width: 90%" name="CustName" class="easyui-searchbox" data-options="editable:false" runat="server" />
            ...
            <div title="欠费账龄" style="width: 100%; overflow: hidden">
            ...
            <div title="组团汇总" style="width: 100%; overflow: hidden">
        ...
        <div id="tb">
            <table border="0" style="font-size: 12px; font-family: 微软雅黑;">
             ...
             费用时间从&nbsp;<input type="text" class="Wdate" onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd' })" id="EditBeginDate" runat="server" name="EditBeginDate" />&nbsp;到&nbsp;<input type="text" runat="server" class="Wdate" onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd' })" id="EditEndDate" name="EditEndDate" /></td>
        ...
        <script type="text/javascript">
            ...
            var column = [[
                ...
                { field: 'StateName', fixed: true, title: '房屋状态', align: 'left', sortable: true, width: 100 },
                ...
                { field: 'RoomPropertyRights', title: '产权性质', align: 'left', sortable: true, fixed: true, width: 100 },
                ...
                { field: 'LateFeeAmount', title: '合同违约金', align: 'left', sortable: true, fixed: true, width: 100 },
                { field: 'PrecBalance', title: '截止预交余额', align: 'left', sortable: true, fixed: true, width: 100 },
        ...
        <script type="text/javascript">
            ...
            function ToExcel() {
                ...
                window.location.href = "NewFeesDebtCutSearchCre.aspx?Flag=" + strFlag;
            }
            $('#tt').tabs({
                border: false,
                onSelect: function (title, index) {
                    ...
                    if (index == 1) {
                        $('#pag1').attr('src', 'NewFeesDebtCut1Search.aspx');
                        $('#pag2').attr('src', '');
                        $('#pag3').attr('src', '');
                        $('#pag4').attr('src', '');
                        $('#pag5').attr('src', '');
                    ...
                    if (index == 3) {
                        $('#pag1').attr('src', '');
                        $('#pag2').attr('src', '');
                        $('#pag3').attr('src', 'NewAlgorithmFeesDebtCut2Search.aspx');
                        $('#pag4').attr('src', '');
                        $('#pag5').attr('src', '');
                        $('#pag6').attr('src', '');
                        $('#pag7').attr('src', '');
                    ...
                    if (index == 4) {
                        ...
                        $('#pag2').attr('src', '');
                        $('#pag3').attr('src', '');
                        $('#pag4').attr('src', 'NewFeesDebtCut8Search.aspx');
                        $('#pag5').attr('src', '');
                        $('#pag6').attr('src', '');
                        $('#pag7').attr('src', '');
                    }
                    if (index == 5) {
                        ...
                        $('#pag3').attr('src', '');
                        $('#pag4').attr('src', '');
                        $('#pag5').attr('src', 'NewFeesDebtCut3Search.aspx');
                        $('#pag6').attr('src', '');
                        $('#pag7').attr('src', '');
                    }
                    if (index == 6) {
                        ...
                        $('#pag4').attr('src', '');
                        $('#pag5').attr('src', '');
                        $('#pag6').attr('src', 'NewFeesDebtCut4Search.aspx');
                        $('#pag7').attr('src', '');
                    }
                    if (index == 7) {
                        $('#pag1').attr('src', '');
                        ...
                        $('#pag5').attr('src', '');
                        $('#pag6').attr('src', '');
                        $('#pag7').attr('src', 'NewFeesDebtCut5Search.aspx');
                    }
                }
            });
        </script>
