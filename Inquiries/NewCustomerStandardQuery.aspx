<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewCustomerStandardQuery.aspx.cs" Inherits="M_Main.Inquiries.NewCustomerStandardQuery" %>
    ...
    <form id="NewFeesDueCutSearch" runat="server">
        ...
        <div id="SearchDlg" class="easyui-dialog" title="筛选条件" data-options="iconCls:'icon-search',closed: true,modal:true" style="width: 700px; height: 250px;">
            <table class="DialogTable">
                <tr>
                    ...
                    <td class="TdContentSearch" ><input id="RegionNames" class="easyui-searchbox" searcher="SelRegion" data-options="editable:false"
                    ...
                    <td class="TdContentSearch" ><input id="BuildNames"  class="easyui-searchbox" searcher="SelBuild" data-options="editable:false"
        ...
        <%--  <div id="SearchDlg2" class="easyui-dialog" title="筛选条件" data-options="iconCls:'icon-search',closed: true,modal:true" style="width: 700px; height: 250px;">
            ...
            <table class="DialogTable">
                <tr>
                    <td class="TdTitle">客户名称</td>
                    <td class="TdContentSearch"><INPUT id="CustName2"  searcher="SelCust2"
                    ...
                    <td class="TdTitle">可选房号</td>
                    <td class="TdContentSearch"><select id="SelectRoomID2" style="width: 150px" class="easyui-combobox" data-options="editable:false,panelHeight: 'auto'" name="SelectRoomID2" runat="server">
                            <option selected></option>
                        </select></td>
                </tr>
                <tr>
                    <td class="TdTitle">房屋编号</td>
                    <td class="TdContentSearch"><INPUT  id="RoomSign2"  class="easyui-searchbox" searcher="SelRoom2" name="RoomSign2" data-options="editable:false" runat="server"/>
                    ...
                    <td class="TdTitle">费用项目</td>
                    <td class="TdContentSearch"><input  id="CostNames2" class="easyui-searchbox" data-options="editable:false" searcher = "SelCost2"
                ...
                <tr>
                    ...
                    <td class="TdContentSearch"><input type="text" class="easyui-datebox" id="EditBeginDate2" runat="server" name="EditBeginDate2" /></td>
                    <td class="TdTitle">到</td>
                    <td class="TdContentSearch"><input type="text" class="easyui-datebox" id="EditEndDate2" runat="server" name="EditEndDate2" /></td>
                </tr>
        ...
        <div id="SearchDlg3" class="easyui-dialog" title="筛选条件" data-options="iconCls:'icon-search',closed: true,modal:true" style="width: 700px; height: 250px;">
            <table class="DialogTable">
                <tr>
                    <td class="TdTitle">楼宇</td>
                    <td class="TdContentSearch"><input id="BuildNames3" class="easyui-searchbox" searcher="SelBuild3" data-options="editable:false"
                                name="BuildNames3" runat="server" />
                        <input id="BuildSNums3"  type="hidden" size="1" name="BuildSNums3" runat="server"/></td>
                     <td class="TdTitle" >组团区域</td>
                    <td class="TdContentSearch" ><input id="RegionNames3" class="easyui-searchbox" searcher="SelRegion3" data-options="editable:false"
                            name="RegionNames" runat="server">
                ...
                <tr>
                    ...
                    <td class="TdContentSearch">
                     ...
                     <td class="TdTitle">房屋编号</td>
                    <td class="TdContentSearch"><INPUT  id="RoomSign3"  class="easyui-searchbox" searcher="SelRoom3" name="RoomSign3" data-options="editable:false" runat="server"/>
        ...
        function InitTableHeight() {
            ...
            //$("#TableContainer2").css("height", h2 + "px");
            //$("#TableContainer3").css("height", h1 +48+ "px");
            //$("#TableContainer4").css("height", h1 +48+ "px");
        ...
        function SelCustIndex(index) {
            ...
            var CostStanColumns2158 = [[
                ...
                { field: 'ChargeCycleName', title: '计费周期', align: 'left', sortable: true, width: 100 },
                {
                    field: 'CalcBeginDate', title: '计费开始时间', align: 'left', sortable: true, width: 100,
        ...
        <script type="text/javascript">
            ...
            $(function ()
            {              
                if ($("#HidCorpID").val() == "2158")
                {
                    column = CostStanColumns2158;
                } else {
                    column = CostStanColumns;
                }
                LoadList('');
            });
         //$('#tt').tabs({
