<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmergencyEventReportSearch.aspx.cs" Inherits="M_Main.Emergency.EmergencyEventReportSearch" %>
...
<body style="margin: 0px; padding: 0px; overflow: hidden">
    ...
    <script type="text/javascript"> 
        ...
        var toolbar = [
            {
                ...
                handler: function () {
                    ...
                    if (Rows.length == 0) {
                        HDialog.Info('没有需要导出的应急事件数据!');
                        return;
                    }
                    window.open("EmergencyEventReportSearchExport.aspx?" + $('#frmFrom').serialize());
                }
            }
        ];
        ...
        function Detail(OpType, ID) {
            ...
            HDialog.OpenWin(w, h, '../Emergency/EmergencyEventReportDetail.aspx?Flag=1&OpType=' + OpType + '&ID=' + ID, "应急事件报告详情", false, function callback(_Data) {
                if (_Data != "") {
                    LoadList();
                }
            });
