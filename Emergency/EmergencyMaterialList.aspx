<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmergencyMaterialList.aspx.cs" Inherits="M_Main.Emergency.EmergencyMaterialList" %>
...
<body style="margin: 0px; padding: 0px; overflow: hidden;">
    ...
    <script language="javascript" type="text/javascript">
        ...
        // 停用/启用
        function StopAndBegin(ID) {
            $.messager.confirm('确定', '是否确认停用/启用应急物资信息?', function (r) {
                if (r) {
                    $.tool.DataPostJson('Emergency', 'EmergencyMaterialStopAndBegin', "ID=" + ID,
                        function Init() {
                        },
        ...
        function Detail(OpType, ID, CommID) {
            ...
            HDialog.OpenWin(w, h, '../Emergency/EmergencyMaterialDetail.aspx?OpType=' + OpType + '&ID=' + ID + "&CommID=" + CommID, "应急物资详情", false, function callback(_Data) {
                if (_Data != "") {
                    LoadList();
                }
            });
        ...
        function DelRecord(IdList) {
            $.messager.confirm('确定', '是否删除该应急物资?', function (r) {
                if (r) {
                    $.tool.DataPostJson('Emergency', 'DelEmergencyMaterial', "idList=" + IdList,
                        function Init() {
                        },
                        function callback(data) {
                            if (data.result) {
