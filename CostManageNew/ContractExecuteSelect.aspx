<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractExecuteSelect.aspx.cs" Inherits="M_Main.CostManageNew.ContractExecuteSelect" %>
    ...
    <form id="frmFrom" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            ...
            var column = [[
                ...
                { field: 'DepName', title: '机构部门', width: 120, align: 'left', sortable: true },
                ...
                {
                    field: 'ContractName', title: '合同名称', width: 220, align: 'left', sortable: true, formatter: function (value, row, index) {
                ...
                { field: 'ContractMoney', title: '合同金额', width: 100, align: 'left', sortable: true },
                {
                    field: 'ExecuteDateBegin', title: '执行时间从', width: 100, align: 'left', sortable: true, formatter: function (value, row, index) {
                        var str = $.dateFormat(row.ExecuteDateBegin, 'yyyy-MM-dd');
                        return str;
                    }
                },
                {
                    field: 'ExecuteDateEnd', title: '到', width: 100, align: 'left', sortable: true, formatter: function (value, row, index) {
                        var str = $.dateFormat(row.ExecuteDateEnd, 'yyyy-MM-dd');
                        return str;
                    }
                },
                {
            ...
            function Export() {
                ...
                param.IsZip = "否";
                param.TableName = "合同执行";
                param.Class = "CsCost";
                param.Method = "GetContractExecutionListWhere";
