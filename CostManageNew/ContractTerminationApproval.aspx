<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractTerminationApproval.aspx.cs" Inherits="M_Main.CostManageNew.ContractTerminationApproval" %>
    ...
    <form id="frmForm" runat="server">
        ...
        <table class="DialogTable">
            <tr>
                ...
                <td class="DialogTdContent">
                    <input id="DepName" name="DepName" class="easyui-validatebox" runat="server" readonly="readonly" data-options="required:true" type="text" onclick="SelDepSer();" />
                ...
                <td class="DialogTdContent">
                    <input id="ContractNo" name="ContractNo" style="width: 68%;" data-options="required:true" class="easyui-validatebox" readonly="readonly" runat="server" type="text" onclick="SelContractInformation();" />
            ...
            <tr>
                ...
                <td class="DialogTdContent">
                    <input id="ContractName" name="ContractName" class="easyui-validatebox" data-options="required:true" readonly="readonly" runat="server" type="text" />
                </td>
                <td class="DialogTdTitle">合同类型：
                </td>
                <td class="DialogTdContent">
                    <input id="TypeName" name="TypeName" type="text" class="easyui-validatebox" data-options="required:true" readonly="readonly" runat="server" />
        ...
        <script type="text/javascript">
            ...
            //查看上传附件
            function OnFileList() {
                HDialog.Open(600, 450, '../DialogNew/ContractTenderFiles.aspx?CtId=' + $("#Id").val(), '查看招标附件', true, function callback(_Data) {
                });
            }
            ...
            function EndEdit() {
                ...
                if (parseFloat($('#AfterContractMoney').val()) < money) {
                    HDialog.Info("合同费用明细之和，不得大于“终止后合同金额”");
                }
            }
            ...
            function ClientClick() {
                ...
                //$('#TableContainer').datagrid('acceptChanges');
                //alert($('#TableContainer').datagrid('getChanges').length);
            ...
            function SelWorkFlowType() {
                ...
                if ($("#ContractType").val() == "") {
                    HDialog.Info("合同类型不能为空!");
                    return;
                }
                if ($("#AfterContractMoney").val() == "") {
                    HDialog.Info("请设置终止后合同金额!");
                    return;
                }
                var rows = $('#TableContainer').datagrid('getRows');
                var money = parseFloat('0');
                ...
                if (parseFloat($('#AfterContractMoney').val()) < money) {
                    ...
                    var FlowId = GetWorkFlow.CostWorkFlowId('0703', $("#ContractType").val(), $("#AfterContractMoney").val());
