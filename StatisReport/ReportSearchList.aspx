<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportSearchList.aspx.cs" Inherits="M_Main.StatisReport.ReportSearchList" %>
                ...
                <div class="col-sm-12">
                    <div class="ibox">
                        <div class="ibox-title">
                            <span style="font-family: 微软雅黑; font-size: 14px; font-weight: bold;">基础查询列表</span>
                        </div>
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-sm-4" style="font-size: 15px; font-family: 微软雅黑; line-height: 30px;">
                                    1、收费标准查询<br />
                                    <a id="Rp_01" data-url="../ChargesNew/NewCostStandardBrowse.aspx">（1）项目收费标准查询</a><br />
                                    <a id="Rp_02" data-url="../Inquiries/NewCostCommissionStanBrowse.aspx">（2）项目佣金标准查询</a><br />
                                    <a id="Rp_03" data-url="../Inquiries/NewRoomStateDetailBrowse.aspx">（3）项目收费比例查询</a><br />
                                    <a id="Rp_04" data-url="../Inquiries/NewCustomerStandardQuery.aspx">（4）客户当前标准查询</a><br />
                                    <a id="Rp_05" data-url="../Inquiries/CustomerHistoryStandardQuery.aspx">（5）客户历史标准查询</a><br />
                                    <a id="Rp_06" data-url="../Inquiries/NewNoPropertyFeesHousingQuery.aspx">（6）未设物管费房屋查询</a><br />
                                    <a id="Rp_07" data-url="../Inquiries/NewNoParkingFeesParkingQuery.aspx">（7）未设水电费表计查询</a><br />
                                    <a id="Rp_08" data-url="../Inquiries/NewNoWaterAndElectricityMeterQuery.aspx">（8）未设车位费车位查询</a><br />
                                    2、应收费用查询<br />
                                    <a id="Rp_09" data-url="../InquiriesNew/FeesDueSearchForSerial_New.aspx">（1）应收费用查询</a><br />
                                    <a id="Rp_10" data-url="../InquiriesNew/NewFeesEditSearch.aspx">（2）添加/修改应收费用查询</a><br />
                                    <a id="Rp_11" data-url="../InquiriesNew/NewFeesDelSearch.aspx">（3）撤销应收费用查询</a><br />
                                    <a id="Rp_32" data-url="../InquiriesNew/NewFeesDueNoSearch.aspx">（4）未生成应收费用查询</a><br />
                                ...
                                <div class="col-sm-4" style="font-size: 15px; font-family: 微软雅黑; line-height: 30px;">
                                    ...
                                    <a id="Rp_40" data-url="../InquiriesNew/NewCustFeesDetb.aspx">（4）收款截止时间查询</a><br />
                                    4、欠收费用查询<br />
                                    <a id="Rp_15" data-url="../InquiriesNew/NewFeesDebtCutSearch1New.aspx">（1）客户欠费明细记录查询</a><br />
                                    <a id="Rp_16" data-url="../InquiriesNew/NewFeesDebtCutSearch3.aspx">（2）按客户、费项欠费查询</a><br />
                                    <a id="Rp_17" data-url="../Inquiries/NewAlgorithmFeesDebtCut7Search.aspx">（3）按客户、费项、年度欠费查询</a><br />
                                    <%--<a id="Rp_18" data-url="../InquiriesNew/NewFeesDebtCut1Search.aspx">（4）按客户、费项、月份欠费查询</a><br />
                                    <a id="Rp_20" data-url="../Inquiries/NewFeesDebtCut8Search.aspx">（5）按组团欠费查询</a><br />
                                    <a id="Rp_21" data-url="../Inquiries/NewFeesDebtCut3Search.aspx">（6）按组团、费项欠费查询</a><br />--%>
                                    <a id="Rp_22" data-url="../Inquiries/NewFeesDebtCut4Search.aspx">（4）按主体欠费查询</a><br />
                                    <a id="Rp_23" data-url="../Inquiries/NewFeesDebtCut5Search.aspx">（5）按原因欠费查询</a><br />
                                </div>
