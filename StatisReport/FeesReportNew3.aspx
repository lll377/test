<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeesReportNew3.aspx.cs" Inherits="M_Main.StatisReport.FeesReportNew3" %>
    ...
    <form id="NewFeesDueCutSearch" runat="server">
        ...
        <div id="SearchDlg" class="easyui-dialog" title="筛选条件" data-options="iconCls:'icon-search',closed: true,modal:true" style="width: 820px; height: 330px; padding: 10px;">
            <table style="width: 100%; overflow: hidden;" class="DialogTable">
                ...
                <%--  <tr>
                    <td class="TdTitle" style="width: 150px;">收款开始时间</td>
                    <td class="TdContentSearch">
                        <input type="text" class="Wdate" style="width: 163px;" onclick="WdatePicker({ startDate: '%y-%M-01 00:00:00', dateFmt: 'yyyy-MM-dd HH:mm:ss', alwaysUseStartDate: true })" id="DueBeginDate" runat="server" name="DueBeginDate" /></td>
                    <td class="TdTitle" style="width: 150px;">收款开结束时间</td>
                    <td class="TdContentSearch">
                        <input type="text" class="Wdate" style="width: 163px;" runat="server" onclick="WdatePicker({ startDate: '%y-%M-01 00:00:00', dateFmt: 'yyyy-MM-dd HH:mm:ss', alwaysUseStartDate: true })" id="DueEndDate" name="DueEndDate" /></td>
                </tr> 
                  <tr>
                    ...
                    <td class="TdContentSearch">
                        <select id="CustTypeID" name="CustTypeID"  >
        ...
        <div id="DlgMemo" class="easyui-dialog" title="备注" data-options="iconCls:'icon-search',closed: true,modal:true" style="width: 550px; height: 205px; padding-left: 10px; padding-top: 5px;">
            <table cellpadding="0" cellspacing="0" border="0" width="100%" style='color: red; font-size:14px;'>
                <tr>
                    ...
                    1、用于统计某一期间预存费用的收款、退款、余额；“T+1”表示不管统计条件如何设置，数据范围截止上日；<br />
                    2、期初预存余额：截止收款开始时间的预存余额；<br />
                    3、本期预存收款：所选时间段内收取的预存费用金额；<br />
                    4、本期预存退款：所选时间段内退还的预存费用金额；<br />
                    5、本期预存冲抵：所选时间段内预存冲抵的费用金额；<br />
                    6、期末预存余额：截止收款结束时间的预存余额。<br />
        ...
        <script type="text/javascript">
            ...
            var ExcelCol = [
                ...
                {
                    field: '期初预存余额', title: '期初预存余额<br /> （1）', align: 'center', sortable: true, width: 120, formatter: function (value) {
                        if (value != "") {
                ...
                {
                    field: '含税金额', title: '含税金额<br /> （2）', align: 'center', sortable: true, width: 120, formatter: function (value) {
                        if (value != "") {
                ...
                {
                    field: '不含税金额', title: '不含税金额<br />（3）', align: 'center', sortable: true, width: 120, formatter: function (value) {
                        if (value != "") {
                ...
                {
                    field: '税额', title: '税额<br />（4）', align: 'center', sortable: true, width: 120, formatter: function (value) {
                        if (value != "") {
                ...
                {
                    field: '本期预存退款', title: '本期预存退款<br /> （5）', align: 'center', sortable: true, width: 120, formatter: function (value) {
                        if (value != "") {
                ...
                {
                    field: '本期预存冲抵', title: '本期预存冲抵<br /> （6）', align: 'center', sortable: true, width: 120, formatter: function (value) {
                        if (value != "") {
                ...
                {
                    field: '期末预存余额', title: '期末预存余额<br /> （7=1+2-5-6）', align: 'center', sortable: true, width: 120, formatter: function (value) {
                        if (value != "") {
            ...
            var column = [
                [
                    {
                        colspan: 1, rowspan: 2, field: '期初预存余额', title: '期初预存余额<br /> （1）', align: 'center', sortable: true, width: 120, formatter: function (value) {
                            if (value != "") {
                    ...
                    { colspan: 3, title: '本期预存收款' },
                    {
                        colspan: 1, rowspan: 2, field: '本期预存退款', title: '本期预存退款<br /> （5）', align: 'center', sortable: true, width: 120, formatter: function (value) {
                            if (value != "") {
                    ...
                    {
                        colspan: 1, rowspan: 2, field: '本期预存冲抵', title: '本期预存冲抵<br /> （6）', align: 'center', sortable: true, width: 120, formatter: function (value) {
                            if (value != "") {
                    ...
                    {
                        colspan: 1, rowspan: 2, field: '期末预存余额', title: '期末预存余额<br /> （7=1+2-5-6）', align: 'center', sortable: true, width: 120, formatter: function (value) {
                            if (value != "") {
                ...
                }, '-',
                {
                    ...
                    handler: function () {
                        ...
                        if (rowData == '') {
                            ...
                            window.location.href = 'FeesReportNew3ToExcel.aspx';
                        }
                    }
                }, '-',
                {
        ...
        <script type="text/javascript">
            ...
            function StartTask() {
                //启动一个任务
                $.tool.DataPostNoLoading('FeesReportNew3', 'StartTask', $('#NewFeesDueCutSearch').serialize(),
                    function Init() {
                    },
            ...
            function LoadList(page, rows) {
                ...
                $("#TableContainer").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        param = $.JQForm.GetParam("FeesReportNew3", "LoadData", "TableContainer", param);
                    },
            ...
            function TakeProgress() {
                $.tool.DataPostNoLoading('FeesReportNew3', 'TakeProgress', $('#NewFeesDueCutSearch').serialize(),
                    function Init() {
                    },
                    function callback(_Data) {
