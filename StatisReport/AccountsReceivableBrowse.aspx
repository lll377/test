<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountsReceivableBrowse.aspx.cs" Inherits="M_Main.StatisReport.AccountsReceivableBrowse" %>


<!DOCTYPE html>
<html>
<head>
    <title>应收汇总统计报表</title>
        ...
        <script type="text/javascript">
            ...
            var column = [
                [
                    ...
                    { field: '总户数', title: '总户数', align: 'center', sortable: true, width: 120 },
                    { field: '计费户数', title: '计费户数', align: 'center', sortable: true, width: 120 },
                    {
                        field: '总面积', title: '总面积', align: 'center', sortable: true, width: 120, formatter: function (value) {
                            if (value != "") return formatNumberRgx(value);
                        }
                    },
                    {
                        field: '总额', title: '总额', align: 'center', sortable: true, width: 120, formatter: function (value) {
                            if (value != "") return formatNumberRgx(value);
                        }
                    },
                    {
                        field: '优惠', title: '优惠', align: 'center', sortable: true, width: 120, formatter: function (value) {
                            if (value != "") return formatNumberRgx(value);
                        }
                    },
                    {
                        field: '应收', title: '应收', align: 'center', sortable: true, width: 120, formatter: function (value) {
                            if (value != "") return formatNumberRgx(value);
                        }
                    },
                    {
                        field: '实收', title: '实收', align: 'center', sortable: true, width: 120, formatter: function (value) {
                            if (value != "") return formatNumberRgx(value);
                        }
                    },
                    {
                        field: '预收', title: '预收', align: 'center', sortable: true, width: 120, formatter: function (value) {
                            if (value != "") return formatNumberRgx(value);
                        }
                    },
                    { field: '实收户数', title: '实收户数', align: 'center', sortable: true, width: 120 },
                    {
                        field: '欠费', title: '欠费', align: 'center', sortable: true, width: 120, formatter: function (value) {
                            if (value != "") return formatNumberRgx(value);
                        }
                    },
                    { field: '欠费户数', title: '欠费户数', align: 'center', sortable: true, width: 120 },
                    { field: '收费率', title: '收费率', align: 'center', sortable: true, width: 120 }
                ]
            ];
                ...
                }, '-',
                {
                    ...
                    handler: function () {
                        ...
                        if (rowData == '') {
                            ...
                            window.location.href = "AccountsReceivableBrowseToExcel.aspx";
                        }
                    }
                }
            ];
            ...
            function StartTask() {
                //启动一个任务
                $.tool.DataPostNoLoading('AccountsReceivable', 'StartTask', $('#frmForm').serialize(),
                    function Init() {
                    },
            ...
            function LoadData() {
                ...
                $("#TableContainer").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        param = $.JQForm.GetParam("AccountsReceivable", "LoadData", "TableContainer", param);
                    },
            ...
            function TakeProgress() {
                $.tool.DataPostNoLoading('AccountsReceivable', 'TakeProgress', $('#frmForm').serialize(),
                    function Init() {
                    },
                    function callback(_Data) {
