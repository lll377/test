<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ParkingSelSearch.aspx.cs" Inherits="M_Main.CarparkNew.ParkingSelSearch" %>
                ...
                <tr>
                    <td colspan="4">
                        <select name="from" ondblclick="removeItem();" id="from" style="width: 230px;" multiple="true">
                            ...
                            <option value="lbParkEndDate">已缴费时间至</option>
                        </select>
                    </td>
                    <td align="center">
...
<script language="javascript" type="text/javascript">
    ...
    var toolbar = [
        ...
        }, '-',
        {
            ...
            handler: function () {
                ...
                window.open("../CarparkNew/ParkingSelSearchCre.aspx?random=" + Math.random() + "&HiIFCode=" + fcode + "&HiIFName=" + ftext);
            }
        }, '-',
        {
    ...
    function LoadList() {
        ...
        $("#TableContainer").datagrid({
            ...
            //    HDialog.Open('1020', '670', '../CarparkNew/ParkingLendSearch.aspx?ParkID=' + rowData.ParkID + '&OpType=details',
            //        '车位查询', false, function callback(_Data) {
            //            if (_Data == "true") {
            //                LoadList();
            //            }
