<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="H5KanBan_8.aspx.cs" Inherits="M_Main.frame.PolyPropertyAPP.H5KanBan_8" %>
...
<head>
    ...
    <title id="CommName">管理层级信息看板</title>
    ...
    <script type="text/javascript">  
        ...
        function InitData() {
            $.dataPostJson('Tb_H5KanBan_8', 'InitData', { "UserCode": $("#UserCode").val(), "CommID": $("#CommID").val(), "OrganCode": $("#OrganCode").val() }, true, true,
                function Init() {
                },
                function callback(data) {
                    ...
                    initGauge({ id: "KHXX", value: data.ds3[0].Rate });
                    $("#KHXX_1").text(data.ds4[0].CommNum);
                    $("#KHXX_2").text(data.ds5[0].Num);
                    $("#KHXX_3").text(addThousands(data.ds6[0].Area));
                    $("#KHXX_4").text(addThousands(data.ds7[0].num));
                    $("#KHXX_5").text(data.ds8[0].num);
                    $("#KHXX_6").text(data.ds9[0].num);

                    initGaugeCar({ id: "SBXX", data: [{ value: data.ds12[0].IntactRate, title: "当前设备完好率" }, { value: data.ds13[0].EquipmentFailureRate, title: "当前设备故障率" }] });
                    $("#SBXX_1").text(addThousands(data.ds10[0].Num));
                    $("#SBXX_2").text(addThousands(data.ds11[0].EquipmentNum));
                    $("#SBXX_3").text(addThousands(data.ds11[0].bydqNum));
                    $("#SBXX_4").text(addThousands(data.ds11[0].zbqnNum));
                    $("#SBXX_5").text(addThousands(data.ds11[0].zxwbNum));
                    $("#SBXX_6").text(addThousands(data.ds11[0].wwwbNum));
                    ...
                    if (data.ds14[0].IsShow == 0) {
                        ...
                        isNotData = false;
                        initGauge({ id: "QBRW", value: data.ds14[0].ComletedRate });
                        $("#QBRW_1").text(addThousands(data.ds15[0].YesterdayComletedNum));
                        $("#QBRW_2").text(addThousands(data.ds15[0].YesterdayOverdueNum));
                        $("#QBRW_3").text(addThousands(data.ds16[0].TaskNum));
                        $("#QBRW_4").text(addThousands(data.ds16[0].ComletedNum));
                        $("#QBRW_5").text(addThousands(data.ds16[0].OverdueNum));
                    }
                    ...
                    if (data.ds17[0].IsShow == 0) {
                        ...
                        isNotData = false;
                        if (data.ds17[0].NoComletedNum == 0 && data.ds17[0].ComletedNum == data.ds17[0].NoComletedNum) {
                            data.ds17[0].NoComletedNum = 1;
                        }
                        initGraphic({ id: "BSGD", text: data.ds17[0].ComletedRate + "%", data: [{ value: data.ds17[0].ComletedNum, color: '#FFA36F' }, { value: data.ds17[0].NoComletedNum }] });
                        $("#BSGD_1").text(data.ds18[0].YesterdayComletedNum);
                        $("#BSGD_2").text(data.ds19[0].YesterdayComletedNum);
                        $("#BSGD_3").text(data.ds20[0].YesterdayOverdueNum);
                        $("#BSGD_4").text(data.ds21[0].TaskNum);
                        $("#BSGD_5").text(data.ds22[0].TaskNum);
                        $("#BSGD_6").text(data.ds23[0].ComletedNum);
                        $("#BSGD_7").text(data.ds24[0].ComletedNum);
                        $("#BSGD_8").text(data.ds25[0].OverdueNum);
                    }
                    ...
                    if (data.ds26[0].IsShow == 0) {
                        ...
                        isNotData = false;
                        initGraphic({ id: "KHBF", text: data.ds26[0].ComletedRate + "%", data: [{ value: data.ds26[0].ComletedNum, color: '#FC8F84' }, { value: data.ds26[0].NoComletedNum }] });
                        $("#KHBF_1").text(data.ds27[0].YesterdayComletedNum);
                        $("#KHBF_2").text(data.ds28[0].YesterdayComletedNum);
                        $("#KHBF_3").text(data.ds29[0].YesterdayOverdueNum);
                        $("#KHBF_4").text(data.ds30[0].TaskNum);
                        $("#KHBF_5").text(data.ds31[0].TaskNum);
                        $("#KHBF_6").text(data.ds32[0].ComletedNum);
                        $("#KHBF_7").text(data.ds33[0].ComletedNum);
                        $("#KHBF_8").text(data.ds34[0].OverdueNum);
                    }
                    ...
                    if (data.ds44[0].IsShow == 0) {
                        ...
                        isNotData = false;
                        initGraphic({ id: "ZXXC", text: data.ds44[0].ComletedRate + "%", data: [{ value: data.ds44[0].ComletedNum, color: '#05C2F8' }, { value: data.ds44[0].NoComletedNum }] });
                        $("#ZXXC_1").text(data.ds45[0].YesterdayComletedNum);
                        $("#ZXXC_2").text(data.ds46[0].YesterdayComletedNum);
                        $("#ZXXC_3").text(data.ds47[0].YesterdayOverdueNum);
                        $("#ZXXC_4").text(data.ds48[0].TaskNum);
                        $("#ZXXC_5").text(data.ds49[0].TaskNum);
                        $("#ZXXC_6").text(data.ds50[0].ComletedNum);
                        $("#ZXXC_7").text(data.ds51[0].ComletedNum);
                        $("#ZXXC_8").text(data.ds52[0].OverdueNum);
                    }
                    ...
                    if (data.ds53[0].IsShow == 0) {
                        ...
                        isNotData = false;
                        initGraphic({ id: "KFXC", text: data.ds53[0].ComletedRate + "%", data: [{ value: data.ds53[0].ComletedNum, color: '#FAC435' }, { value: data.ds53[0].NoComletedNum }] });
                        $("#KFXC_1").text(data.ds54[0].YesterdayComletedNum);
                        $("#KFXC_2").text(data.ds55[0].YesterdayComletedNum);
                        $("#KFXC_3").text(data.ds56[0].YesterdayOverdueNum);
                        $("#KFXC_4").text(data.ds57[0].TaskNum);
                        $("#KFXC_5").text(data.ds58[0].TaskNum);
                        $("#KFXC_6").text(data.ds59[0].ComletedNum);
                        $("#KFXC_7").text(data.ds60[0].ComletedNum);
                        $("#KFXC_8").text(data.ds61[0].OverdueNum);
                    }

                    if (data.ds62[0].IsShow == 0) {
                        $("#SBXJ_Div").hide();
                    } else {
                        isNotData = false;
                        initGraphic({ id: "SBXJ", text: data.ds62[0].ComletedRate + "%", data: [{ value: data.ds62[0].ComletedNum, color: '#4977E6' }, { value: data.ds62[0].NoComletedNum }] });
                        $("#SBXJ_1").text(data.ds63[0].YesterdayComletedNum);
                        $("#SBXJ_2").text(data.ds64[0].YesterdayComletedNum);
                        $("#SBXJ_3").text(data.ds65[0].YesterdayOverdueNum);
                        $("#SBXJ_4").text(data.ds66[0].TaskNum);
                        $("#SBXJ_5").text(data.ds67[0].TaskNum);
                        $("#SBXJ_6").text(data.ds68[0].ComletedNum);
                        $("#SBXJ_7").text(data.ds69[0].ComletedNum);
                        $("#SBXJ_8").text(data.ds70[0].OverdueNum);
                    }


                    if (data.ds71[0].IsShow == 0) {
                        $("#SBWB_Div").hide();
                    } else {
                        isNotData = false;
                        initGraphic({ id: "SBWB", text: data.ds71[0].ComletedRate + "%", data: [{ value: data.ds71[0].ComletedNum, color: '#FE9E62' }, { value: data.ds71[0].NoComletedNum }] });
                        $("#SBWB_1").text(data.ds72[0].YesterdayComletedNum);
                        $("#SBWB_2").text(data.ds73[0].YesterdayComletedNum);
                        $("#SBWB_3").text(data.ds74[0].YesterdayOverdueNum);
                        $("#SBWB_4").text(data.ds75[0].TaskNum);
                        $("#SBWB_5").text(data.ds76[0].TaskNum);
                        $("#SBWB_6").text(data.ds77[0].ComletedNum);
                        $("#SBWB_7").text(data.ds78[0].ComletedNum);
                        $("#SBWB_8").text(data.ds79[0].OverdueNum);
                    }

                    if (data.ds80[0].IsShow == 0) {
                        $("#FHCY_Div").hide();
                    } else {
                        isNotData = false;
                        initGraphic({ id: "FHCY", text: data.ds80[0].ComletedRate + "%", data: [{ value: data.ds80[0].ComletedNum, color: '#05C2F8' }, { value: data.ds80[0].NoComletedNum }] });
                        $("#FHCY_1").text(data.ds81[0].YesterdayComletedNum);
                        $("#FHCY_2").text(data.ds82[0].YesterdayComletedNum);
                        $("#FHCY_3").text(data.ds83[0].YesterdayOverdueNum);
                        $("#FHCY_4").text(data.ds84[0].TaskNum);
                        $("#FHCY_5").text(data.ds85[0].TaskNum);
                        $("#FHCY_6").text(data.ds86[0].ComletedNum);
                        $("#FHCY_7").text(data.ds87[0].ComletedNum);
                        $("#FHCY_8").text(data.ds88[0].OverdueNum);
                    }


                    if (data.ds89[0].IsShow == 0) {
                        $("#AQXG_Div").hide();
                    } else {
                        isNotData = false;
                        initGraphic({ id: "AQXG", text: data.ds89[0].ComletedRate + "%", data: [{ value: data.ds89[0].ComletedNum, color: '#45CFAF' }, { value: data.ds89[0].NoComletedNum }] });
                        $("#AQXG_1").text(data.ds90[0].YesterdayComletedNum);
                        $("#AQXG_2").text(data.ds91[0].YesterdayComletedNum);
                        $("#AQXG_3").text(data.ds92[0].YesterdayOverdueNum);
                        $("#AQXG_4").text(data.ds93[0].TaskNum);
                        $("#AQXG_5").text(data.ds94[0].TaskNum);
                        $("#AQXG_6").text(data.ds95[0].ComletedNum);
                        $("#AQXG_7").text(data.ds96[0].ComletedNum);
                        $("#AQXG_8").text(data.ds97[0].OverdueNum);
                    }


                    if (data.ds98[0].IsShow == 0) {
                        $("#XFXJ_Div").hide();
                    } else {
                        isNotData = false;
                        initGraphic({ id: "XFXJ", text: data.ds98[0].ComletedRate + "%", data: [{ value: data.ds98[0].ComletedNum, color: '#4483E0' }, { value: data.ds98[0].NoComletedNum }] });
                        $("#XFXJ_1").text(data.ds99[0].YesterdayComletedNum);
                        $("#XFXJ_2").text(data.ds100[0].YesterdayComletedNum);
                        $("#XFXJ_3").text(data.ds101[0].YesterdayOverdueNum);
                        $("#XFXJ_4").text(data.ds102[0].TaskNum);
                        $("#XFXJ_5").text(data.ds103[0].TaskNum);
                        $("#XFXJ_6").text(data.ds104[0].ComletedNum);
                        $("#XFXJ_7").text(data.ds105[0].ComletedNum);
                        $("#XFXJ_8").text(data.ds106[0].OverdueNum);
                    }


                    if (data.ds107[0].IsShow == 0) {
                        $("#HJBJ_Div").hide();
                    } else {
                        isNotData = false;
                        initGraphic({ id: "HJBJ", text: data.ds107[0].ComletedRate + "%", data: [{ value: data.ds107[0].ComletedNum, color: '#FC8F84' }, { value: data.ds107[0].NoComletedNum }] });
                        $("#HJBJ_1").text(data.ds108[0].YesterdayComletedNum);
                        $("#HJBJ_2").text(data.ds109[0].YesterdayComletedNum);
                        $("#HJBJ_3").text(data.ds110[0].YesterdayOverdueNum);
                        $("#HJBJ_4").text(data.ds111[0].TaskNum);
                        $("#HJBJ_5").text(data.ds112[0].TaskNum);
                        $("#HJBJ_6").text(data.ds113[0].ComletedNum);
                        $("#HJBJ_7").text(data.ds114[0].ComletedNum);
                        $("#HJBJ_8").text(data.ds115[0].OverdueNum);
                    }


                    if (data.ds116[0].IsShow == 0) {
                        $("#LHYH_Div").hide();
                    } else {
                        isNotData = false;
                        initGraphic({ id: "LHYH", text: data.ds116[0].ComletedRate + "%", data: [{ value: data.ds116[0].ComletedNum, color: '#FAC435' }, { value: data.ds116[0].NoComletedNum }] });
                        $("#LHYH_1").text(data.ds117[0].YesterdayComletedNum);
                        $("#LHYH_2").text(data.ds118[0].YesterdayComletedNum);
                        $("#LHYH_3").text(data.ds119[0].YesterdayOverdueNum);
                        $("#LHYH_4").text(data.ds120[0].TaskNum);
                        $("#LHYH_5").text(data.ds121[0].TaskNum);
                        $("#LHYH_6").text(data.ds122[0].ComletedNum);
                        $("#LHYH_7").text(data.ds123[0].ComletedNum);
                        $("#LHYH_8").text(data.ds124[0].OverdueNum);
                    }
                    ...
                    if (data.ds125[0].IsShow == 0) {
                        ...
                        isNotData = false;
                        initGraphic({ id: "SHXS", text: data.ds125[0].ComletedRate + "%", data: [{ value: data.ds125[0].ComletedNum, color: '#05C2F8' }, { value: data.ds125[0].NoComletedNum }] });
                        $("#SHXS_1").text(data.ds126[0].YesterdayComletedNum);
                        $("#SHXS_2").text(data.ds127[0].YesterdayComletedNum);
                        $("#SHXS_3").text(data.ds128[0].YesterdayOverdueNum);
                        $("#SHXS_4").text(data.ds129[0].TaskNum);
                        $("#SHXS_5").text(data.ds130[0].TaskNum);
                        $("#SHXS_6").text(data.ds131[0].ComletedNum);
                        $("#SHXS_7").text(data.ds132[0].ComletedNum);
                        $("#SHXS_8").text(data.ds133[0].OverdueNum);
                    }


                    if (data.ds134[0].IsShow == 0) {
                        $("#LJQY_Div").hide();
                    } else {
                        isNotData = false;
                        initGraphic({ id: "LJQY", text: data.ds134[0].ComletedRate + "%", data: [{ value: data.ds134[0].ComletedNum, color: '#4A78EA' }, { value: data.ds134[0].NoComletedNum }] });
                        $("#LJQY_1").text(data.ds135[0].YesterdayComletedNum);
                        $("#LJQY_2").text(data.ds136[0].YesterdayComletedNum);
                        $("#LJQY_3").text(data.ds137[0].YesterdayOverdueNum);
                        $("#LJQY_4").text(data.ds138[0].TaskNum);
                        $("#LJQY_5").text(data.ds139[0].TaskNum);
                        $("#LJQY_6").text(data.ds140[0].ComletedNum);
                        $("#LJQY_7").text(data.ds141[0].ComletedNum);
                        $("#LJQY_8").text(data.ds142[0].OverdueNum);
                    }

                    if (data.ds143[0].IsShow == 0) {
                        $("#PZHC_Div").hide();
                    } else {
                        isNotData = false;
                        initGraphic({ id: "PZHC", text: data.ds143[0].ComletedRate + "%", data: [{ value: data.ds143[0].ComletedNum, color: '#FC8F84' }, { value: data.ds143[0].NoComletedNum }] });
                        $("#PZHC_1").text(data.ds144[0].YesterdayComletedNum);
                        $("#PZHC_2").text(data.ds145[0].YesterdayComletedNum);
                        $("#PZHC_3").text(data.ds146[0].YesterdayOverdueNum);
                        $("#PZHC_4").text(data.ds147[0].TaskNum);
                        $("#PZHC_5").text(data.ds148[0].TaskNum);
                        $("#PZHC_6").text(data.ds149[0].ComletedNum);
                        $("#PZHC_7").text(data.ds150[0].ComletedNum);
                        $("#PZHC_8").text(data.ds151[0].OverdueNum);
                    }

                    if (data.ds152[0].IsShow == 0) {
                        $("#PZZG_Div").hide();
                    } else {
                        isNotData = false;
                        initGraphic({ id: "PZZG", text: data.ds152[0].ComletedRate + "%", data: [{ value: data.ds152[0].ComletedNum, color: '#FAC435' }, { value: data.ds152[0].NoComletedNum }] });
                        $("#PZZG_1").text(data.ds153[0].YesterdayComletedNum);
                        $("#PZZG_2").text(data.ds154[0].YesterdayComletedNum);
                        $("#PZZG_3").text(data.ds155[0].YesterdayOverdueNum);
                        $("#PZZG_4").text(data.ds156[0].TaskNum);
                        $("#PZZG_5").text(data.ds157[0].TaskNum);
                        $("#PZZG_6").text(data.ds158[0].ComletedNum);
                        $("#PZZG_7").text(data.ds159[0].ComletedNum);
                        $("#PZZG_8").text(data.ds160[0].OverdueNum);
                    }

                    if (data.ds161[0].IsShow == 0) {
                        $("#WNQQ_Div").hide();
                    } else {
                        isNotData = false;
                        initGauge({ id: "WNQQ", value: data.ds161[0].ComletedRate });
                        $("#WNQQ_1").text(addThousands(data.ds162[0].YesterdayComletedNum));
                        $("#WNQQ_2").text(addThousands(data.ds163[0].YesterdayComletedNum));
                        $("#WNQQ_3").text(addThousands(data.ds164[0].ComletedNum));
                        $("#WNQQ_4").text(addThousands(data.ds165[0].ComletedNum));
                    }
                    if (data.ds166[0].IsShow == 0) {
                        $("#BNSK_Div").hide();
                    } else {
                        isNotData = false;
                        initGauge({ id: "BNSK", value: data.ds166[0].ComletedRate });
                        $("#BNSK_1").text(addThousands(data.ds167[0].YesterdayComletedNum));
                        $("#BNSK_2").text(addThousands(data.ds168[0].YesterdayComletedNum));
                        $("#BNSK_3").text(addThousands(data.ds169[0].ComletedNum));
                        $("#BNSK_4").text(addThousands(data.ds170[0].ComletedNum));
                    }
...
<body>
    ...
    <input type="hidden" id="OrganCode" value="01960201" />
    ...
    <div class="container-fluid">
        <div class="row container-title">
            ...
            <%--<h1 class="container-span-title">管理层级信息看板</h1>--%>
        </div>
                        ...
                        <div id="KHXX_Div">
                            ...
                            <div class="col-md-5 col-xs-5 col-sm-5 mp0">
                                <div class="col-md-12 col-xs-12 col-sm-12 mp0 ">
                                    <div id="KHXX" style="width: 100%; height: 100%;"></div>
                                </div>
                                <div class="col-md-12 col-xs-12 col-sm-12 mp0 textcenter">
                                    <span class="f14 colorgrey">当前客户上线率</span>
                                </div>
                            </div>
                            <div class="col-md-7 col-xs-7 col-sm-7 mp0 pt5">
                                <div class="col-md-6 col-xs-6 col-sm-6 mp0">
                                    <span class="f16 "><b id="KHXX_1">0</b></span>
                                </div>
                                <div class="col-md-6 col-xs-6 col-sm-6 mp0">
                                    <span class="f16 "><b id="KHXX_2">0</b></span>
                                </div>
                                <div class="col-md-6 col-xs-6 col-sm-6 mp0">
                                    <span class="f14 colorgrey">项目数量(个)</span>
                                </div>
                                <div class="col-md-6 col-xs-6 col-sm-6 mp0">
                                    <span class="f14 colorgrey">客户数量(万户)</span>
                                </div>
                                <div class="col-md-12 col-xs-12 col-sm-12 mp0">
                                    <div class="col-md-6 col-xs-6 col-sm-6 mp0">
                                        <span class="f16 "><b id="KHXX_3">0</b></span>
                                    </div>

                                    <div class="col-md-6 col-xs-6 col-sm-6 mp0">
                                        <span class="f16  SXYG"><b id="KHXX_4">0</b></span>
                                    </div>
                                </div>
                                <div class="col-md-12 col-xs-12 col-sm-12 mp0">
                                    <div class="col-md-6 col-xs-6 col-sm-6 mp0">
                                        <span class="f14 colorgrey">建筑面积(万平)</span>
                                    </div>
                                    <div class="col-md-6 col-xs-6 col-sm-6 mp0">
                                        <span class="f14 colorgrey SXYG">上线员工(人)</span>
                                    </div>
                                </div>
                                <div class="col-md-12 col-xs-12 col-sm-12 mp0">
                                    <div class="col-md-6 col-xs-6 col-sm-6 mp0">
                                        <span class="f16 "><b id="KHXX_5">0</b></span>
                                    </div>
                                    <div class="col-md-6 col-xs-6 col-sm-6 mp0">
                                        <span class="f16  SXYG"><b id="KHXX_6">0</b></span>
                                    </div>
                                </div>
                                <div class="col-md-12 col-xs-12 col-sm-12 mp0">
                                    <div class="col-md-6 col-xs-6 col-sm-6 mp0">
                                        <span class="f14 colorgrey">上线用户(万户)</span>
                                    </div>
                                    <div class="col-md-6 col-xs-6 col-sm-6 mp0">
                                        <span class="f14 colorgrey SXYG">上线用户(万人)</span>
                                    </div>
                                </div>
                    ...
                    <div class="row module">
                        ...
                        <div class="col-md-12 col-xs-12 col-sm-12 mp0" id="WNQQ_Div">
                            ...
                            <div class="col-md-7 col-xs-7 col-sm-7 mp0 pt13">
                                ...
                                <div class="col-md-6 col-xs-6 col-sm-6 mp0">
                                    <span class="f14 colorgrey">昨日清欠(万元)</span>
                                </div>
                                <div class="col-md-6 col-xs-6 col-sm-6 mp0">
                                ...
                                <div class="col-md-6 col-xs-6 col-sm-6 mp0">
                                    <span class="f14 colorgrey">本月清欠(万元)</span>
                                </div>
                            </div>
                            <div class="col-md-12 col-xs-12 col-sm-12 mp0">
                                <hr style="width: 92%" />
                        ...
                        <div class="col-md-12 col-xs-12 col-sm-12 mp0" id="BNSK_Div">
                            ...
                            <div class="col-md-7 col-xs-7 col-sm-7 mp0 pt13">
                                ...
                                <div class="col-md-6 col-xs-6 col-sm-6 mp0">
                                    <span class="f14 colorgrey">昨日收款(万元)</span>
                                </div>
                                <div class="col-md-6 col-xs-6 col-sm-6 mp0">
                                ...
                                <div class="col-md-6 col-xs-6 col-sm-6 mp0">
                                    <span class="f14 colorgrey">本月收款(万元)</span>
                                </div>
                            </div>
                            <div class="col-md-12 col-xs-12 col-sm-12 mp0">
                                <hr style="width: 92%" />
