<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractBrowse.aspx.cs" Inherits="M_Main.OAPublicWorkNew.ContractBrowse" %>
        ...
        <script type="text/javascript">
            ...
            function DelRecord(row) {
                $.messager.confirm('确定', '是否删除该项', function (r) {
                    if (r) {
                        $.tool.DataGet('OASearch', 'ContractDelete', 'InfoId=' + row.InfoId + '&State=' + row.CompleteName,
                            function Init() {
                            },
