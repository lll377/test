<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OfficialDocumentManage_NewAddTt.aspx.cs" Inherits="M_Main.OAPublicWorkNew.OfficialDocumentManage_NewAddTt" %>
    ...
    <form id="Form2" method="post" runat="server">
        ...
        <div class="ContentWindow" style="height: auto;">
            <div id="WorkInfoDv1">
                <table class="TableStyle" id="TableFrame" cellspacing="1" cellpadding="1" width="95%" align="center"
                    bgcolor="#cccccc">
                    <tr>
                        <td class="TableTdContentCenterStyle" colspan="4">收文审批单</td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    <td width="90%">
                                        <input class="Control_ItemInputNoStyle" id="WorkFlowType" style="height: 22px; width: 100%"
                                            readonly maxlength="50" size="30" data-options="required:true" name="WorkFlowType" runat="server">
                                    </td>
                                    <td align="right">
                    ...
                    <tr>
                        <td class="TableTdStyle"><span color="red">来文机关：</span>
                        </td>
                        <td class="TableTdContentStyle" colspan="3">
                            <input class="Control_ItemInputNoStyle" data-options="required:true" id="DispatchUnits" style="width: 90%" size="86" name="DispatchUnits"
                                runat="server"><span face="宋体" color="red"></span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="TableTdContentStyle" style="width: 244px"><font face="宋体">
                            <input class="Control_ItemInputNoStyle" id="FileCode" style="width: 90%" maxlength="50"
                                size="26" name="FileCode" runat="server"></font></td>
                        <td class="TableTdStyle"><font color="red">发文时间：</font></td>
                        <td class="TableTdContentStyle">
                            <input class="Control_ItemInputNoStyle" id="DispatchTime" data-options="required:true" style="width: 90%" onclick="WdatePicker()"
                                maxlength="20" size="18" name="DispatchTime" runat="server" /><font face="宋体" color="red"></font>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="TableTdStyle">文件份数：
                        </td>
                        <td class="TableTdContentStyle">
                            <input class="Control_ItemInputNoStyle" id="FileNumber" style="width: 90%"
                                maxlength="20" size="18" name="FileNumber" runat="server"><font face="宋体" color="red"></font>
                        </td>
                    </tr>
                    <tr>
                        <td class="TableTdStyle">收文时间：
                        </td>
                        <td class="TableTdContentStyle" style="width: 244px">
                            <input class="Control_ItemInputNoStyle" id="IncomingTime" data-options="required:true" style="width: 90%" onclick="WdatePicker()"
                                maxlength="20" size="18" name="IncomingTime" runat="server"><font face="宋体" color="red"></font>
                        </td>
                        <td class="TableTdStyle">缓急程度：
                        </td>
                        <td class="TableTdContentStyle">
                            <font face="宋体">
                                <asp:DropDownList ID="Nervous" runat="server"></asp:DropDownList></font>
                        </td>
                    </tr>

                    <tr>
                        <td class="TableTdStyle">收文序号：
                        </td>
                        <td class="TableTdContentStyle" style="width: 244px">
                            <input class="Control_ItemInputNoStyle" id="IncomingNumber" data-options="required:true" style="width: 90%" maxlength="20" size="45"
                                name="IncomingNumber" runat="server">
                        </td>
                        <td class="TableTdStyle">文件类型：
                        </td>
                        <td class="TableTdContentStyle">
                            <input class="Control_ItemInputNoStyle" id="FileType" style="width: 90%"
                                maxlength="20" size="18" name="FileType" runat="server"><font face="宋体" color="red"></font>
                        </td>
                    </tr>
                    <tr>
                        <td class="TableTdStyle">附件页数：
                        </td>
                        <td class="TableTdContentStyle" colspan="3">
                            <input class="Control_ItemInputNoStyle" id="AnnexPages" data-options="required:true" style="width: 90%" maxlength="20" size="45"
                                name="AnnexPages" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="TableTdContentStyle" colspan="3">
                            <input class="Control_ItemInputNoStyle" data-options="required:true" id="FileTitle" style="width: 90%" size="86" name="FileTitle"
                                runat="server"><span face="宋体" color="red"></span></td>
                    </tr>
                    <tr>
                        <td class="TableTdStyle">处理意见：
                        </td>
                        <td class="TableTdContentStyle" colspan="3">
                            <input class="Control_ItemInputNoStyle" data-options="required:true" id="HandleOpinions" style="width: 90%" size="86" name="HandleOpinions"
                                runat="server"><span face="宋体" color="red"></span></td>
                    </tr>
                    <%--<tr id="dv">
        ...
        <script type="text/javascript">
            ...
            function SelWorkFlowType() {
                var strPage = "../OAWorkFlowNew/FlowSortManageSel.aspx?DirectionaryCode=0017&random=" + Math.random();
            ...
            function checkValue() {
                ...
                if (document.all.UserName.value == "") {
                    window.alert("发起人不能为空");

                    return false;
                }

                if (document.all.WorkStartDate.value == "") {
                    window.alert("发起时间不能为空");

                    return false;
                }

                if (document.all.DispatchUnits.value == "") {
                    window.alert("来文机关不能为空");
                ...
                if (document.all.DispatchTime.value == "") {
                    window.alert("发文时间不能为空");

                    return false;
                }

                if (document.all.IncomingTime.value == "") {
                    window.alert("收文时间不能为空");

                    return false;
                }

                if (document.all.IncomingNumber.value == "") {
                    window.alert("收文序号不能为空");
                ...
                if (document.all.AnnexPages.value == "") {
                    window.alert("附件页数不能为空");
            ...
            function UpFileAdjunct() {
                ...
                var strPage = "../OAWorkFlowNew/FileAdjunct.aspx?Type=0017&KeyId=" + document.all.KeyId.value + "&AddFile=" + document.all.AddFile.value + "&random=" + Math.random();
                var w = $(window).width();
                var h = $(window).height();
