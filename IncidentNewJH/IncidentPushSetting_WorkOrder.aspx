<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncidentPushSetting_WorkOrder.aspx.cs" Inherits="M_Main.IncidentNewJH.IncidentPushSetting_WorkOrder" %>
...
<script type="text/javascript">
    ...
    function SelCheckObject(o) {
        ...
        $.tool.DataGet('IncidentPushSetting', 'IncidentPushSetting_WorkOrderUpdate', 'Type=Object&Id=' + values + '&Status=' + check,
            function Init() {
            },
    ...
    function SelCheckAPP(o) {
        ...
        $.tool.DataGet('IncidentPushSetting', 'IncidentPushSetting_WorkOrderUpdate', 'Type=APP&Id=' + values + '&Status=' + check,
            function Init() {
            },
            function callback(_Data) {
    ...
    function SelCheckPhone(o) {
        ...
        $.tool.DataGet('IncidentPushSetting', 'IncidentPushSetting_WorkOrderUpdate', 'Type=Phone&Id=' + values + '&Status=' + check,
            function Init() {
            },
            function callback(_Data) {
    ...
    var toolbar = [
        {
            ...
            handler: function () {
                ...
                //$.tool.DataPostChk('FrmForm', 'IncidentPushSetting', 'IncidentPushSetting_WorkOrderUpdateContent', $('#FrmForm').serialize(),
                //    function Init() {
                //    },
                //    function callback(_Data) {
                //        LoadList();
                ...
                HDialog.Open('650', '280', '../IncidentNewJH/IncidentPushSetting_DetailUpdate.aspx?UpdateTable=Tb_HSPR_IncidentPushSettingWorkOrder&IID=' + row.IID, '报事工单池推送设置', true, function callback(_Data) {
                    LoadList();
                });
            }
        }
    ...
    function LoadList() {
        $("#TableContainer").datagrid({
            ...
            onBeforeLoad: function (param) {
                param = $.JQForm.GetParam("IncidentPushSetting", "IncidentPushSetting_WorkOrder", "TableContainer", param);
            },
            onClickRow: function (rowIndex, rowData) {
                HDialog.Open('650', '280', '../IncidentNewJH/IncidentPushSetting_DetailUpdate.aspx?UpdateTable=Tb_HSPR_IncidentPushSettingWorkOrder&IID=' + rowData.IID, '报事工单池推送设置', true, function callback(_Data) {
                    LoadList();
                });
            },
