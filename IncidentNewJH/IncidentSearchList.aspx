<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncidentSearchList.aspx.cs" Inherits="M_Main.IncidentNewJH.IncidentSearchList" %>
            ...
            <div class="col-sm-12">
                <div class="ibox">
                        <div class="ibox-title">
                                 <span style="font-family:微软雅黑;font-size:14px;font-weight:bold;">报事查询列表</span>
                        </div>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="row">
                                        ...
                                        <a  id="Rp_11" data-url="../IncidentNewJH/IncidentSeach.aspx">1、报事信息查询</a><br />
                                            2、报事跟进查询<br />
                                        <a  id="Rp_12" data-url="../IncidentNewJH/IncidentFollowSeach.aspx">（1）明细查询</a><br />
                                        <a  id="Rp_18" data-url="../IncidentNewJH/IncidentFollowSeachNew.aspx">（2）汇总查询</a><br />
                                        3、报事催办查询<br />
                                        <a  id="Rp_13" data-url="../IncidentNewJH/IncidentRemindSeach.aspx">（1）明细查询</a><br />
                                        <a  id="Rp_20" data-url="../IncidentNewJH/IncidentRemindSeachNew.aspx">（2）汇总查询</a><br />
                                        4、报事转发查询<br />
                                        <a  id="Rp_14" data-url="../IncidentNewJH/IncidentChangeSeach.aspx">（1）明细查询</a><br />
                                            <a  id="Rp_21" data-url="../IncidentNewJH/IncidentChangeSeachNew.aspx">（2）汇总查询</a><br />
                                        ...
                                        <a  id="Rp_15" data-url="../IncidentNewJH/IncidentCancelFinish.aspx">（1）明细查询</a><br />
                                        <a  id="Rp_08" data-url="../IncidentNewJH/IncidentCancelFinishNew.aspx">（2）汇总查询</a><br />
                                        6、报事取消关闭查询<br />
                                        <a  id="Rp_16" data-url="../IncidentNewJH/IncidentCancelColsed.aspx">（1）明细查询</a><br />
                                        <a  id="Rp_28" data-url="../IncidentNewJH/IncidentCancelColsedNew.aspx">（2）汇总查询</a><br />
                                        <a  id="Rp_19" data-url="../IncidentNewJH/IncidentFeesSeach.aspx">7、报事费用查询</a><br />
                                        <a  id="Rp_17" data-url="../IncidentNewJH/IncidentPrintBlankSeach.aspx">8、空白派工单打印查询</a><br />
                                        </div>
                            </div>
                        </div>
                 </div>
