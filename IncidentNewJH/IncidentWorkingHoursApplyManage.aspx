<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncidentWorkingHoursApplyManage.aspx.cs" Inherits="M_Main.IncidentNewJH.IncidentWorkingHoursApplyManage" %>
    ...
    <form id="frmForm" runat="server">
        ...
        <div id="SearchDlg" class="easyui-dialog" title="筛选条件" data-options="iconCls:'icon-search',closed: true,modal:true"
            ...
            <table style="width: 100%; font-size: 12px; font-family: 微软雅黑;">
                <tr>
                    ...
                    <td class="TdContent">
                        <select id="IsClose" name="IsClose" style="width: 140px;" runat="server" readonly="true">
        ...
        <script type="text/javascript">
            ...
            function ViewDetail(title, rowIndex) {
                ...
                var w = $(window).width();
                var h = $(window).height();
                HDialog.Open(w, h, '../IncidentNewJH/IncidentWorkingHoursDetailPage.aspx', title, false, function callback(_Data) {
                    if (_Data == 1) {
                        LoadList($('#IsMore').val());
                    }
                });
