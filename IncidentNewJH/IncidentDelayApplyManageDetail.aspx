<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncidentDelayApplyManageDetail.aspx.cs" Inherits="M_Main.IncidentNewJH.IncidentDelayApplyManageDetail" %>
...
<body style="margin: 0px; padding: 0px; overflow: hidden;">
    <form id="frmForm" method="post" runat="server">
        ...
        <table id="Header_TableMain" class="DialogTable">
            ...
            <tr>
                <td class="DialogTdTitle" style="color: red;">延期原因</td>
                <td class="DialogTdContent" colspan="3">
