<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncidentFollowSeach.aspx.cs" Inherits="M_Main.IncidentNewJH.IncidentFollowSeach" %>
...
<script type="text/javascript">
    ...
    var toolbar = [
        ...
        }, '-',
        {
            ...
            handler: function () {
                window.location.href = "../IncidentNewJH/IncidentFollowSearchToExcel.aspx";
            }
        }
    ];
    ...
    var frozenColumns = [[
        ...
        { field: 'CoordinateNum', title: '派工单号', width: 150, align: 'left', sortable: true },
    ]]
    var column = [[
        {
            field: 'ForwardDateTime', title: '跟进时间', width: 160, align: 'left', sortable: true
        },
        { field: 'ForwardUser', title: '跟进人', width: 100, align: 'left', sortable: true },
        { field: 'ForwardType', title: '跟进类型', width: 100, align: 'left', sortable: true },
        { field: 'ForwardReasons', title: '跟进情况', width: 200, align: 'left', sortable: true },
        { field: 'OverdueReason', title: '逾期原因', width: 200, align: 'left', sortable: true },
        ...
        { field: 'AdmiDate', title: '受理时间', width: 160, align: 'left', sortable: true },
    ...
    function LoadList() {
        ...
        $("#TableContainer").datagrid({
            ...
            onBeforeLoad: function (param) {
                param = $.JQForm.GetParam("IncidentAcceptNew_Search", "SelectForwardList", "TableContainer", param);
            },
