<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncidentStandardUploadFileDialog.aspx.cs" Inherits="M_Main.IncidentNewJH.IncidentStandardUploadFileDialog" %>
...
<body>
    ...
    <script>
        ...
        function UpladImage() {
            ...
            $.ajax({
                type: "POST",
                url: "/HM/M_Main/IncidentNewJH/IncidentStandardUploadFileDialog.aspx?Method=UpladFile&FileDescr=" + hiFileDescr.value,
                data: formData,
                async: false,
                cache: false,
                dataType: 'text',
