<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncidentCutDetailPage.aspx.cs" Inherits="M_Main.IncidentNewJH.IncidentCutDetailPage" %>
    ...
    <form id="frmForm" runat="server">
        ...
        <table class="DialogTable" align="center" style="z-index: -999;">
            ...
            <tr>
                ...
                <td class="TdContent">
                    <input id="RatedWorkHour" type="text" value="" disabled style="width: 50%;" />
            ...
            var column = [[
                ...
                },
                {
                    ...
                    formatter: function (value, row, index) {
                        ...
                        var str = "<a class=\"HrefStyle\"  href='" + row.FilPath+"' onclick=\"doLoadFile('" + row.AdjunctCode + "');\">下载</a>";
                        return str;
                    }
                }
            ]];
