<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncidentCancelColsed.aspx.cs" Inherits="M_Main.IncidentNewJH.IncidentCancelColsed" %>
        ...
        <script type="text/javascript">
            ...
            var toolbar = [
                ...
                , '-',
                {
                    ...
                    handler: function () {
                        location.href = "../IncidentNewJH/IncidentCancelColsedCreateExcel.aspx";
                    }
                }
            ...
            function LoadList() {
                $("#TableContainer").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        param = $.JQForm.GetParam("IncidentAcceptNew_Search", "IncidentCancelColsed", "TableContainer", param);
                    },
            ...
            function btnClearMore() {
                ...
                $("#CloseTime1").val("");
                $("#CloseTime2").val("");
                $("#ReplyGoBackStartTime").val("");
                $("#ReplyGoBackEndTime").val("");
                //$("#DispStartDate").val("");
                //$("#DispEndDate").val("");
