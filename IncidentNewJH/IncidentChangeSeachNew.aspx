<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncidentChangeSeachNew.aspx.cs" Inherits="M_Main.IncidentNewJH.IncidentChangeSeachNew" %>
...
<script type="text/javascript">
            ...
            var toolbar = [
                ...
                }, '-',
                {
                    ...
                    iconCls: 'icon-save',
                    handler: function () {
                        location.href = "../IncidentNewJH/IncidentChangeSeachNewCreateExcel.aspx";
                    }
                }
            ];
    ...
    var column = [[
                ...
                { field: 'zhuanFaCount', title: '转发次数', width: 100, align: 'left', sortable: true },
                { field: 'Drclass', title: '初始类型', width: 100, align: 'left', sortable: true , formatter: function (value, row, index) {
                        var str = "";
                        if (row.DrClass == '1') {
                            str = "书面报事";
                ...
                { field: 'Duty', title: '初始责任', width: 120, align: 'left', sortable: true },
                { field: 'CorpTypeName', title: '初始类别', width: 120, align: 'left', sortable: true}
               ...
               // $("#hiBuildSNum").val(BuildSNum);
                ...
                $("#TableContainer").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        param = $.JQForm.GetParam("IncidentAcceptNew_Search", "IncidentTransmitSearchNew", "TableContainer", param);
                    },
