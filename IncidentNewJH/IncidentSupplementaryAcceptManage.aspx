<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncidentSupplementaryAcceptManage.aspx.cs" Inherits="M_Main.IncidentNewJH.IncidentSupplementaryAcceptManage" %>
...
<head>
    ...
    <script type="text/javascript">
        function CheckData(type) {
            ...
            if ($('#hirbplace').val() == "2") {
                if ($('#RegionalPlace').val() == "0") {
                    HDialog.Info("请选择公区,此项不能为空!");
                    return false;
                }
            }
            if ($('#IncidentMan').val() == "") {
            ...
            if ($('#UserCodesFP').val() == '' || $('#UserCodesFP').val() == undefined) {
                HDialog.Info('请选择分派责任人!');
                return false;
            }
...
<body onload="Win_OnLoad()" style="overflow-y: scroll;">
    <form id="IncidentAcceptManage" method="post" runat="server">
        ...
        <%-- 分派--%>
        <input id="IncidentManFP" type="hidden" name="IncidentManFP" runat="server">
        <input id="hiplaceFP" name="hiplaceFP" type="hidden" runat="server" />
        <input id="BigCorpTypeIDFP" name="BigCorpTypeIDFP" type="hidden" runat="server" />
        <input id="BigCorpTypeCodeFP" name="BigCorpTypeCodeFP" type="hidden" runat="server" />
        <input id="hiIsTouSuFP" name="hiIsTouSuFP" type="hidden" runat="server" />

        <input style="width: 8px; height: 21px" id="PrintParmsFP" size="1" type="hidden" name="PrintParmsFP" runat="server">
        <input id="IncidentNumFP" name="IncidentNumFP" type="hidden" runat="server" />
        <input id="IncidentContentFP" name="IncidentContentFP" type="hidden" runat="server" />
        <input id="CoordinateNumFP" name="CoordinateNumFP" type="hidden" runat="server" />

        <table id="Header_TableMain" class="DialogTable">
            <tr>
                <td style="border: 1px solid #cccccc; padding-left: 12px; background-color: #F6F6F6; font-size: 16px; text-align: center; font-family: 微软雅黑;" colspan="4">受理信息</td>
            </tr>
            <tr>
                <td valign="top">
                    <table class="DialogTable" id="Table1" align="center">
                        ...
                        <tr>
                            ...
                            <td class="TdContentSearch">
                                <select id="IncidentSource" name="IncidentSource" runat="server" onchange="IsChoiceRoom()">
                            ...
                            <td class="TdContent">
                                <asp:RadioButton ID="rbplace1" runat="server" Text="户内" GroupName="rbplace" onclick="ReseleTypeName();" Checked="True" AutoPostBack="True"></asp:RadioButton>&nbsp;
										     <asp:RadioButton ID="rbplace2" runat="server" Text="公区" GroupName="rbplace" onclick="ReseleTypeName();" AutoPostBack="True"></asp:RadioButton></td>
                        </tr>
                        <tr>
                            <td class="TdTitle">报事编号</td>
                            <td class="TdContent">
                                <input class="easyui-validatebox" id="IncidentNum" data-options="required:true" readonly style="width: 95%;"
                                    name="IncidentNum" runat="server"></td>
                            <td class="TdTitle">是否投诉</td>
                            <td class="TdContent">
                                <input id="IsTouSu1" type="radio" disabled="disabled" name="IsTouSu" onclick="return true" value="1" />是
                                <input id="IsTouSu2" type="radio" disabled="disabled" name="IsTouSu" onclick="return true" value="0" checked="checked" />否
                            </td>
                        </tr>
                        <asp:Panel runat="server" ID="GGQY">
                            <tr>
                                ...
                                <td class="TdContentSearch">
                                    ...
                                    <input type="text" class="easyui-searchbox" style="width: 76%;" id="EquipmentName" name="EquipmentName" searcher="SelEqment" runat="server" />
                        ...
                        <tr>
                            ...
                            <td class="TdContent">
                                <input class="easyui-validatebox" style="width: 95%;" id="IncidentMan" data-options="required:true" name="IncidentMan"
                                    runat="server">
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="TdContent" colspan="3">
                                <table cellspacing="0" cellpadding="0" class="DialogTable">
                                    <tr>
                                        <td width="45%">
                                            <textarea style="width: 95%; height: 168px" class="easyui-validatebox" data-options="required:true" id="IncidentContent" rows="13" cols="83" name="IncidentContent"
                        ...
                        <tr>
                            ...
                            <td class="TdContent">
                                <input id="ReserveDate" name="ReserveDate" onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd HH:mm:ss', skin: 'default' })" class="Wdate" runat="server" />
                            </td>--%>
                        ...
                        <tr>
                            ...
                            <%--<td class="TdTitle">
                                <asp:Label ID="Type1" runat="server" CssClass="formTable_Item">原因细类</asp:Label></td>
                            <td class="TdContentSearch">
                                <input type="text" class="easyui-searchbox" style="width: 76%;" id="FineTypeName" name="FineTypeName" data-options="required:true,editable:false"
                                    searcher="SelFineTypeName" runat="server" />
                        ...
                        <tr>
                            ...
                            <td class="TdContentSearch">
                                <input type="text" class="easyui-searchbox" style="width: 76%;" id="AdmiMan" name="AdmiMan" data-options="required:true,editable:false"
                            ...
                            <td class="TdContent">
                                ...
                                <input id="IncidentDate" name="IncidentDate" onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd HH:mm:ss', skin: 'default' })" class="Wdate" runat="server" />
                            </td>
                        </tr>
                        ...
                        <tr class="Tb_Assigned">
                            ...
                            <td class="TdContentSearch">
                                <input type="text" style="width: 76%;" class="easyui-searchbox" data-options="required:true,ditable:false"
                                    id="DealManFP" name="DealManFP" searcher="SelDealMan" runat="server" />
                                <input style="width: 16px; height: 22px" id="ZRUserCodesFP" size="1" type="hidden" name="ZRUserCodesFP" runat="server" />
                            </td>
                        ...
                        <tr>
                            <td style="border: 1px solid #cccccc; padding-left: 12px; background-color: #F6F6F6; font-size: 16px; text-align: center; font-family: 微软雅黑;" colspan="4">附件信息</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="TdContent" style="width: 400px; height: 50px;"></td>
                        </tr>
                        <tr>
        ...
        <script type="text/javascript">
            ...
            function SelTypeName() {
                ...
                if ($("#hirbplace").val() == 1 && $("#RoomID").val() == '') {
                    ...
                    HDialog.Open('800', '500', UrlNewCorpIncidentTypeBigDlg + '?ClassID=' + $("#DrClass").val() + '&Duty=' + duty + '&IsCheck=1&IsBigClass=1&IsEdit=true&IncidentPlace=' + $("#hirbplace").val(), '选择报事类别', false, function callback(_Data) {
                        //HDialog.Open('800', '500', '../DialogNew/NewCorpIncidentTypeBigDlg.aspx?ClassID=' + $("#DrClass").val() + '&Duty=' + duty + '&IsCheck=1&IsEdit=true', '选择报事类别', false, function callback(_Data) {
            ...
            function SelDealMan() {
                if ($("#TypeName").searchbox('getValue') == "") {
                    ...
                    HDialog.Open('640', '480', '../DialogNew/IncidentDealMan.aspx?BigCorpTypeID=' + TypeID, '选择处理人员', false, function callback(_Data) {
                        var arrRet = _Data.split('\t');
                        $("#DealManFP").searchbox("setValue", arrRet[1]);
            ...
            function ExaCoorganizer() {
                if ($("#TypeName").searchbox('getValue') == "") {
                    ...
                    HDialog.Open('740', '480', '../DialogNew/IncidentDealManChecked.aspx?BigCorpTypeID=' + BigCorpTypeID + '&CheckedUserLists=' + $("#DealManCheckedUserLists").val(), '选择协助人', false,
                        function callback(_Data) {
            ...
            function SaveIncident(Print) {
                ...
                $.tool.DataPostNoChk('frmForm', 'IncidentAcceptNew', "IncidentNewSupplementaryAccept", $('#IncidentAcceptManage').serialize()
                    + '&vIsPrint=' + Print + '&IsSupplementary=1',
                    function Init() {
                    },
                    function callback(_Data) {
                        ...
                        if (data[0] == "true") {
                            //HDialog.Info('保存成功!');
                            ViewPages(data[1], data[2], data[3], data[4]);
            ...
            function ViewPages(IncidentID, IncidentMan, IncidentNum, CommID) {
                var url = '../IncidentNewJH/IncidentProcessingFinish.aspx?IsSupplementary=1&IncidentID=' + IncidentID + "&IncidentMan=" + IncidentMan + "&IncidentNum=" + IncidentNum + "&Flag=BL";
                var title = "报事完成";
                var w = $(window).width();
                var h = $(window).height();
                //JSON.stringify(row);
                var rowstr = '{"IncidentID": "' + IncidentID + '","CommID":"' + CommID + '"}';
                Cache.SetData("IncidentDeals", rowstr);
                HDialog.Open(w, h, url, title, false, function callback(_Data) {
                    if (_Data) {
                        $("#hiimgIncidentID").val(IncidentID);
                        UPdateImage();
                        window.location.replace("../IncidentNewJH/IncidentSupplementaryAcceptManage.aspx");
                    } else { window.location.replace("../IncidentNewJH/IncidentSupplementaryAcceptManage.aspx"); }
                });
            }
            ...
            function SelTypeNameFP() {
                ...
                if ($("#hirbplace").val() == 1 && $("#RoomID").val() == '') {
                    ...
                    HDialog.Open('800', '500', '../DialogNew/NewCorpIncidentTypeBigDlg.aspx?ClassID=1&Duty=' + duty + '&IsCheck=1&IsEdit=true', '选择报事类别', false, function callback(_Data) {
                        var arrRet = JSON.parse(_Data);
                        $("#TypeIDFP").val(arrRet.id);
                        $("#hiTypeNameFP").val(arrRet.TypeName);
                        $("#TypeNameFP").searchbox("setValue", arrRet.TypeName);
                        $('#TypeCodeFP').val(arrRet.code);
                        $("#DealLimitFP").val(arrRet.DealLimit);
                        $("#BigCorpTypeIDFP").val(arrRet.id);
                        $('#BigCorpTypeCodeFP').val(arrRet.code);
                        $("#DealManFP").searchbox("setValue", '');
                        $("#UserCodesFP").val('');
                    });
                }
            ...
            function SelDealManFP() {
                if ($("#TypeName").searchbox('getValue') == "") {
                    ...
                    //alert(BigCorpTypeID);
                    //if (BigCorpTypeID.indexOf(',') == 0) {
                    //    BigCorpTypeID = BigCorpTypeID.substring(0, BigCorpTypeID.length);
                    //}
                    //if (BigCorpTypeID.lastIndexOf(',') == BigCorpTypeID.length - 1) {
                    //    BigCorpTypeID = BigCorpTypeID.substring(0, BigCorpTypeID.length - 1);
                    //}
