<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncidentSupplementaryBrowse.aspx.cs" Inherits="M_Main.IncidentNewJH.IncidentSupplementaryBrowse" %>
            ...
            <table cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <%--  <td>
                    ...
                    <td>
                        <a href="javascript:void(0)" onclick=" JavaScript:Supplementary()" class="l-btn l-btn-small l-btn-plain" group="" id="">
                         <span class="l-btn-left l-btn-icon-left"><span class="l-btn-text">补录添加</span><span class="l-btn-icon icon-add">&nbsp;</span></span></a></td>
                    <td>
                        <div class="datagrid-btn-separator"></div>
                    </td>
                    <td>
...
<script type="text/javascript">
    ...
    var column = [[
         { field: 'ClassName', title: '报事类型', width: 65, align: 'left', sortable: true },
        ...
        { field: 'DealMan', title: '责任人', width: 120, align: 'left', sortable: true },
    ...
    function LoadList() {
        ...
        $("#TableContainer").datagrid({
            ...
            onBeforeLoad: function (param) {
                param = $.JQForm.GetParam("IncidentAcceptNew_Search", "IncidentSupplementarySearch", "TableContainer", param);
            }
        });
    ...
    function ViewPages(option, rowIndex) {
        ...
        switch (option) {
            ...
            case "gj":
                ...
                break;
            case "finish":
                url = '../IncidentNewJH/IncidentProcessingFinish.aspx?IsSupplementary=1&IncidentID=' + row.IncidentID + "&IncidentMan=" + row.IncidentMan + "&IncidentNum=" + row.IncidentNum;
                title = "报事完成";
                w = $(window).width();
                h = $(window).height();
    ...
    function Supplementary() {
        var url = "";
        var title = "";
        url = '../IncidentNewJH/IncidentSupplementaryAcceptManage.aspx';
        title = "报事补录";
            HDialog.Open('1024', '650', url, title, false, function callback(_Data) {
                if (_Data == "1") {
                    LoadList();
                }
            });
