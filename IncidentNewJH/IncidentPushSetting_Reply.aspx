<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncidentPushSetting_Reply.aspx.cs" Inherits="M_Main.IncidentNewJH.IncidentPushSetting_Reply" %>
...
<script type="text/javascript">
    ...
    function SelCheckObject(o) {
        ...
        $.tool.DataGet('IncidentPushSetting', 'IncidentPushSetting_ReplyUpdate', 'Type=Object&Id=' + values + '&Status=' + check,
            function Init() {
            },
    ...
    function SelCheckAPP(o) {
        ...
        $.tool.DataGet('IncidentPushSetting', 'IncidentPushSetting_ReplyUpdate', 'Type=APP&Id=' + values + '&Status=' + check,
            function Init() {
            },
            function callback(_Data) {
    ...
    function SelCheckPhone(o) {
        ...
        $.tool.DataGet('IncidentPushSetting', 'IncidentPushSetting_ReplyUpdate', 'Type=Phone&Id=' + values + '&Status=' + check,
            function Init() {
            },
            function callback(_Data) {
    ...
    var toolbar = [
        {
            ...
            handler: function () {
                ...
                //$.tool.DataPostChk('FrmForm', 'IncidentPushSetting', 'IncidentPushSetting_ReplyUpdateContent', $('#FrmForm').serialize(),
                //    function Init() {
                //    },
                //    function callback(_Data) {
                //        LoadList();
                ...
                //    function errorCallback() {
                //    });
                HDialog.Open('650', '280', '../IncidentNewJH/IncidentPushSetting_DetailUpdate.aspx?UpdateTable=Tb_HSPR_IncidentPushSettingReply&IID=' + row.IID, '报事回访推送设置', true, function callback(_Data) {
                    LoadList();
                });
            }
        }
    ...
    function LoadList() {
        $("#TableContainer").datagrid({
            ...
            onBeforeLoad: function (param) {
                param = $.JQForm.GetParam("IncidentPushSetting", "IncidentPushSetting_Reply", "TableContainer", param);
            },
            onClickRow: function (rowIndex, rowData) {
                HDialog.Open('650', '280', '../IncidentNewJH/IncidentPushSetting_DetailUpdate.aspx?UpdateTable=Tb_HSPR_IncidentPushSettingReply&IID=' + rowData.IID, '报事回访推送设置', true, function callback(_Data) {
                    LoadList();
                });
            },
