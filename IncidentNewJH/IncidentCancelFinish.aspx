<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncidentCancelFinish.aspx.cs" Inherits="M_Main.IncidentNewJH.IncidentCancelFinish" %>
    ...
    <script type="text/javascript">
                ...
                var toolbar = [
                    ...
                    , '-',
                    {
                        ...
                        handler: function () {                            
                            location.href = "../IncidentNewJH/IncidentCancelFinishCreateExcel.aspx";
                        }
                    }
                ...
                function LoadList() {
                    $("#TableContainer").datagrid({
                        ...
                        onBeforeLoad: function (param) {
                            param = $.JQForm.GetParam("IncidentAcceptNew_Search", "IncidentCancelFinish", "TableContainer", param);
                        },
        ...
        function SelTypeName() {
            ...
            HDialog.Open('650', '500', UrlNewCorpIncidentTypeBigDlg + '?ClassID=0&Duty=&IsCheck=1&IsEdit=true&IsAll=True', '选择报事类别', false, function callback(_Data) {
                ...
                function btnClearMore() {
                    ...
                    $("#MainEndDate1").val("");
                    $("#MainEndDate2").val("");
                    $("#CloseGoBackStartTime").val("");
                    $("#CloseGoBackEndTime").val("");
                    $("#DispStartDate").val("");
                    $("#DispEndDate").val("");
