<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncidentCancelColsedNew.aspx.cs" Inherits="M_Main.IncidentNewJH.IncidentCancelColsedNew" %>
            ...
            <table style="width: 100%; font-size: 12px; font-family: 微软雅黑;">
                ...
                <tr>
                   ...
                   <td class="TdTitle">退回时间从
                    ...
                    <td class="TdContent">
                        <input type="text" class="Wdate" id="ReplyGoBackStartTime" name="ReplyGoBackStartTime" style="width: 140px;" runat="server"
                            onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd HH:mm:ss', skin: 'default' })" format="date" />
                    </td>
                    <td class="TdTitle">到
                    </td>
                    <td class="TdContent">
                        <input type="text" class="Wdate" id="ReplyGoBackEndTime" name="ReplyGoBackEndTime" style="width: 140px;" runat="server"
                            onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd HH:mm:ss', skin: 'default' })" format="date" />
                    </td>
               </tr>
               <tr>
                   ...
                   <td class="TdTitle">分派人
                    ...
                    <td class="TdContent">
                        <input type="text" id="CloseUser" name="CloseUser" style="width: 140px;" runat="server" />
                    </td>
                   <td class="TdTitle">退回人
                    </td>
                    <td class="TdContent">
                        <input type="text" id="ReplyGoBackUser" name="ReplyGoBackUser" style="width: 140px;" runat="server" />
                    </td>
               </tr>
        ...
        <script type="text/javascript">
            ...
            var toolbar = [
                ...
                }, '-',
                {
                    ...
                    iconCls: 'icon-save',
                    handler: function () {
                        location.href = "../IncidentNewJH/IncidentCancelColsedNewCreateExcel.aspx";
                    }
                }
            ...
            var column = [[
                ...
                { field: 'QXGBCount', title: '取消关闭次数', width: 200, align: 'left', sortable: true },
                { field: 'CloseTime', title: '初次关闭时间', width: 200, align: 'left', sortable: true },
                { field: 'CloseSituation', title: '初次关闭说明', width: 200, align: 'left', sortable: true }

                //{ field: 'CloseTime', title: '关闭时间', width: 200, align: 'left', sortable: true },
                //{ field: 'CloseUser', title: '关闭人', width: 80, align: 'left', sortable: true },
                //{ field: 'LastCloseTime', title: '上次关闭时间', width: 200, align: 'left', sortable: true },
                //{ field: 'LastCloseUser', title: '上次关闭人', width: 80, align: 'left', sortable: true },
                //{ field: 'ReplyGoBackTime', title: '退回时间', width: 200, align: 'left', sortable: true },
                //{ field: 'ReplyGoBackUser', title: '退回人', width: 80, align: 'left', sortable: true },
                //{ field: 'ReplyGoBackReasons', title: '退回原因', width: 200, align: 'left', sortable: true },
                //{ field: 'BigTypeName', title: '报事类别', width: 100, align: 'left', sortable: true },
                //{ field: 'FineTypeName', title: '原因细类', width: 100, align: 'left', sortable: true },
            ...
            function LoadList() {
                $("#TableContainer").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        param = $.JQForm.GetParam("IncidentAcceptNew_Search", "IncidentCancelColsedNew", "TableContainer", param);
                    },
