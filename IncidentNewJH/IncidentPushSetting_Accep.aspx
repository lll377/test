<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncidentPushSetting_Accep.aspx.cs" Inherits="M_Main.IncidentNewJH.IncidentPushSetting_Accep" %>
...
<script type="text/javascript">
    ...
    function SelCheckObject(o) {
        ...
        $.tool.DataGet('IncidentPushSetting', 'IncidentPushSetting_AccepUpdate', 'Type=Object&Id=' + values + '&Status=' + check,
            function Init() {
            },
    ...
    function SelCheckAPP(o) {
        ...
        $.tool.DataGet('IncidentPushSetting', 'IncidentPushSetting_AccepUpdate', 'Type=APP&Id=' + values + '&Status=' + check,
            function Init() {
            },
            function callback(_Data) {
    ...
    function SelCheckPhone(o) {
        ...
        $.tool.DataGet('IncidentPushSetting', 'IncidentPushSetting_AccepUpdate', 'Type=Phone&Id=' + values + '&Status=' + check,
            function Init() {
            },
            function callback(_Data) {
    ...
    var toolbar = [
        {
            ...
            handler: function () {
                ...
                HDialog.Open('650', '280', '../IncidentNewJH/IncidentPushSetting_DetailUpdate.aspx?UpdateTable=Tb_HSPR_IncidentPushSettingAccep&IID=' + row.IID, '报事受理推送设置', true, function callback(_Data) {
                    LoadList();
                });
            }
        }
    ...
    function LoadList() {
        $("#TableContainer").datagrid({
            ...
            onClickRow: function (rowIndex, rowData) {
                HDialog.Open('650', '280', '../IncidentNewJH/IncidentPushSetting_DetailUpdate.aspx?UpdateTable=Tb_HSPR_IncidentPushSettingAccep&IID=' + rowData.IID, '报事受理推送设置', true, function callback(_Data) {
                    LoadList();
                });
            },
            onBeforeLoad: function (param) {
                param = $.JQForm.GetParam("IncidentPushSetting", "IncidentPushSetting_Accep", "TableContainer", param);
            },
