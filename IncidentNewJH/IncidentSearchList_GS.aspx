<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncidentSearchList_GS.aspx.cs" Inherits="M_Main.IncidentNewJH.IncidentSearchList_GS" %>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="row">
                                        ...
                                        <div class="col-sm-4" style="font-size:15px;font-family:微软雅黑;line-height:30px;">
                                                ...
                                                <a  id="Rp_1" data-url="../IncidentNewJH/IncidentSeach.aspx">1、报事信息查询</a><br />                                         
                                                <a  id="Rp_2" data-url="../IncidentNewJH/IncidentFollowSeach.aspx">2、报事跟进查询</a><br />                                       
                                                <a  id="Rp_3" data-url="../IncidentNewJH/IncidentRemindSeach.aspx">3、报事催办查询</a><br />                                       
                                                <a  id="Rp_4" data-url="../IncidentNewJH/IncidentChangeSeach.aspx">4、报事转发查询</a><br />                                                    
                                                <a  id="Rp_5" data-url="../IncidentNewJH/IncidentFeesSeach.aspx">5、报事费用查询</a><br />  
                                                <a  id="Rp_6" data-url="../IncidentNewJH/IncidentCancelFinish.aspx">6、报事取消完成查询</a><br />  
                                                <a  id="Rp_7" data-url="../IncidentNewJH/IncidentCancelColsed.aspx">7、报事取消关闭查询</a><br /> 
                                                <a  id="Rp_8" data-url="../IncidentNewJH/IncidentPrintBlankSeach.aspx">8、空白派工单打印查询</a><br />    
                                        </div>
                                         <div class="col-sm-4" style="font-size:15px;font-family:微软雅黑;line-height:30px;">
