<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncidentFreeApplyManage.aspx.cs" Inherits="M_Main.IncidentNewJH.IncidentFreeApplyManage" %>
    ...
    <form id="frmForm" runat="server">
        ...
        <script type="text/javascript">
            ...
            var column = [[
                ...
                { field: 'FreeReason', title: '免费原因', align: 'left', width: 300, sortable: true },
            ...
            function LoadList() {
                $("#TableContainer").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        param = $.JQForm.GetParam("IncidentProcessingNew", "GetIncidentFreeList", "TableContainer", param);
                        if (flag == "1") {
            ...
            function Detail(IID, IncidentID, OpType) {
                var w = 1000;
                var h = 500;
                HDialog.Open(w, h, '../IncidentNewJH/IncidentFreeApplyManageDetail.aspx?id=' + IID + '&IncidentID=' + IncidentID + '&OpType=' + OpType, "报事免费申请", true, function callback(_Data) {
                    if (_Data != "") {
                        if (_Data == "1") {
                            HDialog.Info("审核成功");
                        }
