<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncidentPushSetting_Audit.aspx.cs" Inherits="M_Main.IncidentNewJH.IncidentPushSetting_Audit" %>
...
<script type="text/javascript">
    ...
    function SelCheckObject(o) {
        ...
        $.tool.DataGet('IncidentPushSetting', 'IncidentPushSetting_AuditUpdate', 'Type=Object&Id=' + values + '&Status=' + check,
            function Init() {
            },
    ...
    function SelCheckAPP(o) {
        ...
        $.tool.DataGet('IncidentPushSetting', 'IncidentPushSetting_AuditUpdate', 'Type=APP&Id=' + values + '&Status=' + check,
            function Init() {
            },
            function callback(_Data) {
    ...
    function SelCheckPhone(o) {
        ...
        $.tool.DataGet('IncidentPushSetting', 'IncidentPushSetting_AuditUpdate', 'Type=Phone&Id=' + values + '&Status=' + check,
            function Init() {
            },
            function callback(_Data) {
    ...
    var toolbar = [
        {
            ...
            handler: function () {
                ...
                $.tool.DataPostChk('FrmForm', 'IncidentPushSetting', 'IncidentPushSetting_AuditUpdateContent', $('#FrmForm').serialize(),
                    function Init() {
                    },
                    function callback(_Data) {
                        LoadList();
    ...
    function LoadList() {
        $("#TableContainer").datagrid({
            ...
            onBeforeLoad: function (param) {
                param = $.JQForm.GetParam("IncidentPushSetting", "IncidentPushSetting_Audit", "TableContainer", param);
            },
