<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HasSendBrowse_WeChat.aspx.cs" Inherits="M_Main.SMSNew.HasSendBrowse_WeChat" %>
    ...
    <script type="text/javascript">
        ...
        function LoadList() {
            $("#TableContainer").datagrid({
                url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=SMS&Command=HasSendSearch_WeChat&' + $("#frmForm").serialize(),
                method: "get",
                nowrap: false,
