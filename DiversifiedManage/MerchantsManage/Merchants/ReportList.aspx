<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportList.aspx.cs" Inherits="M_Main.DiversifiedManage.MerchantsManage.Merchants.ReportList" %>
                ...
                <div class="col-sm-12">
                    <div class="ibox">
                        <div class="ibox-title">
                            <span style="font-family: 微软雅黑; font-size: 14px; font-weight: bold;">客商信息查询</span>
                        </div>
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-sm-4" style="font-size: 15px; font-family: 微软雅黑; line-height: 30px;">
                                    <a id="Rp_01" data-url="/HM/M_Main/DiversifiedManage/MerchantsManage/Merchants/List.aspx?search=search">1、客商基础信息查询</a><br />
                                    <a id="Rp_02" data-url="/HM/M_Main/DiversifiedManage/MerchantsManage/FollowUp/List.aspx?search=search">2、客商跟进信息查询</a><br />
                                    <a id="Rp_03" data-url="/HM/M_Main/DiversifiedManage/MerchantsManage/BlackList/List.aspx?search=search">3、客商限制信息查询</a><br />
                                    <a id="Rp_04" data-url="/HM/M_Main/DiversifiedManage/PointManage/Point/UseSearch.aspx?search=search">4、客商点位信息查询</a><br />
                                </div>
                            </div>
                        </div>
                    </div>
