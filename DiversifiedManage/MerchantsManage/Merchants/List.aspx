<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="M_Main.DiversifiedManage.MerchantsManage.Merchants.List" %>
...
<body>
        ...
        <form id="frm" class="form-horizontal" role="form">
            ...
            <fieldset class="frame-fieldset">
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 col-xs-1 control-label">黑名单状态</label>
                    <div class="col-sm-5 col-xs-5">
                        <input id="IsBlackList" name="IsBlackList" class="easyui-combobox" />
                    </div>
                </div>
            </fieldset>
            <%--<div class="form-group">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function InitControl() {
            ...
            $('#MerchantsType').combobox(param);

            data = [{ id: '未审核', text: '未审核' }, { id: '已审核', text: '已审核' }];
            param.data = data
            $('#AuditState').combobox(param);
            data = [{ id: '否', text: '白名单客商' }, { id: '是', text: '黑名单客商' }];
            param.data = data;
            param.value = "否";
            $('#IsBlackList').combobox(param);
        }
        ...
        var column = [[
            ...
            {
                field: 'IsBlackList', title: '是否黑名单', width: 100, align: 'center', sortable: false, styler: function (value, row, index) {
                    if (value == "是") {
        ...
        function Edit(title, opType) {
            ...
            LayerDialog.OpenWin('1000', '600', '/HM/M_Main/DiversifiedManage/MerchantsManage/Merchants/Edit.aspx?' + $.param(param), title, true, function callback(_Data) {
                InitDataGrid();
            });
        }
        ...
        function Del() {
            ...
            if (row) {
                $.messager.confirm('确定', '是否删除?', function (r) {
                    if (r) {
                        $.dataPostJson('DivfManage_Merchants', 'Del', { "idList": row.ID }, true, false,
                            function Init() {
                            },
                            function callback(data) {
                                if (data.result) {
        ...
        function Export() {
            ...
            param.IsZip = "否";
            param.TableName = "客商信息";
            param.Class = "DivfManage_Merchants";
