<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="M_Main.DiversifiedManage.MerchantsManage.Dictionary.List" %>
...
<body>
    <input id="TypeMust" name="TypeMust" type="hidden" value="客商类别,客商经营业态,跟进阶段" />
    ...
    <script language="javascript" type="text/javascript">
        ...
        function InitControl() {
            var data = [{ id: '客商类别', text: '客商类别' }, { id: '客商经营业态', text: '客商经营业态' }, { id: '跟进阶段', text: '跟进阶段' }];
            $('#Type').combobox({
                required: false,
                editable: false,
                tipPosition: 'bottom',
        ...
        function Edit(title, id) {
            ...
            LayerDialog.OpenWin('400', '240', '/HM/M_Main/DiversifiedManage/MerchantsManage/Dictionary/Edit.aspx?' + $.param(param), title, true, function callback(_Data) {
                InitDataGrid();
            });
        }
        function Del(idList) {
            $.messager.confirm('确定', '是否删除?', function (r) {
                if (r) {
                    $.dataPostJson('DivfManage_Dictionary', 'Del', { "idList": idList }, true, false,
                        function Init() {
                        },
