<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportList.aspx.cs" Inherits="M_Main.DiversifiedManage.PointManage.Point.ReportList" %>
...
<body class="gray-bg">
    <form id="frmForm" runat="server">
                ...
                <div class="col-sm-12">
                    <div class="ibox">
                        <div class="ibox-title">
                            <span style="font-family: 微软雅黑; font-size: 14px; font-weight: bold;">点位信息查询</span>
                        </div>
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-sm-4" style="font-size: 15px; font-family: 微软雅黑; line-height: 30px;">
                                    <a id="Rp_01" data-url="/HM/M_Main/DiversifiedManage/PointManage/Point/List.aspx?search=search">1、点位基础信息查询</a><br />
                                    <a id="Rp_02" data-url="/HM/M_Main/DiversifiedManage/PointManage/Point/UseSearch.aspx?search=search">2、点位使用信息查询</a><br />
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script type="text/javascript" src="/HM/M_Main/jscript/jquery.tool.new.js" type="text/javascript"></script>
        <script type="text/javascript" src="/HM/M_Main/jscript/CloseAjaxCache.js" type="text/javascript"></script>
