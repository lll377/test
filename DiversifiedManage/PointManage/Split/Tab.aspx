<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tab.aspx.cs" Inherits="M_Main.DiversifiedManage.PointManage.Split.Tab" %>
...
<body>
    <div id="tab" class="easyui-tabs">
        ...
        <div id="tab2" issel="false" title="点位拆分详情" style="overflow: hidden">
        </div>
    </div>
            ...
            $('#tab').tabs({
                ...
                onSelect: function (title, index) {
                    ...
                    if (issel == "false") {
                        ...
                        else if (index == 2) { pageName = "Split/ListSplit"; }
