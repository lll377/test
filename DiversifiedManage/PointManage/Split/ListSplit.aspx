<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListSplit.aspx.cs" Inherits="M_Main.DiversifiedManage.PointManage.Split.ListSplit" %>
        ...
        function InitDataGridNew() {
            $("#dgNew").datagrid({
                ...
                onBeforeLoad: function (param) {
                    param.SortField = "LongTimeStamp";
                    param.SortOrder = 1;
                    param.ChangeID = $.getUrlParam("ChangeID");
                    param = $.getDataGridParam("DivfManage_Point", "GetList", param);
                },
                onLoadSuccess: function (data) {
                    $("#dg").datagrid('resize');
