<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListHistory.aspx.cs" Inherits="M_Main.DiversifiedManage.PointManage.Split.ListHistory" %>
...
<body>
    ...
    <script language="javascript" type="text/javascript">
        ...
        var column = [[
            ...
            {
                field: 'GroupName', title: '取消拆分生成的操作编号', width: 160, align: 'center'
            },
            {
                field: 'Number', title: '点位编号', width: 250, align: 'center', sortable: false, formatter: function (value, row, index) {
                    if (!row.ChangeID) {  value = "(拆分的原点位)<br>" + value; }
                    return value;
                }
            },
            {
                field: 'Area', title: '点位面积(平米)', width: 150, align: 'center', sortable: false, formatter: function (value, row, index) {
                    if (!row.ChangeID) {  value = "(拆分的原点位)<br>" + value;}
                    return value;
                }
            },
            {
                field: 'ChangeNumber', title: '原点位编号', width: 150, align: 'center'
            },
            {
                field: 'ChangeArea', title: '原点位面积(平米)', width: 150, align: 'center'
            },
            {
