<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tab.aspx.cs" Inherits="M_Main.DiversifiedManage.PointManage.Merge.Tab" %>
...
<body>
    <div id="tab" class="easyui-tabs">
        ...
        <div id="tab2" issel="false" title="点位合并详情" style="overflow: hidden">
        </div>
    </div>
        ...
        function InitControl() {
            ...
            $('#tab').tabs({
                ...
                onSelect: function (title, index) {
                    ...
                    var pageName = "";
                    if (issel == "false") {
                        if (index == 0) { pageName = "Point/Detailed"; }
                        else if (index == 1) { pageName = "Point/UseSearch"; }
                        else if (index == 2) { pageName = "Merge/ListMerge"; }
                        var html = "<iframe scrolling=\"yes\" frameborder=\"0\" src=\"/HM/M_Main/DiversifiedManage/PointManage/" + pageName + ".aspx?" + urlParam + "\" style=\"width: 100%; height: 100%;\"></iframe>";
                        $("#tab" + index).html(html);
