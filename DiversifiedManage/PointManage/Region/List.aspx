<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="M_Main.DiversifiedManage.PointManage.Region.List" %>
...
<body>
    ...
    <div id="dlg_search" class="easyui-dialog" title="筛选" style="width: 600px; height: 190px;" data-options="
        ...
        <form  id="frm" class="form-horizontal" role="form">
            <div class="form-group">
                ...
                <div class="col-sm-4 col-xs-4">
                    <input id="RegionalPlace" name="RegionalPlace" class="easyui-textbox" />
                </div>
            </div>
            <div class="form-group">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function InitControl() {
            //var data = [{ id: '房屋', text: '房屋' },{ id: '车位', text: '车位' },{ id: '点位', text: '点位' }];
            //$('#Type').combobox({
            //    required: false,
            //    editable: false,
            //    tipPosition: 'bottom',
        ...
        function Edit(title, id) {
            ...
            LayerDialog.OpenWin('450', '400', '/HM/M_Main/DiversifiedManage/PointManage/Region/Edit.aspx?' + $.param(param), title, true, function callback(_Data) {
                InitDataGrid();
            });
        }
        function Del(idList) {
            $.messager.confirm('确定', '是否删除?', function (r) {
                if (r) {
                    $.dataPostJson('DivfManage_Region', 'Del', { "idList": idList }, true, false,
                        function Init() {
                        },
