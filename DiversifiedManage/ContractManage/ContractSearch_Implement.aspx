<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractSearch_Implement.aspx.cs" Inherits="M_Main.DiversifiedManage.ContractManage.ContractSearch_Implement" %>
        ...
        var toolbar = [
            {
                ...
                handler: function () {
                    ...
                    if (Rows.length == 0) {
                        $.messager.alert("温馨提示", '没有需要导出的合同执行数据!');
                        return;
                    }
                    window.open("ContractSearch_ImplementExport.aspx?" + $('#frmFrom').serialize());
                }
            }
        ];
        var column = [[
        ...
        function InitDataGrid() {
            $("#TableContainer").datagrid({
                ...
                onBeforeLoad: function (param) {
                    param = $.JQForm.GetParam("DiversifiedManage", "GetContractImplementSearchList", "TableContainer", param);
                },
