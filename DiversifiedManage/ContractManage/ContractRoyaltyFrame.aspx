<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractRoyaltyFrame.aspx.cs" Inherits="M_Main.DiversifiedManage.ContractManage.ContractRoyaltyFrame" %>
...
<body>
                ...
                <fieldset class="frame-fieldset">
                    ...
                    <table class="bootstrap_table baseinfo" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td class="text" colspan="3">
                                <input type="text" id="SellerName" name="SellerName" class="easyui-textbox" data-options="width:'84%'" runat="server" disabled="disabled" />
                ...
                <fieldset class="frame-fieldset">
                    ...
                    <table class="bootstrap_table baseinfo" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td class="text" colspan="3">
                                <input id="BuyerCustName" name="BuyerCustName" class="easyui-textbox" data-options="width:'84%'" runat="server" disabled="disabled" />
    ...
    <script type="text/javascript">
        ...
        var RoyaltyToolbar = [
            {
                ...
                handler: function () {
                    //判断 判断合同是否是已终止 已终止
                    $.tool.DataPostJson('DiversifiedManage', 'ContractRoyaltyValidate', "ContractID=" + $('#ContractID').val(),
                        function Init() {
                        },
            ...
            }, '-',
            {
                ...
                handler: function () {
                    ...
                    $.messager.confirm('温馨提示', '确定删除选择的合同提成数据?', function (r) {
                        if (r) {
                            $.tool.DataPostJson('DiversifiedManage', 'DelContractRoyalty', "idList=" + row.ID,
                                function Init() {
                                },
                                function callback(data) {
                                    if (data.result) {
        ...
        function RoyaltyDetail(OpType, ID) {
            ...
            LayerDialog.OpenWin("1000", '600', '../DiversifiedManage/ContractManage/ContractRoyaltyDetail.aspx?' + $.param(param), "合同提成详情", false, function callback(_Data) {
                if (_Data != "") {
                    LoadRoyaltyGrid();
                }
            });
        ...
        function LoadRoyaltyGrid() {
            $("#TableContainerRoyalty").datagrid({
                ...
                onBeforeLoad: function (param) {
                    ...
                    param.Command = "GetContractRoyaltyDetailList";
        ...
        var FeesColumn = [[
            ...
            { field: 'CostName', title: '费用项目', width: '160', align: 'left' },
