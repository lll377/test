<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportList.aspx.cs" Inherits="M_Main.DiversifiedManage.ContractManage.ReportList" %>
...
<body class="gray-bg">
    <form id="frmForm" runat="server">
                ...
                <div class="col-sm-12">
                    <div class="ibox">
                        <div class="ibox-title">
                            <span style="font-family: 微软雅黑; font-size: 14px; font-weight: bold;">合同查询</span>
                        </div>
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-sm-4" style="font-size: 15px; font-family: 微软雅黑; line-height: 30px;">
                                    <a id="Rp_01" data-url="/HM/M_Main/DiversifiedManage/ContractManage/ContractSearch_Sign.aspx">1、合同签订信息查询</a><br />
                                    <a id="Rp_02" data-url="/HM/M_Main/DiversifiedManage/ContractManage/ContractSearch_Change.aspx">2、合同变更信息查询</a><br />
                                    <a id="Rp_03" data-url="/HM/M_Main/DiversifiedManage/ContractManage/ContractSearch_Point.aspx">3、合同点位信息查询</a><br />
                                    <a id="Rp_04" data-url="/HM/M_Main/DiversifiedManage/ContractManage/ContractSearch_Implement.aspx">4、合同执行信息查询</a><br />
                                    <a id="Rp_05" data-url="/HM/M_Main/DiversifiedManage/ContractManage/ContractSearch_Royalty.aspx">5、合同提成信息查询</a><br />
                                    <a id="Rp_06" data-url="/HM/M_Main/DiversifiedManage/ContractManage/ContractSearch_Fees.aspx">6、合同费用信息查询</a><br />
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script type="text/javascript" src="/HM/M_Main/Jscript-Ui/hplus/js/jquery.min.js?v=2.1.4"></script>
        <script type="text/javascript" src="/HM/M_Main/Jscript-Ui/hplus/js/bootstrap.min.js?v=3.3.5"></script>
        <script type="text/javascript" src="/HM/M_Main/Jscript-Ui/hplus/js/content.min.js?v=1.0.0"></script>
        <script type="text/javascript" src="/HM/M_Main/jscript/jquery.tool.new.js"></script>
        <script type="text/javascript" src="/HM/M_Main/jscript/CloseAjaxCache.js"></script>
