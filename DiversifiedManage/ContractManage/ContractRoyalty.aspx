<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractRoyalty.aspx.cs" Inherits="M_Main.DiversifiedManage.ContractManage.ContractRoyalty" %>
...
<body style="padding: 0px; margin: 0px; overflow: hidden;">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function InitDataGrid() {
            $("#TableContainer").datagrid({
                ...
                onBeforeLoad: function (param) {
                    param = $.JQForm.GetParam("DiversifiedManage", "GetContractRoyaltyList", "TableContainer", param);
                },
        ...
        function Edit(ContractID) {
            ...
            var h = $(window).height();
            LayerDialog.OpenWin(w, h, '../DiversifiedManage/ContractManage/ContractRoyaltyFrame.aspx?' + $.param(param), "合同信息", false, function callback(_Data) {
                if (_Data != "") {
                    InitDataGrid();
                }
            });
