<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportStatisticsList.aspx.cs" Inherits="M_Main.DiversifiedManage.ContractManage.ReportStatisticsList" %>
                ...
                <div class="col-sm-12">
                    <div class="ibox">
                        <div class="ibox-title">
                            <span style="font-family: 微软雅黑; font-size: 14px; font-weight: bold;">多经统计</span>
                        </div>
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-sm-4" style="font-size: 15px; font-family: 微软雅黑; line-height: 30px;">
                                    <a id="Rp_01" data-url="/HM/M_Main/DiversifiedManage/Report/MerchantsAccountReport.aspx">1、客商台账报表(T+1)</a><br />
                                    <a id="Rp_02" data-url="/HM/M_Main/DiversifiedManage/Report/ContractAccountReport.aspx">2、合同台账报表(T+1)</a><br />
                                    <a id="Rp_03" data-url="/HM/M_Main/DiversifiedManage/Report/ContractSynthesizeReport.aspx">3、多经综合报表(T+1)</a><br />
                                </div>
                            </div>
                        </div>
                    </div>
