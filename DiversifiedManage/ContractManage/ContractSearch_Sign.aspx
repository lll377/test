<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractSearch_Sign.aspx.cs" Inherits="M_Main.DiversifiedManage.ContractManage.ContractSearch_Sign" %>
        ...
        var toolbar = [
            {
                ...
                handler: function () {
                    ...
                    window.open("ContractSearch_SignExport.aspx?" + $('#frmFrom').serialize());
                }
            }
        ];
        ...
        function InitDataGrid() {
            $("#TableContainer").datagrid({
                ...
                onBeforeLoad: function (param) {
                    param = $.JQForm.GetParam("DiversifiedManage", "GetContractSearchList", "TableContainer", param);
                },
