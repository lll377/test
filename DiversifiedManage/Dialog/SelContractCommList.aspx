<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelContractCommList.aspx.cs" Inherits="M_Main.DiversifiedManage.Dialog.SelContractCommList" %>
...
<body>
    ...
    <script language="javascript" type="text/javascript">
        ...
        var column = [[
            { field: 'OrganName', title: '区域名称', width: 100, align: 'left' },
            { field: 'CommID', title: '项目ID', width: 30, align: 'left' },
            { field: 'CommName', title: '项目名称', width: 100, align: 'left' }
        ]];
        function InitDataGrid() {
            $("#dg").datagrid({
                ...
                onBeforeLoad: function (param) {
                    param = $.JQForm.GetParam("DiversifiedManage", "ContractCommList", "dg", param);
                },
