<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelContractSelectedPoint_ForContractSetting.aspx.cs" Inherits="M_Main.DiversifiedManage.Dialog.SelContractSelectedPoint_ForContractSetting" %>
...
<head runat="server">
    ...
    <title>合同批量新增标准，选择合同中已选点位</title>
...
<body class="easyui-layout" style="margin: 0px; padding: 0px; overflow: hidden">
    ...
    <input type="hidden" name="AllPointIDs" id="AllPointIDs" runat="server" />
    <input type="hidden" id="HidCommID" name="HidCommID" runat="server" />
    <script language="javascript" type="text/javascript">
        $(function () {
            //获取值
            let SendData = localStorage.getItem("ContractBatchSetting_SelPoint");
            //设置值为空
            localStorage.setItem("ContractBatchSetting_SelPoint", "");
            ...
            if (!!ItemData.AllPointIDs) {
                $("#AllPointIDs").val(ItemData.AllPointIDs);
            }
            InitDataGrid();//加载未选点位
        ...
        function InitDataGrid() {
            $("#dg").datagrid({
                ...
                onBeforeLoad: function (param) {
                    param = $.JQForm.GetParam("DiversifiedManage", "ContractSetting_ContractSelPoint_GetNotSelected", "dg", param);
                },
