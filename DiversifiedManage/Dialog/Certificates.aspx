<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Certificates.aspx.cs" Inherits="M_Main.DiversifiedManage.Dialog.Certificates" %>
...
<body>
        ...
        <form id="frm" class="form-horizontal" role="form">
            <div class="form-group">
                <div class="col-sm-12 col-xs-12">
                    ...
                    <input id="DictionaryCode" name="DictionaryCode" class="easyui-numberbox" data-options="prompt:'',
                        icons:[{
                            iconCls:'icon-clear',
                            handler: function(e){
    ...
    <script language="javascript" type="text/javascript">
        ...
        var column = [[
            { field: 'DictionaryCode', title: '编号', width: 50, align: 'center', sortable: false },
            { field: 'DictionaryName', title: '名称', width: 100, align: 'center', sortable: false },
        ]];
        function InitDataGrid() {
            $("#dg").datagrid({
                ...
                onBeforeLoad: function (param) {
                    param = $.getDataGridParam("DivfManage_Dialog", "GetListCertificates", param);
                },
