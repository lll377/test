<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="M_Main.DiversifiedManage.Dialog.Category" %>
...
<body>
    ...
    <script language="javascript" type="text/javascript">
        ...
        var column = [[
            { field: 'Type', title: '类型', width: 30, align: 'center', sortable: false },
            { field: 'Name', title: '类别', width: 50, align: 'center', sortable: false },
