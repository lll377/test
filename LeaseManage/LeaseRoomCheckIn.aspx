<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaseRoomCheckIn.aspx.cs" Inherits="M_Main.LeaseManage.LeaseRoomCheckIn" %>
            ...
            <table class="SearchTable">
                <tr>
                    ...
                    <td class="TdContentSearch">
                        <input type="text" id="CheckInTime" name="CheckInTime" class="easyui-datebox" runat="server" data-options="editable:false,required:true" />
                    </td>
                </tr>
                <tr>
                    <td class="TdTitle">入住办理人:</td>
                    <td class="TdContentSearch">
                        <input type="text" id="CheckInUserName" name="CheckInUserName" class="easyui-validatebox TdContentSearchDisable" runat="server" readonly />
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Save() {
            if ($('#frmFrom').form("validate")) {
                $.tool.DataPostJson('LeaseManage', 'LeaseRoomCheckIn', $.JQForm.GetStrParam(),
                    function Init() {
                    },
