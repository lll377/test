<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaseContractChangeAuditManage.aspx.cs" Inherits="M_Main.LeaseManage.LeaseContractChangeAuditManage" %>
...
<body style="padding: 0px; margin: 0px; overflow: hidden;">
    <form id="form1" runat="server">
            ...
            <table class="SearchTable">
                <tr>
                    ...
                    <td class="TdContentSearch">
                        <select id="ChangeType" name="ChangeType" class="easyui-combobox"
                            data-options="editable:false,panelHeight: 'auto',width:120,multiple:true,valueField:'Id',textField:'Name'">
                ...
                <tr>
                    ...
                    <td class="TdContentSearch" colspan="3">
                        <textarea id="DepName" name="DepName" class="easyui-validatebox"></textarea>
        ...
        <input type="hidden" id="AuditType" name="AuditType" runat="server" value="30" />
        <script type="text/javascript">
                        ...
                        function callback(_Data) {
                            if (_Data != "") {
                                ...
                                if (varObjects.length > 0) {
                                    $("#ChangeType").combobox("setValues", varObjects[0]["ChangeType"])
            ...
            function WorkFlowChoise() {
                var strPage = "../OAWorkFlowNew/FlowSortManageSel.aspx?DirectionaryCode=0015&biaoshi=1&Filter=1205&random=" + Math.random();
