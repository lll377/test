<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentBindingDateLeft.aspx.cs" Inherits="M_Main.ChargesNew.PaymentBindingDateLeft" %>
        ...
        <script type="text/javascript">
            function NodeItemClick() {
                if (parseInt($("#CommID").val()) > 0) {
                    parent.$("#PaymentBindingDateRight").attr("src", "PaymentBindingDateRight.aspx?OrganCode=" + $("#PrentOrganCode").val() + "&OpType=edit&CommID=" + $("#CommID").val());
                }
                else {
                    parent.$("#PaymentBindingDateRight").attr("src", "PaymentBindingDateRight.aspx?OrganCode=" + $("#OrganCode").val() + "&OpType=edit&CommID=" + $("#CommID").val());
                }
            }
