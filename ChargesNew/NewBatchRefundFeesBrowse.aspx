<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewBatchRefundFeesBrowse.aspx.cs" Inherits="M_Main.ChargesNew.NewBatchRefundFeesBrowse" %>
...
<script type="text/javascript">
    ...
    var column = [[
        {
            field: 'RecNum', title: '申请编号', width: 140, align: 'left', sortable: true,
        ...
        { field: 'RefundReason', title: '退款原因', width: 150, align: 'left', sortable: true },
        { field: 'RefundChargeMode', title: '退款方式', width: 100, align: 'left', sortable: true },
        { field: 'AuditingState', title: '审核状态', width: 100, align: 'left', sortable: true },
        {
    ...
    function ViewRefundFees(title, optype, id) {
        var w = $(window).width();
        var h = $(window).height();
        HDialog.Open(w, h, '../ChargesNew/NewRefundFeesNewSecAddBL.aspx?OPType=' + optype + '&ID=' + id, title, false,
            function (_data) {
                if (_data != '') {
                    LoadList();
                } else {
