<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CostStanSettingBrowse.aspx.cs" Inherits="M_Main.ChargesNew.CostStanSettingBrowse" %>
            ...
            <table class="DialogTable">
                <tr>
                    ...
                    <td class="TdContentSearch">
                        <select id="BuildSNum" class="easyui-combobox" runat="server" data-options="editable:false" style="width: 150px"></select>
                    </td>
                    <td class="TdTitle">交房状态</td>
                    <td class="TdContentSearch">
                        <select id="RoomState" class="easyui-combobox" runat="server" data-options="editable:false" style="width: 180px"></select>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="4" style="text-align: center"><a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="LoadList();">确定筛选</a>&nbsp;&nbsp;
                        ...
                        if (row == "") {
                            ...
                            if (row.HandID > 0) {
                                ...
                                if (row.AuditState == "是") {
                                    ...
                                    HDialog.Info('费用标准已审核不能修改!');
                                }
                                else {
                                    ViewDetail("单户设置收费标准", 'update', row.IID);
                                }
                            }
                        }
                    ...
                    handler: function () {
                        ...
                        if (rows == "") {
                            ...
                            for (var i = 0; i < rows.length; i++) {
                                if (rows[i].AuditState == "是") {
                                    info = info + rows[i].CustName + rows[i].CostName + "标准已审核不能删除" + ";"
                                }
                            }
                            if (info != "") {
                                HDialog.Info(info);
            ...
            function LoadList() {
                $("#TableContainer").datagrid({
                    ...
                    onBeforeLoad: function (param) {
                        param = $.JQForm.GetParam("CostStanSetting", "search", "TableContainer", param);
                    }
                });
