<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeesPastAddBrowseSearch.aspx.cs" Inherits="M_Main.ChargesNew.FeesPastAddBrowseSearch" %>
...
<body>
    <form id="frmForm" runat="server">
        ...
        <input id="CommID" style="width: 16px; height: 22px" type="hidden" size="1" name="CommID" value="-1"
            runat="server" />
                ...
                <tr>
                    ...
                    <td class="TdContentSearch">
                        <input id="EditEndDate" class="Wdate"
                            readonly type="text" maxlength="50" name="EditEndDate"
                            runat="server"></td>
                </tr>
                <tr>
            ...
            var toolbar = [
                ...
                , '-',
                {
                    ...
                    handler: function () {
                        ...
                        window.location.href = '../ChargesNew/FeesPastAddBrowseSearchCreExcel.aspx?CommID=' + $("#CommID").val();
