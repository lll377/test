<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rscxOld.aspx.cs" Inherits="M_Main.PersonnelManage.rscxOld" %>
            ...
            <table style="width: 100%; font-size: 12px; font-family: 微软雅黑;">
                ...
                <tr>
                    <td colspan="8" align="center">
                        <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="LoadList(1,1);">确定筛选</a>
                    </td>
                </tr>
            </table>
        </div>
                ...
                <tr>
                    <td colspan="4">
                        <select name="from" ondblclick="removeItem();" id="from" multiple="true">
                            ...
                            <%--<option value="LeftEye">入职时间</option>--%>
                        ...
                        <option value="RoleName">岗位</option>--%>
                            ...
                            <option value="DimissionReason">离职原因</option>
        ...
        <script language="javascript" type="text/javascript">
            ...
            var column = [[
                    ...
                    { field: 'EducationName', title: '学历', width: 80, align: 'left', sortable: true },
                      //{
                      //    field: 'DepName', title: '人事所属机构', width: 150, align: 'left', sortable: true, formatter: function (value, row, index) {
                      //        var str = '';
                    ...
                    {
                        field: 'WorkStartDate', title: '参加工作时间', width: 100, align: 'left', sortable: true, formatter: function (value, row, index) {
                            var str = row.WorkStartDate.ToCustomizeDate();
                            return str;
                        }
                    },
                    {
                        field: 'EntryDate', title: '入职时间', width: 100, align: 'left', sortable: true, formatter: function (value, row, index) {
                            var str = row.EntryDate.ToCustomizeDate();
                            return str;
                        }
                    },
                    {
                        field: 'FormalDate', title: '转正时间', width: 100, align: 'left', sortable: true, formatter: function (value, row, index) {
                            var str = row.FormalDate.ToCustomizeDate();
                            return str;
                        }
                    },
                    {
                        field: 'WorkDimissionDate', title: '离职时间', width: 100, align: 'left', sortable: true, formatter: function (value, row, index) {
                            var str = row.DimissionDate.ToCustomizeDate();
                            return str;
                        }
                    }
                   ,
                   { field: 'IsLock', title: '锁定状态', width: 60, align: 'left', sortable: true },
            ...
            //                { field: 'LeftEye', title: '入职时间', width: 50, align: 'left', sortable: true, hidden: true },
                    ...
                    { field: 'IsStopSalary', title: '是否停薪', width: 100, align: 'left', sortable: true, hidden: true },
                      {
                          field: 'PersonState', title: '人员状态', width: 80, align: 'left', sortable: true, hidden: true, formatter: function (value, row, index) {
                              var str = row.DimissionDate.ToCustomizeDate();
                              return str;
                          }
                      },
            ...
            function SelRole() {
                HDialog.Open('370', '300', "../PersonnelManage/SelRole.aspx?Ram=" + Math.random(), '选择', false, function callback(_Data) {
                    if (_Data != '') {
            ...
            function LoadList(sort, order) {
                $("#TableContainer").datagrid({
                    url: '/HM/M_Main/HC/DataGetControl.aspx?Method=DataGet&Class=CSPerson&Command=SelectPersonList' + GetParam(sort, order),
                    method: "get",
                    title: '人事档案列表',
                    nowrap: false,
                    pageSize: 20,
